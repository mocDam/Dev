...
package dev.copy_of_masterfile_prices_0_35;
...
/**
 * Job: Copy_of_MASTERFILE_PRICES Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class Copy_of_MASTERFILE_PRICES implements TalendJob {
	...
	private final String jobName = "Copy_of_MASTERFILE_PRICES";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Copy_of_MASTERFILE_PRICES.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Copy_of_MASTERFILE_PRICES.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_DEV_Copy_of_MASTERFILE_PRICES = new byte[0];
		static byte[] commonByteArray_DEV_Copy_of_MASTERFILE_PRICES = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_DEV_Copy_of_MASTERFILE_PRICES.length) {
					if (length < 1024 && commonByteArray_DEV_Copy_of_MASTERFILE_PRICES.length == 0) {
						commonByteArray_DEV_Copy_of_MASTERFILE_PRICES = new byte[1024];
					} else {
						commonByteArray_DEV_Copy_of_MASTERFILE_PRICES = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_DEV_Copy_of_MASTERFILE_PRICES, 0, length);
				strReturn = new String(commonByteArray_DEV_Copy_of_MASTERFILE_PRICES, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DEV_Copy_of_MASTERFILE_PRICES) {
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final Copy_of_MASTERFILE_PRICES Copy_of_MASTERFILE_PRICESClass = new Copy_of_MASTERFILE_PRICES();

		int exitCode = Copy_of_MASTERFILE_PRICESClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Copy_of_MASTERFILE_PRICES.class.getClassLoader()
					.getResourceAsStream("dev/copy_of_masterfile_prices_0_35/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Copy_of_MASTERFILE_PRICES.class.getClassLoader()
		...
		} catch (TalendException e_tWarn_5) {
			globalMap.put("tWarn_5_SUBPROCESS_STATE", -1);

			e_tWarn_5.printStackTrace();
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : Copy_of_MASTERFILE_PRICES");
		}
...
/************************************************************************************************
 * 225198 characters generated by Talend Open Studio for Data Integration on the
 * 7 mars 2023 20:04:26 CET
 ************************************************************************************************/