...
/**
 * Class to generate Oauth 1.0a header for Bynder
 *
 */
public class BynderOauthHeaderGenerator {
    ...
    public BynderOauthHeaderGenerator(String consumerKey, String consumerSecret, String token, String tokenSecret) {
