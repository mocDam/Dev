...
package dev.uploadassetintobynder_prod_1_14;
...
public class UploadAssetIntoBynder_PROD implements TalendJob {
	...
	public class ContextProperties extends PropertiesWithType {
		...
		public void synchronizeContext() {
			...
			if (jarPath != null) {
				...
				this.setProperty("jarPath", jarPath.toString());
	...
	private final String jobVersion = "1.14";
	...
	public void tFileCopy_2_onSubJobError(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public void tFileCopy_4_onSubJobError(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				java.io.File file_tFileExist_4 = new java.io.File(
						context.bynderDirectory + "/input/FileAssetsName.csv");
			...
			if (resumeEntryMethodName == null || globalResumeTicket) {
				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tFileExist_4:OnSubjobOk", "",
				...
				if (file_tFileDelete_6.exists() && file_tFileDelete_6.isFile()) {
					if (file_tFileDelete_6.delete()) {
						...
						throw new RuntimeException(
								"File " + file_tFileDelete_6.getAbsolutePath() + " can not be deleted.");
					}
				} else {
					globalMap.put("tFileDelete_6_CURRENT_STATUS", "File does not exist or is invalid.");
					throw new RuntimeException("File " + file_tFileDelete_6.getAbsolutePath()
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				java.io.File file_tFileExist_2 = new java.io.File(
						context.bynderDirectory + "/temp/NewAssetsToUpload.csv");
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				class ContextProcessor_tRunJob_2 {
					private void transmitContext_0() {
						...
						parentContextMap_tRunJob_2.put("jarPath", context.jarPath);
						paraList_tRunJob_2.add("--context_type " + "jarPath" + "=" + "id_String");
					}
				...
				if (obj_tRunJob_2 != null) {
					paraList_tRunJob_2.add(
							"--context_param bynderDirectory=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_2));
				} else {
					paraList_tRunJob_2.add("--context_param bynderDirectory="
							+ NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
				}
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				for (int i_tFileList_1 = 0; i_tFileList_1 < list_tFileList_1.size(); i_tFileList_1++) {
					...
					fileName_tFileOutputDelimited_4 = (new java.io.File(
							context.bynderDirectory + "/temp/NewAssetsToUpload.csv")).getAbsolutePath().replace("\\",
									"/");
...
// ###############################
					...
					row1.File_Datetime = TalendDate.formatDate("yyyy-MM-dd HH:mm:ss",
							TalendDate.parseDateLocale("EEE MMM dd HH:mm:ss z yyyy", row1.mtime_string, "EN"));
...
// # Filter conditions 
						...
						Var.var1.substring(0, Var.var1.indexOf("."))
								.equals(((String) globalMap.get("EcomTag"))) == false
...
// Start of branch "output"
					if (output != null) {
						...
						{ // start of Var scope
							...
							Var.var3 = (StringHandling
									.RIGHT(output.basename.substring(0, output.basename.indexOf(".")), 1).equals("F")
											? "Front"
											: (StringHandling
													.RIGHT(output.basename.substring(0, output.basename.indexOf(".")),
															1)
													.equals("B")
															? "Back"
															: (StringHandling
																	.RIGHT(output.basename.substring(0,
																			output.basename.indexOf(".")), 1)
																	.equals("L")
																			? "Left"
																			: (StringHandling
																					.RIGHT(output.basename.substring(0,
...
// Start of branch "setGlobalVar"
						if (setGlobalVar != null) {
							...
							globalMap.put("ExecDate",
									TalendDate.formatDate("yyyyMMdd-HH'H'mm'm'ss", TalendDate.getCurrentDate()));
							...
							if (row2.abs_path != null) {
								sb_tFileOutputDelimited_4.append(row2.abs_path);
							}
							sb_tFileOutputDelimited_4.append(OUT_DELIM_tFileOutputDelimited_4);
							if (row2.varAssetName != null) {
								sb_tFileOutputDelimited_4.append(row2.varAssetName);
							}
							sb_tFileOutputDelimited_4.append(OUT_DELIM_tFileOutputDelimited_4);
							if (row2.dirname != null) {
								sb_tFileOutputDelimited_4.append(row2.dirname);
							}
							sb_tFileOutputDelimited_4.append(OUT_DELIM_tFileOutputDelimited_4);
							if (row2.basename != null) {
								sb_tFileOutputDelimited_4.append(row2.basename);
							}
							sb_tFileOutputDelimited_4.append(OUT_DELIM_tFileOutputDelimited_4);
							if (row2.mode_string != null) {
								sb_tFileOutputDelimited_4.append(row2.mode_string);
							}
							sb_tFileOutputDelimited_4.append(OUT_DELIM_tFileOutputDelimited_4);
							if (row2.size != null) {
								sb_tFileOutputDelimited_4.append(row2.size);
							}
							sb_tFileOutputDelimited_4.append(OUT_DELIM_tFileOutputDelimited_4);
							if (row2.mtime != null) {
								sb_tFileOutputDelimited_4.append(row2.mtime);
							}
							sb_tFileOutputDelimited_4.append(OUT_DELIM_tFileOutputDelimited_4);
							if (row2.mtime_string != null) {
								sb_tFileOutputDelimited_4.append(row2.mtime_string);
							}
							sb_tFileOutputDelimited_4.append(OUT_DELIM_tFileOutputDelimited_4);
							if (row2.photo_View != null) {
								sb_tFileOutputDelimited_4.append(row2.photo_View);
							}
...
///////////////////////		
							...
							if (display.abs_path != null) { //
								...
								strBuffer_tLogRow_2.append(String.valueOf(display.abs_path));
							...
							if (display.varAssetName != null) { //
								...
								strBuffer_tLogRow_2.append(String.valueOf(display.varAssetName));
							...
							if (display.dirname != null) { //
								...
								strBuffer_tLogRow_2.append(String.valueOf(display.dirname));
							...
							if (display.basename != null) { //
								...
								strBuffer_tLogRow_2.append(String.valueOf(display.basename));
							...
							if (display.mode_string != null) { //
								...
								strBuffer_tLogRow_2.append(String.valueOf(display.mode_string));
							...
							if (display.size != null) { //
								...
								strBuffer_tLogRow_2.append(String.valueOf(display.size));
							...
							if (display.mtime != null) { //
								...
								strBuffer_tLogRow_2.append(String.valueOf(display.mtime));
							...
							if (display.mtime_string != null) { //
								...
								strBuffer_tLogRow_2.append(String.valueOf(display.mtime_string));
							...
							if (display.photo_View != null) { //
								...
								strBuffer_tLogRow_2.append(String.valueOf(display.photo_View));
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				fileName_tFileOutputDelimited_1 = (new java.io.File(
						context.bynderDirectory + "/input/FileAssetsName.csv")).getAbsolutePath().replace("\\", "/");
				...
				try {
					...
					try {
						fid_tFileInputDelimited_2 = new org.talend.fileprocess.FileInputDelimited(
								context.bynderDirectory + "/temp/NewAssetsToUpload.csv", "ISO-8859-15", ";", "\n", true,
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"mtime", "row6", temp, ex_tFileInputDelimited_2),
						...
						if (row6 != null) {
							...
							while ((tHash_Lookup_row5 != null && tHash_Lookup_row5.hasNext()) || forceLooprow5) { // G_TM_M_043
								...
								{ // start of Var scope
									...
									Var.var1 = StringHandling.INDEX(row6.varAssetName, "PLV") > 0
											? StringHandling.LEFT(row6.varAssetName,
													StringHandling.INDEX(row6.varAssetName, "PLV") - 1)
											: StringHandling.LEFT(row6.varAssetName, 6);
									Var.var2 = StringHandling.INDEX(row6.varAssetName, "PLV") > 0 ? "PLV"
											: StringHandling.RIGHT(StringHandling.LEFT(row6.varAssetName, 10), 3);// ###############################
									// ###############################
									// # Output tables
...
// Start of branch "toUpload"
								if (toUpload != null) {
									...
									if (toUpload.filename != null) {
										sb_tFileOutputDelimited_1.append(toUpload.filename);
									}
									sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
									if (toUpload.assetname != null) {
										sb_tFileOutputDelimited_1.append(toUpload.assetname);
									}
									sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
									if (toUpload.StyleCode != null) {
										sb_tFileOutputDelimited_1.append(toUpload.StyleCode);
									}
									sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
									if (toUpload.ColorCode != null) {
										sb_tFileOutputDelimited_1.append(toUpload.ColorCode);
									}
									sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
									if (toUpload.NewTags != null) {
										sb_tFileOutputDelimited_1.append(toUpload.NewTags);
									}
									sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
									if (toUpload.PhotoView != null) {
										sb_tFileOutputDelimited_1.append(toUpload.PhotoView);
									}
					...
					if (!((Object) (context.bynderDirectory
							+ "/temp/NewAssetsToUpload.csv") instanceof java.io.InputStream)) {
...
// ###############################      
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final Process ps_tSystem_1 = runtime_tSystem_1.exec(
						"java -jar \"C:/Haddad_Interface_SF_JDE/Interface Bynder/bin/UploadAssetToBynder.jar\"",
						env_tSystem_1, new java.io.File("C:/Program Files/Java/jre1.8.0_291/bin"));
							...
							try {
								while ((line = reader.readLine()) != null) {
									...
									if (globalMap.get("tSystem_1_OUTPUT") != null) {
										globalMap.put("tSystem_1_OUTPUT",
							...
							try {
								while ((line = reader.readLine()) != null) {
									...
									if (globalMap.get("tSystem_1_ERROROUTPUT") != null) {
										globalMap.put("tSystem_1_ERROROUTPUT",
			...
			if (resumeEntryMethodName == null || globalResumeTicket) {
				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tSystem_1:OnSubjobOk", "",
						Thread.currentThread().getId() + "", "", "", "", "", "");
			}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					Object filename_tFileInputDelimited_3 = context.bynderDirectory + "/temp/assetTrated.txt";
					...
					try {
						fid_tFileInputDelimited_3 = new org.talend.fileprocess.FileInputDelimited(
								context.bynderDirectory + "/temp/assetTrated.txt", "ISO-8859-15", ";", "\n", true, 0, 0,
					...
					if (!((Object) (context.bynderDirectory
							+ "/temp/assetTrated.txt") instanceof java.io.InputStream)) {
				...
				if (!((Integer) globalMap.get("tFileInputDelimited_2_NB_LINE"))
						.equals(((Integer) globalMap.get("tFileInputDelimited_3_NB_LINE")))) {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					tLogCatcher_1.addMessage("tDie", "tDie_2", 5,
							"Error detected while uploading file : "
									+ ((Integer) globalMap.get("tFileInputDelimited_2_NB_LINE")) + " : "
									+ ((Integer) globalMap.get("tFileInputDelimited_3_NB_LINE")),
							4);
					tLogCatcher_1Process(globalMap);
					...
					System.err.println("Error detected while uploading file : "
							+ ((Integer) globalMap.get("tFileInputDelimited_2_NB_LINE")) + " : "
							+ ((Integer) globalMap.get("tFileInputDelimited_3_NB_LINE")));
	...
	public void tSleep_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeEntryMethodName == null || globalResumeTicket) {
				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tSleep_1:OnSubjobOk", "",
						Thread.currentThread().getId() + "", "", "", "", "", "");
			}
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				paraList_tRunJob_1.add("--context=BynderPhotoContext");
				...
				class ContextProcessor_tRunJob_1 {
					private void transmitContext_0() {
						...
						parentContextMap_tRunJob_1.put("jarPath", context.jarPath);
						paraList_tRunJob_1.add("--context_type " + "jarPath" + "=" + "id_String");
					}
				...
				if (obj_tRunJob_1 != null) {
					paraList_tRunJob_1.add(
							"--context_param bynderDirectory=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_1));
				} else {
					paraList_tRunJob_1.add("--context_param bynderDirectory="
							+ NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
				}
	...
	public void tSleep_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeEntryMethodName == null || globalResumeTicket) {
				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tSleep_2:OnSubjobOk", "",
						Thread.currentThread().getId() + "", "", "", "", "", "");
			}
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				class ContextProcessor_tRunJob_4 {
					private void transmitContext_0() {
						...
						parentContextMap_tRunJob_4.put("jarPath", context.jarPath);
						paraList_tRunJob_4.add("--context_type " + "jarPath" + "=" + "id_String");
					}
				...
				if (obj_tRunJob_4 != null) {
					paraList_tRunJob_4.add(
							"--context_param bynderDirectory=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_4));
				} else {
					paraList_tRunJob_4.add("--context_param bynderDirectory="
							+ NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
				}
	...
	public void tDie_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					tLogCatcher_1.addMessage("tDie", "tDie_1", 5, "Error Upload Salesforce Information into Bynder", 4);
					tLogCatcher_1Process(globalMap);

					talendLogs_LOGS.addMessage("tDie", "tDie_1", 5, "Error Upload Salesforce Information into Bynder",
							4);
					talendLogs_LOGSProcess(globalMap);

					globalMap.put("tDie_1_DIE_PRIORITY", 5);
					System.err.println("Error Upload Salesforce Information into Bynder");

					globalMap.put("tDie_1_DIE_MESSAGE", "Error Upload Salesforce Information into Bynder");
					globalMap.put("tDie_1_DIE_MESSAGES", "Error Upload Salesforce Information into Bynder");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = context.bynderDirectory
							+ "/archive/AssetsUploadedInBynder.csv";
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
								context.bynderDirectory + "/archive/AssetsUploadedInBynder.csv", "ISO-8859-15", ";",
...
// Start of branch "row5"
					...
					if (!((Object) (context.bynderDirectory
							+ "/archive/AssetsUploadedInBynder.csv") instanceof java.io.InputStream)) {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					for (LogCatcherUtils.LogCatcherMessage lcm : tLogCatcher_1.getMessages()) {
						...
						if (row4.pid != null) {
							sb_tFileOutputDelimited_2.append(row4.pid);
						}
						sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
						if (row4.root_pid != null) {
							sb_tFileOutputDelimited_2.append(row4.root_pid);
						}
						sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
						if (row4.father_pid != null) {
							sb_tFileOutputDelimited_2.append(row4.father_pid);
						}
						sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
						if (row4.project != null) {
							sb_tFileOutputDelimited_2.append(row4.project);
						}
						sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
						if (row4.job != null) {
							sb_tFileOutputDelimited_2.append(row4.job);
						}
						sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
						if (row4.context != null) {
							sb_tFileOutputDelimited_2.append(row4.context);
						}
						sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
						if (row4.priority != null) {
							sb_tFileOutputDelimited_2.append(row4.priority);
						}
						sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
						if (row4.type != null) {
							sb_tFileOutputDelimited_2.append(row4.type);
						}
						sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
						if (row4.origin != null) {
						...
						if (row4.message != null) {
							sb_tFileOutputDelimited_2.append(row4.message);
						}
						sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
						if (row4.code != null) {
							sb_tFileOutputDelimited_2.append(row4.code);
						}
	...
	public void tFileExist_5Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				globalMap.put("tFileExist_5_FILENAME",
						"C:/Haddad_Interface_SF_JDE/Interface Bynder/hors eCom/log/UploadAssetToBynder.log");
	...
	public void tFileCopy_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeEntryMethodName == null || globalResumeTicket) {
				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tFileCopy_1:OnSubjobOk1", "",
						Thread.currentThread().getId() + "", "", "", "", "", "");
			}
			...
			if (resumeEntryMethodName == null || globalResumeTicket) {
				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tFileCopy_1:OnSubjobOk2", "",
						Thread.currentThread().getId() + "", "", "", "", "", "");
			}
	...
	public void tFileDelete_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeEntryMethodName == null || globalResumeTicket) {
				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tFileDelete_2:OnSubjobOk", "",
						Thread.currentThread().getId() + "", "", "", "", "", "");
			}
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				for (int i_tFileList_3 = 0; i_tFileList_3 < list_tFileList_3.size(); i_tFileList_3++) {
					...
					if (!srcFile_tFileCopy_3.getPath().equals(desFile_tFileCopy_3.getPath())) {
						...
						java.io.File isRemoved_tFileCopy_3 = new java.io.File(
								(String) globalMap.get("tFileList_3_CURRENT_FILEPATH"));
						if (isRemoved_tFileCopy_3.exists()) {
							String errorMessageCouldNotRemoveFile_tFileCopy_3 = String.format(
									"tFileCopy_3 - The source file \"%s\" could not be removed from the folder because it is open or you only have read-only rights.",
									srcFileName_tFileCopy_3);
	...
	public void tFileCopy_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String desFileFolderPath_tFileCopy_2 = context.bynderImage + "/archive/AssetsUploadedInBynder/"
						+ (String) globalMap.get("ExecDate");
				...
				java.io.File newDesFileFolder_tFileCopy_2 = new java.io.File(desFileFolder_tFileCopy_2,
						srcFolderName_tFileCopy_2);
				...
				class CopyDirectory_tFileCopy_2 {
					...
					public void copyAllFiles(java.io.File rootFolder, int pathLength, java.io.File newDesFileFolder) {
						...
						if (fileList != null) {
							...
							String errorMessageInputOutputErrorOccurs_tFileCopy_2 = String.format(
									"Path name \"%s\" does not denote a directory, or if an I/O error occurs.",
									rootFolder.getPath());
				...
				copyDir_tFileCopy_2.copyAllFiles(srcFileFolder_tFileCopy_2, srcFilePathLength_tFileCopy_2,
						newDesFileFolder_tFileCopy_2);
			...
			if (resumeEntryMethodName == null || globalResumeTicket) {
				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tFileCopy_2:OnSubjobOk", "",
						Thread.currentThread().getId() + "", "", "", "", "", "");
			}
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				for (final String filemask_tFileList_4 : maskList_tFileList_4) {
					...
					java.util.regex.Pattern fileNamePattern_tFileList_4 = java.util.regex.Pattern
							.compile(filemask_compile_tFileList_4, java.util.regex.Pattern.CASE_INSENSITIVE);
	...
	public void tFileList_5Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				int NB_ITERATE_tFileDelete_5 = 0; // for statistics
				...
				String directory_tFileList_5 = context.bynderImage + "/image/temp/";
				...
				for (final String filemask_tFileList_5 : maskList_tFileList_5) {
					...
					java.util.regex.Pattern fileNamePattern_tFileList_5 = java.util.regex.Pattern
							.compile(filemask_compile_tFileList_5, java.util.regex.Pattern.CASE_INSENSITIVE);
				...
				for (int i_tFileList_5 = 0; i_tFileList_5 < list_tFileList_5.size(); i_tFileList_5++) {
					 ...
					 */
					NB_ITERATE_tFileDelete_5++;

					if (execStat) {
						runStat.updateStatOnConnection("iterate6", 1, "exec" + NB_ITERATE_tFileDelete_5);
						// Thread.sleep(1000);
					}
					...
					java.io.File file_tFileDelete_5 = new java.io.File(
							(String) globalMap.get("tFileList_5_CURRENT_FILEPATH"));
					...
					globalMap.put("tFileDelete_5_DELETE_PATH", (String) globalMap.get("tFileList_5_CURRENT_FILEPATH"));
					 ...
					 */
					if (execStat) {
						runStat.updateStatOnConnection("iterate6", 2, "exec" + NB_ITERATE_tFileDelete_5);
					}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				fileName_tFileOutputDelimited_3 = (new java.io.File(
						"C:/Haddad_Interface_SF_JDE/Interface Salesforce/Salesforce_Configurations/Extract_Assets_CreatedLastRun.tmp"))
								.getAbsolutePath().replace("\\", "/");
				...
				try {
					...
					try {
						fid_tFileInputDelimited_4 = new org.talend.fileprocess.FileInputDelimited(
								"C:/Haddad_Interface_SF_JDE/Interface Salesforce/Salesforce_Configurations/Extract_Assets_CreatedLastRun",
...
//System.out.println("EcomTag : " + ((String)globalMap.get("EcomTag")) );
							context.jarPath = "\"C:/Program Files/Java/jre1.8.0_291/bin/\"";
							context.jarPath += "java -jar ";
							context.jarPath += "\"C:/Haddad_Interface_SF_JDE/Interface Bynder/bin/UploadAssetToBynder.jar\"";
							System.out.println(context.jarPath);
							nb_line_tJavaRow_2++;
...
///System.out.println( " dd  : " + TalendDate.parseDate("M/d/yyyy H:mm:ss", "Tue Jan 07 14:42:20 CET 2020")
							...
							if (row33.Value != null) {
								sb_tFileOutputDelimited_3.append(row33.Value);
							}
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (!srcFile_tFileCopy_4.getPath().equals(desFile_tFileCopy_4.getPath())) {
					...
					if (isRemoved_tFileCopy_4.exists()) {
						String errorMessageCouldNotRemoveFile_tFileCopy_4 = String.format(
								"tFileCopy_4 - The source file \"%s\" could not be removed from the folder because it is open or you only have read-only rights.",
					...
					for (LogCatcherUtils.LogCatcherMessage lcm : talendLogs_LOGS.getMessages()) {
						...
						if (row_talendLogs_FILE.moment != null) {
							pstmt_talendLogs_DB.setTimestamp(1,
									new java.sql.Timestamp(row_talendLogs_FILE.moment.getTime()));
						} else {
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = UploadAssetIntoBynder_PROD.class.getClassLoader()
					.getResourceAsStream("dev/uploadassetintobynder_prod_1_14/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = UploadAssetIntoBynder_PROD.class.getClassLoader()
			...
			class ContextProcessing {
				private void processContext_0() {
					...
					context.setContextType("jarPath", "id_String");
					context.jarPath = (String) context.getProperty("jarPath");
				}
		...
		if (parentContextMap != null && !parentContextMap.isEmpty()) {
			...
			if (parentContextMap.containsKey("jarPath")) {
				context.jarPath = (String) parentContextMap.get("jarPath");
			}
		}
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : UploadAssetIntoBynder_PROD");
		}
...
/************************************************************************************************
 * 455244 characters generated by Talend Open Studio for Data Integration on the
 * 19 septembre 2023 14:17:38 CEST
 ************************************************************************************************/