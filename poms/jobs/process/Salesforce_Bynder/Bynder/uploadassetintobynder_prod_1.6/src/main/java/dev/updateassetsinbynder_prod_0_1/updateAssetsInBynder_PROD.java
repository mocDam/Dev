...
try {
	...
	final String decryptedPassword_tRESTClient_3 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[xMhxPDQl6s5voGoP6kWRUj3A6RwTbe2n5OCb9DPRE77M6nAXRBw=]");
	...
	final String decryptedPassword_tRESTClient_3 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[VPCiGPFgSrSSc0xytWhwpRPgANqXOQ2vh2ye7Gwr9M4g8/JUrMs=]");
	...
	final String decryptedPassword_tRESTClient_3 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[/vqcYJmGss1wyADekZkJ3EsNEnAGMukJCqe40zZuRbYkr/LPopU=]");
	...
	final String decryptedPassword_tRESTClient_3 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[aFDYLMFllrhYkwVXkjLPqkfpE1BamcOzj9fZ+g==]");
	...
	final String decryptedPassword_tRESTClient_3 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[ADJQkxgXiGyFN/JTi+2ZrvuHytiLukj7Tdu9/hM67bmz44Sqn3Y=]");
...
org.talend.components.salesforce.SalesforceConnectionProperties props_tSalesforceConnection_1 =
        (org.talend.components.salesforce.SalesforceConnectionProperties) def_tSalesforceConnection_1.createRuntimeProperties();
 		                    ...
 		                    "systemuser@haddadeurope.com");
 		                        ...
 		                        routines.system.PasswordEncryptUtil.decryptPassword("ENC:[f7VTUmUpKhUskwntvutWoEpQiy4tchGWNRq55v+3PApYVNiN8WqIHrViSPWxlT+T+c8Imp8=]"));
 		                    ...
 		                    "systemuser@haddadeurope.com");
 		                        ...
 		                        routines.system.PasswordEncryptUtil.decryptPassword("ENC:[rQTUK3L9eGcxZb5dFemMjVuQJ+uuidY47lImuk30m1zfgEisYaWNPHzzIc+R]"));
	...
	currentComponent="tUniqRow_4";
		...
		class KeyStruct_tUniqRow_4 {
		    ...
		    public boolean hashCodeDirty = true;
					...
					String ProductCode;
					String Product_Code_External_Id__c;        
			...
			public int hashCode() {
				if (this.hashCodeDirty) {
					...
					int result = DEFAULT_HASHCODE;
								...
								result = prime * result + ((this.Product_Code_External_Id__c == null) ? 0 : this.Product_Code_External_Id__c.hashCode());
			...
			public boolean equals(Object obj) {
				...
				final KeyStruct_tUniqRow_4 other = (KeyStruct_tUniqRow_4) obj;
									...
									if (this.Product_Code_External_Id__c == null) {
										if (other.Product_Code_External_Id__c != null) 
											return false;
								
									} else if (!this.Product_Code_External_Id__c.equals(other.Product_Code_External_Id__c))
 		                    ...
 		                    class SchemaSettingTool_tSalesforceInput_1_1_fisrt {
 		                    		...
 		                    		String getSchemaValue() {
 		                    						...
 		                    						StringBuilder s = new StringBuilder();
     		                    						...
     		                    						a("\"name\":\"Description\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"Description\",\"talend.field.dbColumnName\":\"Description\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"4000\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"Description\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"Gender_Haddad__c\",\"type\":\"string\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"Gender_Haddad__c\",\"talend.field.dbColumnName\":\"Gender_Haddad__c\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"255\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"Gender_Haddad__c\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"IsActive\",\"type\":\"boolean\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"IsActive\",\"talend.field.dbColumnName\":\"IsActive\",\"di.column.talendType\":\"id_Boolean\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"IsActive\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						...
     		                    						a("\"name\":\"Product_Status__c\",\"type\":\"string\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"Product_Status__c\",\"talend.field.dbColumnName\":\"Product_Status__c\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"255\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"Product_Status__c\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"Ref__c\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"Ref__c\",\"talend.field.dbColumnName\":\"Ref__c\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"1300\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"Ref__c\",\"di.column.relatedEntity\":\"\"},{",s);
...
if(row5.ProductCode == null){
	finder_tUniqRow_4.ProductCode = null;
}else{
	finder_tUniqRow_4.ProductCode = row5.ProductCode.toLowerCase();
}
if(row5.Product_Code_External_Id__c == null){
	finder_tUniqRow_4.Product_Code_External_Id__c = null;
}else{
	finder_tUniqRow_4.Product_Code_External_Id__c = row5.Product_Code_External_Id__c.toLowerCase();
}	
...
if(row5.ProductCode == null){
	new_tUniqRow_4.ProductCode = null;
}else{
	new_tUniqRow_4.ProductCode = row5.ProductCode.toLowerCase();
}
if(row5.Product_Code_External_Id__c == null){
	new_tUniqRow_4.Product_Code_External_Id__c = null;
}else{
	new_tUniqRow_4.Product_Code_External_Id__c = row5.Product_Code_External_Id__c.toLowerCase();
}
...
try {
	...
	final String decryptedPassword_tRESTClient_4 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[5H4Is+AVnazkjrUqtYHYuLptMcqlQjxisLzi5rmHuqna9kmbP1E=]");
	...
	final String decryptedPassword_tRESTClient_4 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[RZApDoGnXQkVBt1y7C0oeZ7j3DAk3hHIGasPUyu/wls5KcEQ7ew=]");
	...
	final String decryptedPassword_tRESTClient_4 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[HH8HQb3lVB4djzvDeGOhEAGIiclJ/mlK85Fh7gUKeulplgLvXZA=]");
	...
	final String decryptedPassword_tRESTClient_4 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[PG0lZPeFIHjC5NlJvSXD/hG7zYnXW9ZeWRUM8g==]");
	...
	final String decryptedPassword_tRESTClient_4 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[QfHomTLcHlIDY2KaCJp0mRLI5YU0wGrWx9qCLuecNBextzW5laI=]");
	...
	// if FORM request then capture query parameters into Form, otherwise set them as queries
			...
			webClient_tRESTClient_4.query("property_Color_Code" ,row7.Color_Haddad__r_Name);
...
try {
	...
	final String decryptedPassword_tRESTClient_2 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[Fg7aq1tioKhvdiHUvX1gLfwKSlZn0mS3cXfccTai2RXT79C/MdI=]");
	...
	final String decryptedPassword_tRESTClient_2 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[B9tSs9nAvnyCJNhcDwpCdpd8gzvIk1p1TgeFTuwj0qf2xfahbHI=]");
	...
	final String decryptedPassword_tRESTClient_2 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[Y/EFLEwxuNcngeTmPVzIMdf9PeCnZR3MMCkL/jHj+pUEJ8u6jDM=]");
	...
	final String decryptedPassword_tRESTClient_2 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[G15pgtZef/56pe7EWg/Yh31RP77GjJWdgKfWzg==]");
	...
	final String decryptedPassword_tRESTClient_2 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[9yPwnLba5GfPSO0s01oz77NyBY/ELCF45CO2wAGwBGw9n9KB/DY=]");
...
/************************************************************************************************
 *     821630 characters generated by Talend Open Studio for Data Integration 
 *     on the 21 février 2023 11:13:18 CET
 ************************************************************************************************/