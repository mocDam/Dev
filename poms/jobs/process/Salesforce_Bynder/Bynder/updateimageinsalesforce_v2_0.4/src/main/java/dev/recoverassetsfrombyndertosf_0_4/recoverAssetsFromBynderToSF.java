...
package dev.recoverassetsfrombyndertosf_0_4;
...
/**
 * Job: recoverAssetsFromBynderToSF Purpose: recoverAssetsFromBynderToSF<br>
 * Description: recoverAssetsFromBynderToSF <br>
 * 
 * @author user@talend.com
 * @version 7.3.1.20191031_1204-M3
 * @status
 */
public class recoverAssetsFromBynderToSF implements TalendJob {
	...
	private final String jobName = "recoverAssetsFromBynderToSF";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					recoverAssetsFromBynderToSF.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(recoverAssetsFromBynderToSF.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tSalesforceConnection_2_error(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public void tSalesforceInput_2_error(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public void tSalesforceOutput_3_error(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public void tSalesforceOutput_4_error(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public void tSalesforceOutput_5_error(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public void tSalesforceInput_3_error(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public void tSalesforceConnection_2_onSubJobError(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public void tSalesforceInput_2_onSubJobError(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public void tSalesforceInput_3_onSubJobError(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public void tFileCopy_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String srcFileName_tFileCopy_1 = "C:/Haddad_Interface_SF_JDE/Interface Bynder/hors eCom/recoverAssetsFromBynderToSF/assetsToInsertInSF.csv";
				...
				String desDirName_tFileCopy_1 = "C:/Haddad_Interface_SF_JDE/Interface Bynder/hors eCom/recoverAssetsFromBynderToSF/"
						+ (String) globalMap.get("ExcDate");

				String desFileName_tFileCopy_1 = "assetsInsertedInSF.csv";
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				java.io.File file_tFileDelete_1 = new java.io.File(
						"C:/Haddad_Interface_SF_JDE/Interface Bynder/hors eCom/recoverAssetsFromBynderToSF/assetsToInsertInSF.csv");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				java.io.File file_tFileDelete_2 = new java.io.File(
						"C:/Haddad_Interface_SF_JDE/Interface Bynder/hors eCom/recoverAssetsFromBynderToSF/Error.log");
	...
	public void tSalesforceConnection_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				props_tSalesforceConnection_2.setValue("endpoint", "https://login.salesforce.com/services/Soap/u/45.0");
				...
				props_tSalesforceConnection_2.setValue("bulkConnection", false);

				props_tSalesforceConnection_2.setValue("reuseSession", false);

				props_tSalesforceConnection_2.setValue("needCompression", false);

				props_tSalesforceConnection_2.setValue("timeout", 6000);

				props_tSalesforceConnection_2.setValue("httpChunked", true);

				props_tSalesforceConnection_2.setValue("clientId", "zeine.mahbouby@haddadeurope.com");

				props_tSalesforceConnection_2.userPassword.setValue("securityKey",
						routines.system.PasswordEncryptUtil.decryptPassword(
								"ENC:[fz/RQbXK5ORIuZnfqAMcdjKo6i4oYf4e9qAodV8zVG+pCKhzjG1Juyns2WfXEeu31hG5XQ==]"));

				props_tSalesforceConnection_2.userPassword.setValue("useAuth", false);

				props_tSalesforceConnection_2.userPassword.setValue("userId", "zeine.mahbouby@haddadeurope.com");

				props_tSalesforceConnection_2.userPassword.setValue("password", routines.system.PasswordEncryptUtil
						.decryptPassword("ENC:[vdpwkx8JsmOQJhBVIyUPnusHnnrEpCG7hnTC7C5aTfVAjw0/4l/n]"));

				props_tSalesforceConnection_2.proxy.setValue("useProxy", false);

				props_tSalesforceConnection_2.proxy.userPassword.setValue("useAuth", false);
				...
				org.talend.daikon.runtime.RuntimeInfo runtime_info_tSalesforceConnection_2 = def_tSalesforceConnection_2
						.getRuntimeInfo(org.talend.components.api.component.runtime.ExecutionEngine.DI,
								props_tSalesforceConnection_2, topology_tSalesforceConnection_2);
				...
				org.talend.components.api.component.runtime.RuntimableRuntime componentRuntime_tSalesforceConnection_2 = (org.talend.components.api.component.runtime.RuntimableRuntime) (Class
						.forName(runtime_info_tSalesforceConnection_2.getRuntimeClassName()).newInstance());
				org.talend.daikon.properties.ValidationResult initVr_tSalesforceConnection_2 = componentRuntime_tSalesforceConnection_2
						.initialize(container_tSalesforceConnection_2, props_tSalesforceConnection_2);

				if (initVr_tSalesforceConnection_2
...
// end of generic
			...
			if (resumeEntryMethodName == null || globalResumeTicket) {
				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tSalesforceConnection_2:OnSubjobOk", "",
						Thread.currentThread().getId() + "", "", "", "", "", "");
			}
...
// finally of generic
	...
	public static class row7Struct implements routines.system.IPersistableRow<row7Struct> {
		final static byte[] commonByteArrayLock_DEV_recoverAssetsFromBynderToSF = new byte[0];
		static byte[] commonByteArray_DEV_recoverAssetsFromBynderToSF = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_DEV_recoverAssetsFromBynderToSF.length) {
					if (length < 1024 && commonByteArray_DEV_recoverAssetsFromBynderToSF.length == 0) {
						commonByteArray_DEV_recoverAssetsFromBynderToSF = new byte[1024];
					} else {
						commonByteArray_DEV_recoverAssetsFromBynderToSF = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_DEV_recoverAssetsFromBynderToSF, 0, length);
				strReturn = new String(commonByteArray_DEV_recoverAssetsFromBynderToSF, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DEV_recoverAssetsFromBynderToSF) {
	...
	public static class mDStruct implements routines.system.IPersistableRow<mDStruct> {
		final static byte[] commonByteArrayLock_DEV_recoverAssetsFromBynderToSF = new byte[0];
		static byte[] commonByteArray_DEV_recoverAssetsFromBynderToSF = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(mDStruct other) {
	...
	public static class outURLStruct implements routines.system.IPersistableRow<outURLStruct> {
		final static byte[] commonByteArrayLock_DEV_recoverAssetsFromBynderToSF = new byte[0];
		static byte[] commonByteArray_DEV_recoverAssetsFromBynderToSF = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(outURLStruct other) {
	...
	public static class updateMDBynderStruct implements routines.system.IPersistableRow<updateMDBynderStruct> {
		final static byte[] commonByteArrayLock_DEV_recoverAssetsFromBynderToSF = new byte[0];
		static byte[] commonByteArray_DEV_recoverAssetsFromBynderToSF = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(updateMDBynderStruct other) {
	...
	public static class noAssetsAvailableStruct implements routines.system.IPersistableRow<noAssetsAvailableStruct> {
		final static byte[] commonByteArrayLock_DEV_recoverAssetsFromBynderToSF = new byte[0];
		static byte[] commonByteArray_DEV_recoverAssetsFromBynderToSF = new byte[0];
		...
		public String bynderStatus;

		public String getBynderStatus() {
			return this.bynderStatus;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DEV_recoverAssetsFromBynderToSF) {
				...
				try {
					...
					this.bynderStatus = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.bynderStatus, dos);
		...
		public String toString() {
			...
			sb.append(",bynderStatus=" + bynderStatus);
			sb.append("]");
		 ...
		 * Compare keys
		 */
		public int compareTo(noAssetsAvailableStruct other) {
	...
	public static class after_tSalesforceInput_2Struct
			implements routines.system.IPersistableRow<after_tSalesforceInput_2Struct> {
		final static byte[] commonByteArrayLock_DEV_recoverAssetsFromBynderToSF = new byte[0];
		static byte[] commonByteArray_DEV_recoverAssetsFromBynderToSF = new byte[0];
	...
	public void tSalesforceInput_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				outURLStruct outURL = new outURLStruct();
				outURLStruct row15 = outURL;
				updateMDBynderStruct updateMDBynder = new updateMDBynderStruct();
				mDStruct mD = new mDStruct();
				row7Struct row7 = new row7Struct();
				noAssetsAvailableStruct noAssetsAvailable = new noAssetsAvailableStruct();
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "outURL");
				}
				...
				if (filetFileOutputDelimited_1.length() == 0) {
					...
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("image");
...
///////////////////////    			
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "mD");
				}
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "updateMDBynder");
				}
...
// # Outputs initialization
				outURLStruct outURL_tmp = new outURLStruct();
				updateMDBynderStruct updateMDBynder_tmp = new updateMDBynderStruct();
// ###############################
...
// ###############################
// # Outputs initialization
				row32Struct row32_tmp = new row32Struct();
// ###############################
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "noAssetsAvailable");
				}
				...
				fileName_tFileOutputDelimited_3 = (new java.io.File(
						"C:/Haddad_Interface_SF_JDE/Interface Bynder/hors eCom/recoverAssetsFromBynderToSF/"
								+ (String) globalMap.get("ExcDate") + "/noAssetsInBynder.csv")).getAbsolutePath()
										.replace("\\", "/");
				...
				if (filetFileOutputDelimited_3.length() == 0) {
					outtFileOutputDelimited_3.write("Style_Color");
					outtFileOutputDelimited_3.write(OUT_DELIM_tFileOutputDelimited_3);
					outtFileOutputDelimited_3.write("bynderStatus");
...
// # Outputs initialization
				...
				noAssetsAvailableStruct noAssetsAvailable_tmp = new noAssetsAvailableStruct();
// ###############################
...
// ###############################
				...
				props_tSalesforceInput_2.connection.userPassword.setValue("useAuth", false);

				props_tSalesforceInput_2.connection.proxy.userPassword.setValue("useAuth", false);
				...
				props_tSalesforceInput_2.module.setValue("moduleName", "Product2");

				props_tSalesforceInput_2.module.connection.userPassword.setValue("useAuth", false);

				props_tSalesforceInput_2.module.connection.proxy.userPassword.setValue("useAuth", false);
				...
				org.talend.daikon.runtime.RuntimeInfo runtime_info_tSalesforceInput_2 = def_tSalesforceInput_2
						.getRuntimeInfo(org.talend.components.api.component.runtime.ExecutionEngine.DI,
								props_tSalesforceInput_2, topology_tSalesforceInput_2);
				...
				org.talend.components.api.component.runtime.RuntimableRuntime componentRuntime_tSalesforceInput_2 = (org.talend.components.api.component.runtime.RuntimableRuntime) (Class
						.forName(runtime_info_tSalesforceInput_2.getRuntimeClassName()).newInstance());
				org.talend.daikon.properties.ValidationResult initVr_tSalesforceInput_2 = componentRuntime_tSalesforceInput_2
						.initialize(container_tSalesforceInput_2, props_tSalesforceInput_2);

				if (initVr_tSalesforceInput_2
						.getStatus() == org.talend.daikon.properties.ValidationResult.Result.ERROR) {
				...
				org.talend.codegen.enforcer.OutgoingSchemaEnforcer outgoingEnforcer_tSalesforceInput_2 = org.talend.codegen.enforcer.EnforcerCreator
						.createOutgoingEnforcer(schema_tSalesforceInput_2, false);
				...
				for (; available_tSalesforceInput_2; available_tSalesforceInput_2 = reader_tSalesforceInput_2
					...
					try {
						...
						outgoingEnforcer_tSalesforceInput_2
								.setWrapped(factory_tSalesforceInput_2.convertToAvro(data_tSalesforceInput_2));
						Object columnValue_0_tSalesforceInput_2 = outgoingEnforcer_tSalesforceInput_2.get(0);
						row28.Id = (String) (columnValue_0_tSalesforceInput_2);
						...
						errorMessage_tSalesforceInput_2 = "Row " + nb_line_tSalesforceInput_2 + ": "
					...
					if (row28.Color_Code_Haddad__c == null) {
						finder_tUniqRow_8.Color_Code_Haddad__c = null;
					} else {
						finder_tUniqRow_8.Color_Code_Haddad__c = row28.Color_Code_Haddad__c.toLowerCase();
					}
					if (row28.Style_Haddad__r_Name == null) {
						finder_tUniqRow_8.Style_Haddad__r_Name = null;
					} else {
						finder_tUniqRow_8.Style_Haddad__r_Name = row28.Style_Haddad__r_Name.toLowerCase();
					}
					...
					if (!keystUniqRow_8.contains(finder_tUniqRow_8)) {
						...
						if (row28.Color_Code_Haddad__c == null) {
							new_tUniqRow_8.Color_Code_Haddad__c = null;
						} else {
							new_tUniqRow_8.Color_Code_Haddad__c = row28.Color_Code_Haddad__c.toLowerCase();
						}
						if (row28.Style_Haddad__r_Name == null) {
							new_tUniqRow_8.Style_Haddad__r_Name = null;
						} else {
							new_tUniqRow_8.Style_Haddad__r_Name = row28.Style_Haddad__r_Name.toLowerCase();
						}
							...
							try {
								...
								if (use_auth_tRESTClient_1 && "SAML".equals("OAUTH2_BEARER")) {
									...
									final String decryptedPassword_tRESTClient_1 = routines.system.PasswordEncryptUtil
											.decryptPassword(
													"ENC:[AMD6ERlrlSSnxBtxpgCRNxhjqxet5Xs9O1f1m6WyI+rSzFkAKyI=]");
									...
									org.talend.esb.security.saml.SAMLRESTUtils
											.configureClient(factoryBean_tRESTClient_1, stsClient);
								}
								...
								if (use_auth_tRESTClient_1 && "BASIC".equals("OAUTH2_BEARER")) {
									...
									final String decryptedPassword_tRESTClient_1 = routines.system.PasswordEncryptUtil
											.decryptPassword(
													"ENC:[MFfotEYd8hZJEfpxAt28KOVZ9bVEuh4dY6ddhwfeBZhX6zQGzLw=]");
									...
									final String decryptedPassword_tRESTClient_1 = routines.system.PasswordEncryptUtil
											.decryptPassword(
													"ENC:[WSbRDAJZc82uigMlLH3fl4GpphNdX4+q2CMvZNYDThnTm9CZa5M=]");
								...
								if (!inOSGi) {
									...
									if (use_proxy_tRESTClient_1) {
										...
										final String decryptedPassword_tRESTClient_1 = routines.system.PasswordEncryptUtil
												.decryptPassword("ENC:[a/F0du1G8wv9vBa966BWhczadiPzLKyUej+MgQ==]");
								...
								clientConfig_tRESTClient_1.getRequestContext().put("http.redirect.same.host.only",
										false);
								...
								if (use_auth_tRESTClient_1 && "OIDC_PASSWORD_GRANT".equals("OAUTH2_BEARER")) {
									...
									final String decryptedPassword_tRESTClient_1 = routines.system.PasswordEncryptUtil
											.decryptPassword(
													"ENC:[tEHkvHEywXtLUiTwkLerYGueLx4dRTrEzXiLYdnwBZgbo+12pbA=]");
								...
								webClient_tRESTClient_1.query("property_Style_Code", getAssets.Style_Haddad__r_Name);

								webClient_tRESTClient_1.query("property_Color_Code", getAssets.Color_Code_Haddad__c);
...
// Start of branch "row6"
							if (row6 != null) {
								...
								{ // start of Var scope
									...
									Reponse = null;
									noAssetsAvailable = null;

// # Output table : 'Reponse'
// # Filter conditions 
									if (

									row6.string.equals("[]") == false

									) {
										Reponse_tmp.body = row6.body;
										Reponse_tmp.string = row6.string;
										Reponse_tmp.statusCode = row6.statusCode;
										Reponse = Reponse_tmp;
									} // closing filter/reject

// # Output table : 'noAssetsAvailable'
// # Filter conditions 
									if (

									row6.string.equals("[]") == true

									) {
										noAssetsAvailable_tmp.Style_Color = row1.Name;
										noAssetsAvailable_tmp.bynderStatus = "No assests available";
										noAssetsAvailable = noAssetsAvailable_tmp;
									} // closing filter/reject
// ###############################
...
// Start of branch "Reponse"
								if (Reponse != null) {
									...
									if (Reponse.string != null) {// C_01
										jsonStr_tExtractJSONFields_3 = Reponse.string.toString();
										...
										try {
											...
											Object result_tExtractJSONFields_3 = document_tExtractJSONFields_3.read(
													compiledLoopPath_tExtractJSONFields_3,
											...
											if (!isStructError_tExtractJSONFields_3) {
												...
												try {
													...
													try {
														...
														row33.id = value_tExtractJSONFields_3 == null ?
													...
													jsonPath_tExtractJSONFields_3 = "$.description";
													compiledJsonPath_tExtractJSONFields_3 = jsonPathCache_tExtractJSONFields_3
															.getCompiledJsonPath(jsonPath_tExtractJSONFields_3);
													...
													try {
														...
														row33.description = value_tExtractJSONFields_3 == null ?
													...
													try {
														...
														row33.type = value_tExtractJSONFields_3 == null ?
													...
													jsonPath_tExtractJSONFields_3 = "$.idHash";
													compiledJsonPath_tExtractJSONFields_3 = jsonPathCache_tExtractJSONFields_3
															.getCompiledJsonPath(jsonPath_tExtractJSONFields_3);
													...
													try {
														...
														row33.idHash = value_tExtractJSONFields_3 == null ?
													...
													jsonPath_tExtractJSONFields_3 = "$.tags";
													compiledJsonPath_tExtractJSONFields_3 = jsonPathCache_tExtractJSONFields_3
															.getCompiledJsonPath(jsonPath_tExtractJSONFields_3);
													...
													try {
														...
														row33.tags = value_tExtractJSONFields_3 == null ?
													...
													jsonPath_tExtractJSONFields_3 = "$.brandId";
													compiledJsonPath_tExtractJSONFields_3 = jsonPathCache_tExtractJSONFields_3
															.getCompiledJsonPath(jsonPath_tExtractJSONFields_3);
													...
													try {
														...
														row33.brandId = value_tExtractJSONFields_3 == null ?
													...
													try {
														...
														row33.name = value_tExtractJSONFields_3 == null ?
													...
													jsonPath_tExtractJSONFields_3 = "$.property_Color_Code";
													compiledJsonPath_tExtractJSONFields_3 = jsonPathCache_tExtractJSONFields_3
															.getCompiledJsonPath(jsonPath_tExtractJSONFields_3);
													...
													try {
														...
														row33.property_Color_Code = value_tExtractJSONFields_3 == null ?

																null

																: value_tExtractJSONFields_3.toString();
													} catch (com.jayway.jsonpath.PathNotFoundException e_tExtractJSONFields_3) {
														row33.property_Color_Code =

																null

														;
													}
													jsonPath_tExtractJSONFields_3 = "$.property_Style_Code";
													compiledJsonPath_tExtractJSONFields_3 = jsonPathCache_tExtractJSONFields_3
															.getCompiledJsonPath(jsonPath_tExtractJSONFields_3);
													...
													try {
														...
														row33.property_Style_Code = value_tExtractJSONFields_3 == null ?

																null

																: value_tExtractJSONFields_3.toString();
													} catch (com.jayway.jsonpath.PathNotFoundException e_tExtractJSONFields_3) {
														row33.property_Style_Code =

																null

														;
													}
													jsonPath_tExtractJSONFields_3 = "$.property_Brand";
													compiledJsonPath_tExtractJSONFields_3 = jsonPathCache_tExtractJSONFields_3
															.getCompiledJsonPath(jsonPath_tExtractJSONFields_3);
													...
													try {
														...
														row33.property_Brand = value_tExtractJSONFields_3 == null ?

																null

																: value_tExtractJSONFields_3.toString();
													} catch (com.jayway.jsonpath.PathNotFoundException e_tExtractJSONFields_3) {
														row33.property_Brand =

																null

														;
													}
													jsonPath_tExtractJSONFields_3 = "$.extension";
													compiledJsonPath_tExtractJSONFields_3 = jsonPathCache_tExtractJSONFields_3
															.getCompiledJsonPath(jsonPath_tExtractJSONFields_3);
													...
													try {
														...
														row33.extension = value_tExtractJSONFields_3 == null ?
													...
													jsonPath_tExtractJSONFields_3 = "$.property_Style_Reference";
													compiledJsonPath_tExtractJSONFields_3 = jsonPathCache_tExtractJSONFields_3
															.getCompiledJsonPath(jsonPath_tExtractJSONFields_3);
													...
													try {
														...
														row33.property_Style_Reference = value_tExtractJSONFields_3 == null
																?
														...
														row33.property_Style_Reference =

																null

														;
													}
													jsonPath_tExtractJSONFields_3 = "$.isPublic";
													compiledJsonPath_tExtractJSONFields_3 = jsonPathCache_tExtractJSONFields_3
															.getCompiledJsonPath(jsonPath_tExtractJSONFields_3);
													...
													try {
														...
														row33.isPublic = value_tExtractJSONFields_3 == null ?
													...
													jsonPath_tExtractJSONFields_3 = "$.property_Season";
													compiledJsonPath_tExtractJSONFields_3 = jsonPathCache_tExtractJSONFields_3
															.getCompiledJsonPath(jsonPath_tExtractJSONFields_3);
													...
													try {
														...
														row33.property_Season = value_tExtractJSONFields_3 == null ?

																null

																: value_tExtractJSONFields_3.toString();
													} catch (com.jayway.jsonpath.PathNotFoundException e_tExtractJSONFields_3) {
														row33.property_Season =

																null

														;
													}
													jsonPath_tExtractJSONFields_3 = "$.property_Year";
													compiledJsonPath_tExtractJSONFields_3 = jsonPathCache_tExtractJSONFields_3
															.getCompiledJsonPath(jsonPath_tExtractJSONFields_3);
													...
													try {
														...
														row33.property_Year = value_tExtractJSONFields_3 == null ?
													...
													jsonPath_tExtractJSONFields_3 = "$.property_Asset_Type";
													compiledJsonPath_tExtractJSONFields_3 = jsonPathCache_tExtractJSONFields_3
															.getCompiledJsonPath(jsonPath_tExtractJSONFields_3);
													...
													try {
														...
														row33.property_Asset_Type = value_tExtractJSONFields_3 == null ?

																null

																: value_tExtractJSONFields_3.toString();
													} catch (com.jayway.jsonpath.PathNotFoundException e_tExtractJSONFields_3) {
														row33.property_Asset_Type =

																null

														;
													}
													jsonPath_tExtractJSONFields_3 = "$.property_Asset_Subtype";
													compiledJsonPath_tExtractJSONFields_3 = jsonPathCache_tExtractJSONFields_3
															.getCompiledJsonPath(jsonPath_tExtractJSONFields_3);
													...
													try {
														...
														row33.property_Asset_Subtype = value_tExtractJSONFields_3 == null
																?
														...
														row33.property_Asset_Subtype =

																null

														;
													}
													jsonPath_tExtractJSONFields_3 = "$.userCreated";
													compiledJsonPath_tExtractJSONFields_3 = jsonPathCache_tExtractJSONFields_3
															.getCompiledJsonPath(jsonPath_tExtractJSONFields_3);
													...
													try {
														...
														row33.userCreated = value_tExtractJSONFields_3 == null ?
													...
													jsonPath_tExtractJSONFields_3 = "$.filename";
													compiledJsonPath_tExtractJSONFields_3 = jsonPathCache_tExtractJSONFields_3
															.getCompiledJsonPath(jsonPath_tExtractJSONFields_3);
													...
													try {
														...
														row33.filename = value_tExtractJSONFields_3 == null ?
													...
													jsonPath_tExtractJSONFields_3 = "$.property_Gender";
													compiledJsonPath_tExtractJSONFields_3 = jsonPathCache_tExtractJSONFields_3
															.getCompiledJsonPath(jsonPath_tExtractJSONFields_3);
													...
													try {
														...
														row33.property_Gender = value_tExtractJSONFields_3 == null ?

																null

																: value_tExtractJSONFields_3.toString();
													} catch (com.jayway.jsonpath.PathNotFoundException e_tExtractJSONFields_3) {
														row33.property_Gender =

																null

														;
													}
													jsonPath_tExtractJSONFields_3 = "$.property_Age_Group";
													compiledJsonPath_tExtractJSONFields_3 = jsonPathCache_tExtractJSONFields_3
															.getCompiledJsonPath(jsonPath_tExtractJSONFields_3);
													...
													try {
														...
														row33.property_Age_Group = value_tExtractJSONFields_3 == null ?

																null

																: value_tExtractJSONFields_3.toString();
													} catch (com.jayway.jsonpath.PathNotFoundException e_tExtractJSONFields_3) {
														row33.property_Age_Group =

																null

														;
													}
													jsonPath_tExtractJSONFields_3 = "$.property_Division";
													compiledJsonPath_tExtractJSONFields_3 = jsonPathCache_tExtractJSONFields_3
															.getCompiledJsonPath(jsonPath_tExtractJSONFields_3);
													...
													try {
														...
														row33.property_Sub_Division = value_tExtractJSONFields_3 == null
																?
														...
														row33.property_Sub_Division =

																null

														;
													}
													jsonPath_tExtractJSONFields_3 = "$.property_Sub_Division";
													compiledJsonPath_tExtractJSONFields_3 = jsonPathCache_tExtractJSONFields_3
															.getCompiledJsonPath(jsonPath_tExtractJSONFields_3);
													...
													try {
														...
														row33.property_Division = value_tExtractJSONFields_3 == null ?

																null

																: value_tExtractJSONFields_3.toString();
													} catch (com.jayway.jsonpath.PathNotFoundException e_tExtractJSONFields_3) {
														row33.property_Division =

																null

														;
													}
													jsonPath_tExtractJSONFields_3 = "$.Terms_of_Use";
													compiledJsonPath_tExtractJSONFields_3 = jsonPathCache_tExtractJSONFields_3
															.getCompiledJsonPath(jsonPath_tExtractJSONFields_3);
													...
													try {
														...
														row33.Terms_of_Use = value_tExtractJSONFields_3 == null ?
													...
													jsonPath_tExtractJSONFields_3 = "$.thumbnails.webimage";
													compiledJsonPath_tExtractJSONFields_3 = jsonPathCache_tExtractJSONFields_3
															.getCompiledJsonPath(jsonPath_tExtractJSONFields_3);
													...
													try {
														...
														row33.webimage = value_tExtractJSONFields_3 == null ?
													...
													jsonPath_tExtractJSONFields_3 = "$.thumbnails.thul";
													compiledJsonPath_tExtractJSONFields_3 = jsonPathCache_tExtractJSONFields_3
															.getCompiledJsonPath(jsonPath_tExtractJSONFields_3);
													...
													try {
														...
														row33.thul = value_tExtractJSONFields_3 == null ?
													...
													jsonPath_tExtractJSONFields_3 = "$.property_Photo_View";
													compiledJsonPath_tExtractJSONFields_3 = jsonPathCache_tExtractJSONFields_3
															.getCompiledJsonPath(jsonPath_tExtractJSONFields_3);
													...
													try {
														...
														row33.property_Photo_View = value_tExtractJSONFields_3 == null ?

																null

																: value_tExtractJSONFields_3.toString();
													} catch (com.jayway.jsonpath.PathNotFoundException e_tExtractJSONFields_3) {
														row33.property_Photo_View =
...
// # Filter conditions 
													...
													row33.property_Style_Code.indexOf(",") == -1
															&& row33.property_Color_Code.indexOf(",") == -1

													) {
														row32_tmp.id = row33.id;
														row32_tmp.description = row33.description;
														row32_tmp.type = row33.type;
														row32_tmp.idHash = row33.idHash;
														row32_tmp.tags = row33.tags;
														row32_tmp.brandId = row33.brandId;
														row32_tmp.name = row33.name;
														row32_tmp.property_Color_Code = row33.property_Color_Code;
														row32_tmp.property_Style_Code = row33.property_Style_Code;
														row32_tmp.property_Brand = row33.property_Brand;
														row32_tmp.extension = row33.extension;
														row32_tmp.property_Style_Reference = row33.property_Style_Reference;
														row32_tmp.isPublic = row33.isPublic;
														row32_tmp.property_Season = row33.property_Season;
														row32_tmp.property_Year = row33.property_Year;
														row32_tmp.property_Asset_Type = row33.property_Asset_Type;
														row32_tmp.property_Asset_Subtype = row33.property_Asset_Subtype;
														row32_tmp.userCreated = row33.userCreated;
														row32_tmp.filename = row33.filename;
														row32_tmp.property_Gender = row33.property_Gender;
														row32_tmp.property_Age_Group = row33.property_Age_Group;
														row32_tmp.property_Sub_Division = row33.property_Sub_Division;
														row32_tmp.property_Division = row33.property_Division;
														row32_tmp.Terms_of_Use = row33.Terms_of_Use;
														row32_tmp.webimage = row33.webimage;
														row32_tmp.thul = row33.thul;
														row32_tmp.property_Photo_View = row33.property_Photo_View;
														row32 = row32_tmp;
													} // closing filter/reject
// ###############################
...
// Start of branch "row32"
												if (row32 != null) {
													...
													if (!rejectedInnerJoin_tMap_9) { // G_TM_M_020
														...
														row38HashKey.Color_Code_Haddad__c = StringHandling
																.CHANGE(StringHandling.CHANGE(row32.property_Color_Code,
																		"\"\\]", ""), "\\[\"", "");

														row38HashKey.Style_Haddad__r_Name = StringHandling
																.CHANGE(StringHandling.CHANGE(row32.property_Style_Code,
																		"\"\\]", ""), "\\[\"", "");
													...
													if (tHash_Lookup_row38 != null
															&& tHash_Lookup_row38.getCount(row38HashKey) > 1) { // G 071

														// System.out.println("WARNING: UNIQUE MATCH is configured for
														// the lookup 'row38' and it contains more one result from keys
														// : row38.Color_Code_Haddad__c = '" +
														// row38HashKey.Color_Code_Haddad__c + "',
														// row38.Style_Haddad__r_Name = '" +
														// row38HashKey.Style_Haddad__r_Name + "'");
													} // G 071
													...
													if (tHash_Lookup_row38 != null && tHash_Lookup_row38.hasNext()) { // G
																														// 099
													...
													{ // start of Var scope
														...
														Var.seasonBrand = (row38.Brand_Haddad__r_Name.equals("LEVIS")
																&& row38.Season_Product_Haddad__r_Name.contains("FA")
																		? "Fall / Holiday"
																		:

																		(row38.Brand_Haddad__r_Name.equals("LEVIS")
																				&& row38.Season_Product_Haddad__r_Name
																						.contains("SP")
																								? "Spring / Summer"
																								:

																								(Relational.NOT(
																										row38.Brand_Haddad__r_Name
																												.equals("LEVIS"))
																										&& row38.Season_Product_Haddad__r_Name
																												.contains(
																														"SP") ? "Spring"
																																...
																																(Relational
																																		.NOT(row38.Brand_Haddad__r_Name
																																				.equals("LEVIS"))
																																		&& row38.Season_Product_Haddad__r_Name
																																				.contains(
																																						"SU") ? "Summer"
														...
														Var.year = (row38.Season_Product_Haddad__r_Name == null
																? "No season"
																: (row38.Season_Product_Haddad__r_Name
																		.equals("All SEASONS")
																				? "All Seasons"
																				: "20" + StringHandling.RIGHT(
																						row38.Season_Product_Haddad__r_Name,
																						2)));
														Var.pCC = StringHandling.CHANGE(StringHandling.CHANGE(
																row32.property_Color_Code, "\"\\]", ""), "\\[\"", "");
														Var.pSC = StringHandling.DOWNCASE(StringHandling
																.CHANGE(StringHandling.CHANGE(row32.property_Style_Code,
																		"\"\\]", ""), "\\[\"", "")
																.replace("_", " "));
														Var.pPV = row32.property_Photo_View == null
																? (StringHandling.RIGHT(row32.name, 1).equals("F")
																		? "Front"
																		: (StringHandling.RIGHT(row32.name, 1)
																				.equals("B")
																						? "Back"
																						: (StringHandling
																								.RIGHT(row32.name, 1)
																								.equals("L")
																										...
																										: (StringHandling
																												...
																												.equals("R")
																														? "Right"
																														: "Details"))))
																: StringHandling.CHANGE(StringHandling.CHANGE(
																		StringHandling.CHANGE(row32.property_Photo_View,
																				"\"\\]", ""),
																		"\\[\"", ""), "\"", "");
														Var.pAT = row32.property_Asset_Type == null ? ""
																: StringHandling.CHANGE(StringHandling.CHANGE(
																		StringHandling.CHANGE(row32.property_Asset_Type,
																				"\"\\]", ""),
																		"\\[\"", ""), "\"", "");
														Var.pAS = row32.property_Asset_Subtype == null ? ""
																: StringHandling.CHANGE(
																		StringHandling.CHANGE(StringHandling.CHANGE(
																				row32.property_Asset_Subtype, "\"\\]",
																				""), "\\[\"", ""),
																		"\"", "");// ###############################
														// ###############################
														// # Output tables
...
// # Output table : 'outURL'
														outURL_tmp.property_Color_Code = Var.pCC;
														outURL_tmp.property_Style_Code = Var.pSC;
														outURL_tmp.webImage = row32.webimage;
														outURL_tmp.property_Photo_View = Var.pPV;
														outURL_tmp.name = row32.name;
														outURL_tmp.thul = row32.thul;
														outURL_tmp.Product = row38.Name;
														outURL_tmp.image = row32.name;
														outURL = outURL_tmp;

// # Output table : 'updateMDBynder'
														updateMDBynder_tmp.id = row32.id;
														updateMDBynder_tmp.newDescription = row38.Description;
														updateMDBynder_tmp.newTags = row38.Season_Product_Haddad__r_Name
																+ StringHandling.CHANGE(
																		StringHandling.CHANGE(StringHandling.CHANGE(
																				row32.tags, "\"\\]", ""), "\\[\"", ""),
																		"\"", "");
														updateMDBynder_tmp.newName = row32.name;
														updateMDBynder_tmp.newProperty_Color_Code = row38.Color_Code_Haddad__c;
														updateMDBynder_tmp.newProperty_Style_Code = row38.Style_Haddad__r_Name;
														updateMDBynder_tmp.newProperty_Brand = row38.Brand_Haddad__r_Name
																.equals("LEVIS")
																		? "Levi's"
																		: row38.Brand_Haddad__r_Name.substring(0, 1)
																				.toUpperCase()
																				+ row38.Brand_Haddad__r_Name
																						.substring(1).toLowerCase();
														updateMDBynder_tmp.newProperty_Style_Reference = row38.Ref__c;
														updateMDBynder_tmp.newIsPublic = "true";
														updateMDBynder_tmp.newProperty_Season = Var.seasonBrand;
														updateMDBynder_tmp.newProperty_Year = Var.year;
														updateMDBynder_tmp.newProperty_Asset_Type = (Var.pAT
																.equals("Images")
																		? "Image"
																		: (Var.pAT.equals("Logos") ? "Logo"
																				: (Var.pAT.equals("Presentations")
																						? "Presentation"
																						: (Var.pAT.equals("Videos")
																								? "Video"
																								: Var.pAT))));
														updateMDBynder_tmp.newProperty_Asset_Subtype = (Var.pAS
																.equals("Lifestyle_image")
																		? "Lifestyle image"
																		: (Var.pAS.equals("Product_image")
																				? "Product image"
																				: (Var.pAS.equals("Videos") ? "Video"
																						: Var.pAS)));
														updateMDBynder_tmp.newProperty_Gender = row38.Gender_Haddad__c;
														updateMDBynder_tmp.newProperty_Age_Group = row38.Age_Group_Haddad__c;
														updateMDBynder_tmp.newProperty_Sub_Division = null;
														updateMDBynder_tmp.newProperty_Division = null;
														updateMDBynder_tmp.PhotoView = Var.pPV;
														updateMDBynder = updateMDBynder_tmp;
// ###############################
...
// Start of branch "outURL"
													if (outURL != null) {
														...
														if (execStat) {
															runStat.updateStatOnConnection(iterateId, 1, 1, "outURL");
														}

														StringBuilder sb_tFileOutputDelimited_1 = new StringBuilder();
														if (outURL.property_Color_Code != null) {
															sb_tFileOutputDelimited_1
																	.append(outURL.property_Color_Code);
														}
														sb_tFileOutputDelimited_1
																.append(OUT_DELIM_tFileOutputDelimited_1);
														if (outURL.property_Style_Code != null) {
															sb_tFileOutputDelimited_1
																	.append(outURL.property_Style_Code);
														}
														sb_tFileOutputDelimited_1
																.append(OUT_DELIM_tFileOutputDelimited_1);
														if (outURL.webImage != null) {
															sb_tFileOutputDelimited_1.append(outURL.webImage);
														}
														sb_tFileOutputDelimited_1
																.append(OUT_DELIM_tFileOutputDelimited_1);
														if (outURL.property_Photo_View != null) {
															sb_tFileOutputDelimited_1
																	.append(outURL.property_Photo_View);
														}
														sb_tFileOutputDelimited_1
																.append(OUT_DELIM_tFileOutputDelimited_1);
														if (outURL.name != null) {
															sb_tFileOutputDelimited_1.append(outURL.name);
														}
														sb_tFileOutputDelimited_1
																.append(OUT_DELIM_tFileOutputDelimited_1);
														if (outURL.thul != null) {
															sb_tFileOutputDelimited_1.append(outURL.thul);
														}
														sb_tFileOutputDelimited_1
																.append(OUT_DELIM_tFileOutputDelimited_1);
														if (outURL.Product != null) {
															sb_tFileOutputDelimited_1.append(outURL.Product);
														}
														sb_tFileOutputDelimited_1
																.append(OUT_DELIM_tFileOutputDelimited_1);
														if (outURL.image != null) {
															sb_tFileOutputDelimited_1.append(outURL.image);
														}
														sb_tFileOutputDelimited_1
...
// output_row.name = row15.name.toLowerCase();
														...
														System.out.println("Asset : " + row15.image + " into Product :"
																+ row15.Product);
														nb_line_tJavaRow_2++;
													...
													} // End of branch "outURL"

// Start of branch "updateMDBynder"
													if (updateMDBynder != null) {
														...
														mD = null;
														if (updateMDBynder.id == null) {
															finder_tUniqRow_7.id = null;
														} else {
															finder_tUniqRow_7.id = updateMDBynder.id.toLowerCase();
														}
														...
														if (!keystUniqRow_7.contains(finder_tUniqRow_7)) {
															...
															if (updateMDBynder.id == null) {
																...
																new_tUniqRow_7.id = updateMDBynder.id.toLowerCase();
															}
															...
															mD.id = updateMDBynder.id;
															mD.newDescription = updateMDBynder.newDescription;
															mD.newTags = updateMDBynder.newTags;
															mD.newName = updateMDBynder.newName;
															mD.newProperty_Color_Code = updateMDBynder.newProperty_Color_Code;
															mD.newProperty_Style_Code = updateMDBynder.newProperty_Style_Code;
															mD.newProperty_Brand = updateMDBynder.newProperty_Brand;
															mD.newProperty_Style_Reference = updateMDBynder.newProperty_Style_Reference;
															mD.newIsPublic = updateMDBynder.newIsPublic;
															mD.newProperty_Season = updateMDBynder.newProperty_Season;
															mD.newProperty_Year = updateMDBynder.newProperty_Year;
															mD.newProperty_Asset_Type = updateMDBynder.newProperty_Asset_Type;
															mD.newProperty_Asset_Subtype = updateMDBynder.newProperty_Asset_Subtype;
															mD.newProperty_Gender = updateMDBynder.newProperty_Gender;
															mD.newProperty_Age_Group = updateMDBynder.newProperty_Age_Group;
															mD.newProperty_Sub_Division = updateMDBynder.newProperty_Sub_Division;
															mD.newProperty_Division = updateMDBynder.newProperty_Division;
															mD.PhotoView = updateMDBynder.PhotoView;
...
// Start of branch "mD"
														if (mD != null) {
															...
															if (execStat) {
																runStat.updateStatOnConnection(iterateId, 1, 1, "mD");
															}
...
// expected response body
															...
															try {
																...
																features_tRESTClient_4.add(
																		new org.apache.cxf.feature.LoggingFeature());

																factoryBean_tRESTClient_4
																		.setFeatures(features_tRESTClient_4);

																java.util.List<Object> providers_tRESTClient_4 = new java.util.ArrayList<Object>();
																providers_tRESTClient_4.add(
																...
																jsonProvider_tRESTClient_4
																		.setConvertTypesToStrings(true);
																providers_tRESTClient_4.add(jsonProvider_tRESTClient_4);
																factoryBean_tRESTClient_4
																		.setProviders(providers_tRESTClient_4);
																factoryBean_tRESTClient_4.setTransportId(
																		"http://cxf.apache.org/transports/http");

																boolean use_auth_tRESTClient_4 = false;
																if (use_auth_tRESTClient_4
																		&& "SAML".equals("OAUTH2_BEARER")) {
																	if (!inOSGi) {
																		throw new IllegalArgumentException(
																				"SAML based security scenarios are not supported in Studio (standalone)");
																	}
																	...
																	final String decryptedPassword_tRESTClient_4 = routines.system.PasswordEncryptUtil
																			.decryptPassword(
																					"ENC:[QaCMXAbopASMmDeV9z5g+/ZwksSrG8rTDD380V3N/o74V7xrlzw=]");

																	org.apache.cxf.ws.security.trust.STSClient stsClient = org.talend.esb.security.saml.STSClientUtils
																			.createSTSClient(
																					factoryBean_tRESTClient_4.getBus(),
																					"otman.nikraj@haddadeurope.com.partial",
																					decryptedPassword_tRESTClient_4);

																	org.talend.esb.security.saml.SAMLRESTUtils
																			.configureClient(factoryBean_tRESTClient_4,
																					stsClient);
																}
																...
																// set request path
																webClient_tRESTClient_4.path(mD.id);
																...
																tlsClientParameters_tRESTClient_4
																		.setDisableCNCheck(true);
																conduit_tRESTClient_4.setTlsClientParameters(
																		tlsClientParameters_tRESTClient_4);

																if (use_auth_tRESTClient_4
																		&& "BASIC".equals("OAUTH2_BEARER")) {
																	// set BASIC auth

																	final String decryptedPassword_tRESTClient_4 = routines.system.PasswordEncryptUtil
																			.decryptPassword(
																					"ENC:[E1lp3ctrFU4jBsGbfZFwq9JAhsoag9ThwGO/f/ZkSx6kKZtq4Ns=]");
																	...
																	authPolicy_tRESTClient_4.setUserName(
																			"otman.nikraj@haddadeurope.com.partial");
																	authPolicy_tRESTClient_4.setPassword(
																			decryptedPassword_tRESTClient_4);
																	conduit_tRESTClient_4
																			.setAuthorization(authPolicy_tRESTClient_4);
																} else if (use_auth_tRESTClient_4
																		&& "HTTP Digest".equals("OAUTH2_BEARER")) {
																	// set Digest auth

																	final String decryptedPassword_tRESTClient_4 = routines.system.PasswordEncryptUtil
																			.decryptPassword(
																					"ENC:[JxOcC5thYCDc3EMOO07uIRCgRAa5Yk0Fv7GjEr+3RAu/+4KK80Q=]");
																...
																if (!inOSGi) {
																	...
																	if (use_proxy_tRESTClient_4) {
																		...
																		final String decryptedPassword_tRESTClient_4 = routines.system.PasswordEncryptUtil
																				.decryptPassword(
																						"ENC:[YLHdM+GJvN2t/RyMR2cbO97ItA0B0GGd54t0nw==]");
																...
																clientConfig_tRESTClient_4.getRequestContext()
																		.put("http.redirect.relative.uri", true);
																clientConfig_tRESTClient_4.getRequestContext()
																		.put("http.redirect.same.host.only", false);

																// set Content-Type
																webClient_tRESTClient_4
																...
																webClient_tRESTClient_4.header("Authorization",
																		globalMap.get("tokentype") + " "
																				+ globalMap.get("accesstoken"));

																webClient_tRESTClient_4.header("Accept",
																		"application/json");

																webClient_tRESTClient_4.header("content-Type",
																		"application/json");

																if (use_auth_tRESTClient_4
																		&& "OAUTH2_BEARER".equals("OAUTH2_BEARER")) {
																	// set oAuth2 bearer token
																	webClient_tRESTClient_4.header("Authorization",
																			"Bearer " + globalMap.get("tokentype") + " "
																					+ globalMap.get("accesstoken"));
																}

																if (use_auth_tRESTClient_4 && "OIDC_PASSWORD_GRANT"
																		.equals("OAUTH2_BEARER")) {

																	final String decryptedPassword_tRESTClient_4 = routines.system.PasswordEncryptUtil
																			.decryptPassword(
																					"ENC:[HUkrt5DGUWlQEWuaX95l/s/m40u0OPeDe/82MrzeumtiYe6iblM=]");
																...
																javax.ws.rs.core.Form form_tRESTClient_4 = new javax.ws.rs.core.Form();

																form_tRESTClient_4.param("name", mD.newName);

																form_tRESTClient_4.param("description",
																		mD.newDescription);

																form_tRESTClient_4.param("tags", mD.newTags);

																form_tRESTClient_4.param(
																		"metaproperty.0E7F5A0A-DBB8-4FDC-A648B811CB7F92FE",
																		mD.newProperty_Color_Code);

																form_tRESTClient_4.param(
																		"metaproperty.73489A4D-F984-40EA-840B6C33481D96A6",
																		mD.newProperty_Style_Code);

																form_tRESTClient_4.param(
																		"metaproperty.E4D13B4A-FBDE-4702-B4BBB72B74D854C2",
																		mD.newProperty_Brand);

																form_tRESTClient_4.param(
																		"metaproperty.10C6645B-D1D1-4F74-95FA1945D660B93E",
																		mD.newProperty_Style_Reference);

																form_tRESTClient_4.param("isPublic", mD.newIsPublic);

																form_tRESTClient_4.param(
																		"metaproperty.7762F558-150B-4EEB-88DD7171CA89C763",
																		mD.newProperty_Season);

																form_tRESTClient_4.param(
																		"metaproperty.3D960B44-C48B-45FF-AD6166AFA8D228B8",
																		mD.newProperty_Year);

																form_tRESTClient_4.param(
																		"metaproperty.370DB808-8A3F-4708-9899482FD2F7A447",
																		mD.newProperty_Asset_Type);

																form_tRESTClient_4.param(
																		"metaproperty.86FBC4EB-56D2-486B-BC6D3AEE6401E2B1",
																		mD.newProperty_Asset_Subtype);

																form_tRESTClient_4.param(
																		"metaproperty.CD088462-C9B7-4BFF-9B84B06336DC8433",
																		mD.newProperty_Age_Group);

																form_tRESTClient_4.param(
																		"metaproperty.3049A3D9-BAA1-4F1F-88F0A4549858D35A",
																		mD.newProperty_Gender);

																form_tRESTClient_4.param(
																		"metaproperty.915D02BE-14A5-498D-A9640C4824BB5995",
																		mD.newProperty_Division);

																form_tRESTClient_4.param(
																		"metaproperty.915D02BE-14A5-498D-A9640C4824BB5995",
																		mD.newProperty_Sub_Division);

																form_tRESTClient_4.param(
																		"metaproperty.FF1B8CFF-4420-47D1-9EFCD75B8AE718E4",
																		mD.PhotoView);

																requestBody_tRESTClient_4 = form_tRESTClient_4;

																try {
																	// start send request

																	responseDoc_tRESTClient_4 = webClient_tRESTClient_4
																			.post(requestBody_tRESTClient_4);
																	...
																	row7.statusCode = webClientResponseStatus_tRESTClient_4;

																	Object responseObj_tRESTClient_4 = null;
																	if (responseDoc_tRESTClient_4 != null
																			&& responseDoc_tRESTClient_4.hasEntity()) {
																		responseObj_tRESTClient_4 = responseDoc_tRESTClient_4
																				.readEntity(
																						responseClass_tRESTClient_4);

																		if (responseObj_tRESTClient_4 != null) {
																			if (responseClass_tRESTClient_4 == String.class) {
																				row7.string = (String) responseObj_tRESTClient_4;
																			} else {
																				...
																				row7.body = responseTalendDoc_tRESTClient_4;
																			}
																		}
																	}
																	...
																	// handle "oneway" for PUT, POST and PATCH with
																	// empty response payload
																	if (webClientResponseStatus_tRESTClient_4 == 202
																			&& responseObj_tRESTClient_4 == null) {
																		row7.string = "";
																		return;
																	}
																...
																new TalendException(e_tRESTClient_4, currentComponent,
...
///////////////////////		
																...
																if (row7.body != null) { //
																	...
																	strBuffer_tLogRow_8
																			.append(String.valueOf(row7.body));
																...
																if (row7.string != null) { //
																	...
																	strBuffer_tLogRow_8
																			.append(String.valueOf(row7.string));
																...
																if (row7.statusCode != null) { //
																	...
																	strBuffer_tLogRow_8
																			.append(String.valueOf(row7.statusCode));
																...
																consoleOut_tLogRow_8
																		.println(strBuffer_tLogRow_8.toString());
...
// Start of branch "noAssetsAvailable"
								if (noAssetsAvailable != null) {
									...
									if (execStat) {
										runStat.updateStatOnConnection(iterateId, 1, 1, "noAssetsAvailable");
									}

									StringBuilder sb_tFileOutputDelimited_3 = new StringBuilder();
									if (noAssetsAvailable.Style_Color != null) {
										sb_tFileOutputDelimited_3.append(noAssetsAvailable.Style_Color);
									}
									sb_tFileOutputDelimited_3.append(OUT_DELIM_tFileOutputDelimited_3);
									if (noAssetsAvailable.bynderStatus != null) {
										sb_tFileOutputDelimited_3.append(noAssetsAvailable.bynderStatus);
									}
								...
								} // End of branch "noAssetsAvailable"
				...
				if (resultMap_tSalesforceInput_2 != null) {
					for (java.util.Map.Entry<String, Object> entry_tSalesforceInput_2 : resultMap_tSalesforceInput_2
						...
						case org.talend.components.api.component.ComponentDefinition.RETURN_ERROR_MESSAGE:
							container_tSalesforceInput_2.setComponentData("tSalesforceInput_2", "ERROR_MESSAGE",
									entry_tSalesforceInput_2.getValue());
							break;
						case org.talend.components.api.component.ComponentDefinition.RETURN_TOTAL_RECORD_COUNT:
							container_tSalesforceInput_2.setComponentData("tSalesforceInput_2", "NB_LINE",
									entry_tSalesforceInput_2.getValue());
							break;
						case org.talend.components.api.component.ComponentDefinition.RETURN_SUCCESS_RECORD_COUNT:
							container_tSalesforceInput_2.setComponentData("tSalesforceInput_2", "NB_SUCCESS",
									entry_tSalesforceInput_2.getValue());
							break;
						case org.talend.components.api.component.ComponentDefinition.RETURN_REJECT_RECORD_COUNT:
							container_tSalesforceInput_2.setComponentData("tSalesforceInput_2", "NB_REJECT",
									entry_tSalesforceInput_2.getValue());
							break;
						default:
							StringBuilder studio_key_tSalesforceInput_2 = new StringBuilder();
							for (int i_tSalesforceInput_2 = 0; i_tSalesforceInput_2 < entry_tSalesforceInput_2.getKey()
									.length(); i_tSalesforceInput_2++) {
								char ch_tSalesforceInput_2 = entry_tSalesforceInput_2.getKey()
										.charAt(i_tSalesforceInput_2);
							...
							container_tSalesforceInput_2.setComponentData("tSalesforceInput_2",
									studio_key_tSalesforceInput_2.toString().toUpperCase(java.util.Locale.ENGLISH),
									entry_tSalesforceInput_2.getValue());
							break;
						}
					}
...
// ###############################      
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "outURL");
				}
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "updateMDBynder");
				}
...
// [tRESTCliend_end]
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "mD");
				}
...
///////////////////////    			
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "noAssetsAvailable");
				}
...
// finally of generic
	...
	public static class copyOfcopyOfcopyOfUpdate_Back_ImageStruct
			implements routines.system.IPersistableRow<copyOfcopyOfcopyOfUpdate_Back_ImageStruct> {
		final static byte[] commonByteArrayLock_DEV_recoverAssetsFromBynderToSF = new byte[0];
		static byte[] commonByteArray_DEV_recoverAssetsFromBynderToSF = new byte[0];
	...
	public static class copyOfcopyOfUpdate_Back_ImageStruct
			implements routines.system.IPersistableRow<copyOfcopyOfUpdate_Back_ImageStruct> {
		final static byte[] commonByteArrayLock_DEV_recoverAssetsFromBynderToSF = new byte[0];
		static byte[] commonByteArray_DEV_recoverAssetsFromBynderToSF = new byte[0];
	...
	public static class copyOfUpdate_Back_ImageStruct
			implements routines.system.IPersistableRow<copyOfUpdate_Back_ImageStruct> {
		final static byte[] commonByteArrayLock_DEV_recoverAssetsFromBynderToSF = new byte[0];
		static byte[] commonByteArray_DEV_recoverAssetsFromBynderToSF = new byte[0];
	...
	public static class updateSF_Front_ImageStruct
			implements routines.system.IPersistableRow<updateSF_Front_ImageStruct> {
		final static byte[] commonByteArrayLock_DEV_recoverAssetsFromBynderToSF = new byte[0];
		static byte[] commonByteArray_DEV_recoverAssetsFromBynderToSF = new byte[0];
...
///////////////////////    			
				...
				class SchemaSettingTool_tSalesforceOutput_1_1_fisrt {
					...
					String getSchemaValue() {
						...
						a("\"name\":\"Image_1_Link_Haddad__c\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"Image_1_Link_Haddad__c\",\"talend.field.dbColumnName\":\"Image_1_Link_Haddad__c\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"255\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"Image_1_Link_Haddad__c\",\"di.column.relatedEntity\":\"\"},{",
								s);

						a("\"name\":\"Image_1_Link_Type__c\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"Image_1_Link_Type__c\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"Image_1_Link_Type__c\",\"di.column.relatedEntity\":\"\"}],\"di.table.name\":\"tSalesforceOutput_1\",\"di.table.label\":\"updateSF_Front_Image\"}",
								s);
				...
				class SchemaSettingTool_tSalesforceOutput_1_2_fisrt {
					...
					String getSchemaValue() {
						...
						a("\"name\":\"Image_1_Link_Type__c\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"Image_1_Link_Type__c\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"Image_1_Link_Type__c\",\"di.column.relatedEntity\":\"\"},{",
								s);
						...
						a("\"name\":\"errorMessage\",\"type\":\"string\",\"talend.isLocked\":\"false\",\"talend.field.generated\":\"true\",\"talend.field.length\":\"255\"}],\"di.table.name\":\"tSalesforceOutput_1\",\"di.table.label\":\"updateSF_Front_Image\"}",
								s);
				...
				props_tSalesforceOutput_1.module.setValue("moduleName", "Product2");
				...
				org.talend.codegen.enforcer.OutgoingSchemaEnforcer outgoingEnforcer_tSalesforceOutput_1OutMain = org.talend.codegen.enforcer.EnforcerCreator
						.createOutgoingEnforcer(mainSchema_tSalesforceOutput_1, false);
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "updateSF_Front_Image");
				}
...
///////////////////////    			
				...
				props_tSalesforceOutput_2.setValue("ceaseForError", false);

				props_tSalesforceOutput_2.setValue("ignoreNull", false);
				...
				class SchemaSettingTool_tSalesforceOutput_2_1_fisrt {
					...
					String getSchemaValue() {
						...
						a("\"name\":\"Image_2_Link_Haddad__c\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"talend.field.dbColumnName\":\"Image_2_Link_Haddad__c\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"255\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"Image_2_Link_Haddad__c\",\"di.column.relatedEntity\":\"\"},{",
								s);

						a("\"name\":\"Image_2_Link_Type__c\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"Image_2_Link_Type__c\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"Image_2_Link_Type__c\",\"di.column.relatedEntity\":\"\"}],\"di.table.name\":\"tSalesforceOutput_2\",\"di.table.label\":\"Update_Back_Image\"}",
								s);
				...
				class SchemaSettingTool_tSalesforceOutput_2_2_fisrt {
					...
					String getSchemaValue() {
						...
						a("\"name\":\"Image_2_Link_Type__c\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"Image_2_Link_Type__c\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"Image_2_Link_Type__c\",\"di.column.relatedEntity\":\"\"},{",
								s);
						...
						a("\"name\":\"errorMessage\",\"type\":\"string\",\"talend.isLocked\":\"false\",\"talend.field.generated\":\"true\",\"talend.field.length\":\"255\"}],\"di.table.name\":\"tSalesforceOutput_2\",\"di.table.label\":\"Update_Back_Image\"}",
								s);
				...
				props_tSalesforceOutput_2.module.setValue("moduleName", "Product2");
				...
				org.talend.codegen.enforcer.IncomingSchemaEnforcer incomingEnforcer_tSalesforceOutput_2 = new org.talend.codegen.enforcer.IncomingSchemaEnforcer(
				...
				org.apache.avro.Schema mainSchema_tSalesforceOutput_2 = props_tSalesforceOutput_2
						.getSchema(c_tSalesforceOutput_2, true);
				org.talend.codegen.enforcer.OutgoingSchemaEnforcer outgoingEnforcer_tSalesforceOutput_2OutMain = org.talend.codegen.enforcer.EnforcerCreator
						.createOutgoingEnforcer(mainSchema_tSalesforceOutput_2, false);
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "Update_Back_Image");
				}
...
///////////////////////    			
				...
				props_tSalesforceOutput_3.setValue("ignoreNull", false);

				props_tSalesforceOutput_3.setValue("commitLevel", 200);
				...
				class SchemaSettingTool_tSalesforceOutput_3_2_fisrt {
					...
					String getSchemaValue() {
						...
						a("\"name\":\"Image_3_Link_Type__c\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"Image_3_Link_Type__c\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"Image_3_Link_Type__c\",\"di.column.relatedEntity\":\"\"},{",
								s);
						...
						a("\"name\":\"errorMessage\",\"type\":\"string\",\"talend.isLocked\":\"false\",\"talend.field.generated\":\"true\",\"talend.field.length\":\"255\"}],\"di.table.name\":\"tSalesforceOutput_3\",\"di.table.label\":\"Update_Back_Image\"}",
								s);
				...
				props_tSalesforceOutput_3.connection.userPassword.setValue("useAuth", false);

				props_tSalesforceOutput_3.connection.proxy.userPassword.setValue("useAuth", false);
				...
				props_tSalesforceOutput_3.module.setValue("moduleName", "Product2");

				props_tSalesforceOutput_3.module.connection.userPassword.setValue("useAuth", false);

				props_tSalesforceOutput_3.module.connection.proxy.userPassword.setValue("useAuth", false);
				...
				org.talend.daikon.runtime.RuntimeInfo runtime_info_tSalesforceOutput_3 = def_tSalesforceOutput_3
						.getRuntimeInfo(org.talend.components.api.component.runtime.ExecutionEngine.DI,
								props_tSalesforceOutput_3, topology_tSalesforceOutput_3);
				...
				org.talend.components.api.component.runtime.RuntimableRuntime componentRuntime_tSalesforceOutput_3 = (org.talend.components.api.component.runtime.RuntimableRuntime) (Class
						.forName(runtime_info_tSalesforceOutput_3.getRuntimeClassName()).newInstance());
				org.talend.daikon.properties.ValidationResult initVr_tSalesforceOutput_3 = componentRuntime_tSalesforceOutput_3
						.initialize(container_tSalesforceOutput_3, props_tSalesforceOutput_3);

				if (initVr_tSalesforceOutput_3
						.getStatus() == org.talend.daikon.properties.ValidationResult.Result.ERROR) {
				...
				org.talend.codegen.enforcer.OutgoingSchemaEnforcer outgoingEnforcer_tSalesforceOutput_3OutMain = org.talend.codegen.enforcer.EnforcerCreator
						.createOutgoingEnforcer(mainSchema_tSalesforceOutput_3, false);
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "copyOfUpdate_Back_Image");
				}
...
///////////////////////    			
				...
				props_tSalesforceOutput_4.setValue("ceaseForError", false);

				props_tSalesforceOutput_4.setValue("ignoreNull", false);
				...
				class SchemaSettingTool_tSalesforceOutput_4_1_fisrt {
					...
					String getSchemaValue() {
						...
						a("\"name\":\"Image_4_Link_Haddad__c\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"Image_2_Link_Haddad__c\",\"talend.field.dbColumnName\":\"Image_4_Link_Haddad__c\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"255\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"Image_4_Link_Haddad__c\",\"di.column.relatedEntity\":\"\"},{",
								s);

						a("\"name\":\"Image_4_Link_Type__c\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"Image_4_Link_Type__c\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"Image_4_Link_Type__c\",\"di.column.relatedEntity\":\"\"}],\"di.table.name\":\"tSalesforceOutput_4\",\"di.table.label\":\"Update_Back_Image\"}",
								s);
				...
				class SchemaSettingTool_tSalesforceOutput_4_2_fisrt {
					...
					String getSchemaValue() {
						...
						a("\"name\":\"Image_4_Link_Type__c\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"Image_4_Link_Type__c\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"Image_4_Link_Type__c\",\"di.column.relatedEntity\":\"\"},{",
								s);
						...
						a("\"name\":\"errorMessage\",\"type\":\"string\",\"talend.isLocked\":\"false\",\"talend.field.generated\":\"true\",\"talend.field.length\":\"255\"}],\"di.table.name\":\"tSalesforceOutput_4\",\"di.table.label\":\"Update_Back_Image\"}",
								s);
				...
				props_tSalesforceOutput_4.connection.userPassword.setValue("useAuth", false);

				props_tSalesforceOutput_4.connection.proxy.userPassword.setValue("useAuth", false);
				...
				props_tSalesforceOutput_4.module.setValue("moduleName", "Product2");

				props_tSalesforceOutput_4.module.connection.userPassword.setValue("useAuth", false);

				props_tSalesforceOutput_4.module.connection.proxy.userPassword.setValue("useAuth", false);
				...
				org.talend.daikon.runtime.RuntimeInfo runtime_info_tSalesforceOutput_4 = def_tSalesforceOutput_4
						.getRuntimeInfo(org.talend.components.api.component.runtime.ExecutionEngine.DI,
								props_tSalesforceOutput_4, topology_tSalesforceOutput_4);
				...
				org.talend.components.api.component.runtime.RuntimableRuntime componentRuntime_tSalesforceOutput_4 = (org.talend.components.api.component.runtime.RuntimableRuntime) (Class
						.forName(runtime_info_tSalesforceOutput_4.getRuntimeClassName()).newInstance());
				org.talend.daikon.properties.ValidationResult initVr_tSalesforceOutput_4 = componentRuntime_tSalesforceOutput_4
						.initialize(container_tSalesforceOutput_4, props_tSalesforceOutput_4);

				if (initVr_tSalesforceOutput_4
						.getStatus() == org.talend.daikon.properties.ValidationResult.Result.ERROR) {
				...
				org.apache.avro.Schema mainSchema_tSalesforceOutput_4 = props_tSalesforceOutput_4
						.getSchema(c_tSalesforceOutput_4, true);
				org.talend.codegen.enforcer.OutgoingSchemaEnforcer outgoingEnforcer_tSalesforceOutput_4OutMain = org.talend.codegen.enforcer.EnforcerCreator
						.createOutgoingEnforcer(mainSchema_tSalesforceOutput_4, false);
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "copyOfcopyOfUpdate_Back_Image");
				}
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "out_4");
				}
...
///////////////////////    			
				...
				org.talend.components.api.component.ComponentDefinition def_tSalesforceOutput_5 = new org.talend.components.salesforce.tsalesforceoutput.TSalesforceOutputDefinition();

				org.talend.components.salesforce.tsalesforceoutput.TSalesforceOutputProperties props_tSalesforceOutput_5 = (org.talend.components.salesforce.tsalesforceoutput.TSalesforceOutputProperties) def_tSalesforceOutput_5
						.createRuntimeProperties();
				props_tSalesforceOutput_5.setValue("extendInsert", true);

				props_tSalesforceOutput_5.setValue("ceaseForError", false);

				props_tSalesforceOutput_5.setValue("ignoreNull", false);

				props_tSalesforceOutput_5.setValue("commitLevel", 200);
				...
				class SchemaSettingTool_tSalesforceOutput_5_1_fisrt {
					...
					String getSchemaValue() {
						...
						a("\"name\":\"Image_5_Link_Haddad__c\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"Image_2_Link_Haddad__c\",\"talend.field.dbColumnName\":\"Image_5_Link_Haddad__c\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"255\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"Image_5_Link_Haddad__c\",\"di.column.relatedEntity\":\"\"},{",
								s);

						a("\"name\":\"Image_5_Link_Type__c\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"Image_5_Link_Type__c\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"Image_5_Link_Type__c\",\"di.column.relatedEntity\":\"\"}],\"di.table.name\":\"tSalesforceOutput_5\",\"di.table.label\":\"Update_Back_Image\"}",
								s);
				...
				class SchemaSettingTool_tSalesforceOutput_5_2_fisrt {
					...
					String getSchemaValue() {
						...
						a("\"name\":\"Image_5_Link_Type__c\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"Image_5_Link_Type__c\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"Image_5_Link_Type__c\",\"di.column.relatedEntity\":\"\"},{",
								s);
						...
						a("\"name\":\"errorMessage\",\"type\":\"string\",\"talend.isLocked\":\"false\",\"talend.field.generated\":\"true\",\"talend.field.length\":\"255\"}],\"di.table.name\":\"tSalesforceOutput_5\",\"di.table.label\":\"Update_Back_Image\"}",
								s);
				...
				props_tSalesforceOutput_5.connection.userPassword.setValue("useAuth", false);

				props_tSalesforceOutput_5.connection.proxy.userPassword.setValue("useAuth", false);
				...
				props_tSalesforceOutput_5.module.setValue("moduleName", "Product2");

				props_tSalesforceOutput_5.module.connection.userPassword.setValue("useAuth", false);

				props_tSalesforceOutput_5.module.connection.proxy.userPassword.setValue("useAuth", false);
				...
				if (org.talend.components.api.properties.ComponentReferenceProperties.ReferenceType.COMPONENT_INSTANCE == props_tSalesforceOutput_5.connection.referencedComponent.referenceType
						.getValue()) {
					final String referencedComponentInstanceId_tSalesforceOutput_5 = props_tSalesforceOutput_5.connection.referencedComponent.componentInstanceId
							.getStringValue();
					if (referencedComponentInstanceId_tSalesforceOutput_5 != null) {
						org.talend.daikon.properties.Properties referencedComponentProperties_tSalesforceOutput_5 = (org.talend.daikon.properties.Properties) globalMap
								.get(referencedComponentInstanceId_tSalesforceOutput_5
										+ "_COMPONENT_RUNTIME_PROPERTIES");
						props_tSalesforceOutput_5.connection.referencedComponent
								.setReference(referencedComponentProperties_tSalesforceOutput_5);
					}
				}
				if (org.talend.components.api.properties.ComponentReferenceProperties.ReferenceType.COMPONENT_INSTANCE == props_tSalesforceOutput_5.module.connection.referencedComponent.referenceType
						.getValue()) {
					final String referencedComponentInstanceId_tSalesforceOutput_5 = props_tSalesforceOutput_5.module.connection.referencedComponent.componentInstanceId
							.getStringValue();
					if (referencedComponentInstanceId_tSalesforceOutput_5 != null) {
						org.talend.daikon.properties.Properties referencedComponentProperties_tSalesforceOutput_5 = (org.talend.daikon.properties.Properties) globalMap
								.get(referencedComponentInstanceId_tSalesforceOutput_5
										+ "_COMPONENT_RUNTIME_PROPERTIES");
						props_tSalesforceOutput_5.module.connection.referencedComponent
								.setReference(referencedComponentProperties_tSalesforceOutput_5);
					}
				}
				...
				org.talend.daikon.runtime.RuntimeInfo runtime_info_tSalesforceOutput_5 = def_tSalesforceOutput_5
						.getRuntimeInfo(org.talend.components.api.component.runtime.ExecutionEngine.DI,
								props_tSalesforceOutput_5, topology_tSalesforceOutput_5);
				java.util.Set<org.talend.components.api.component.ConnectorTopology> supported_connector_topologies_tSalesforceOutput_5 = def_tSalesforceOutput_5
						.getSupportedConnectorTopologies();

				org.talend.components.api.component.runtime.RuntimableRuntime componentRuntime_tSalesforceOutput_5 = (org.talend.components.api.component.runtime.RuntimableRuntime) (Class
						.forName(runtime_info_tSalesforceOutput_5.getRuntimeClassName()).newInstance());
				org.talend.daikon.properties.ValidationResult initVr_tSalesforceOutput_5 = componentRuntime_tSalesforceOutput_5
						.initialize(container_tSalesforceOutput_5, props_tSalesforceOutput_5);

				if (initVr_tSalesforceOutput_5
						.getStatus() == org.talend.daikon.properties.ValidationResult.Result.ERROR) {
				...
				if (componentRuntime_tSalesforceOutput_5 instanceof org.talend.components.api.component.runtime.SourceOrSink) {
					...
					org.talend.daikon.properties.ValidationResult vr_tSalesforceOutput_5 = sourceOrSink_tSalesforceOutput_5
							.validate(container_tSalesforceOutput_5);
					if (vr_tSalesforceOutput_5
							.getStatus() == org.talend.daikon.properties.ValidationResult.Result.ERROR) {
						throw new RuntimeException(vr_tSalesforceOutput_5.getMessage());
					}
				}

				org.talend.components.api.component.runtime.Sink sink_tSalesforceOutput_5 = (org.talend.components.api.component.runtime.Sink) sourceOrSink_tSalesforceOutput_5;
				org.talend.components.api.component.runtime.WriteOperation writeOperation_tSalesforceOutput_5 = sink_tSalesforceOutput_5
						.createWriteOperation();
				writeOperation_tSalesforceOutput_5.initialize(container_tSalesforceOutput_5);
				org.talend.components.api.component.runtime.Writer writer_tSalesforceOutput_5 = writeOperation_tSalesforceOutput_5
						.createWriter(container_tSalesforceOutput_5);
				...
				for (org.talend.components.api.component.Connector currentConnector : props_tSalesforceOutput_5
						.getAvailableConnectors(null, false)) {
					if (currentConnector.getName().equals("MAIN")) {
				...
				org.apache.avro.Schema designSchema_tSalesforceOutput_5 = props_tSalesforceOutput_5
						.getSchema(c_tSalesforceOutput_5, false);
				org.talend.codegen.enforcer.IncomingSchemaEnforcer incomingEnforcer_tSalesforceOutput_5 = new org.talend.codegen.enforcer.IncomingSchemaEnforcer(
						designSchema_tSalesforceOutput_5);
				...
				org.apache.avro.Schema mainSchema_tSalesforceOutput_5 = props_tSalesforceOutput_5
						.getSchema(c_tSalesforceOutput_5, true);
				org.talend.codegen.enforcer.OutgoingSchemaEnforcer outgoingEnforcer_tSalesforceOutput_5OutMain = org.talend.codegen.enforcer.EnforcerCreator
						.createOutgoingEnforcer(mainSchema_tSalesforceOutput_5, false);
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "copyOfcopyOfcopyOfUpdate_Back_Image");
				}
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "out_5");
				}
...
// ###############################
				...
				class SchemaSettingTool_tSalesforceInput_1_1_fisrt {
					...
					String getSchemaValue() {
						...
						a("\"name\":\"Image_5_Link__c\",\"type\":[\"string\",\"null\"],\"talend.field.length\":\"255\"},{",
								s);

						a("\"name\":\"Image_1_Link_Type__c\",\"type\":[\"string\",\"null\"],\"talend.field.length\":\"255\"},{",
								s);

						a("\"name\":\"Image_2_Link_Type__c\",\"type\":[\"string\",\"null\"],\"talend.field.length\":\"255\"},{",
								s);

						a("\"name\":\"Image_3_Link_Type__c\",\"type\":[\"string\",\"null\"],\"talend.field.length\":\"255\"},{",
								s);

						a("\"name\":\"Image_4_Link_Type__c\",\"type\":[\"string\",\"null\"],\"talend.field.length\":\"255\"},{",
								s);

						a("\"name\":\"Image_5_Link_Type__c\",\"type\":[\"string\",\"null\"],\"talend.field.length\":\"255\"},{",
								s);
...
// Start of branch "updateSF_Front_Image"
							if (updateSF_Front_Image != null) {
								...
								if (execStat) {
									runStat.updateStatOnConnection(iterateId, 1, 1, "updateSF_Front_Image");
								}
								...
								if (updateSF_Front_Image.Id == null) {
									...
									finder_tUniqRow_2.Id = updateSF_Front_Image.Id.toLowerCase();
								}
								...
								if (!keystUniqRow_2.contains(finder_tUniqRow_2)) {
									...
									if (updateSF_Front_Image.Id == null) {
										...
										new_tUniqRow_2.Id = updateSF_Front_Image.Id.toLowerCase();
									}
									...
									row12.Id = updateSF_Front_Image.Id;
									row12.Image_1_Link_Haddad__c = updateSF_Front_Image.Image_1_Link_Haddad__c;
									row12.Image_1_Link_Type__c = updateSF_Front_Image.Image_1_Link_Type__c;
...
// Start of branch "row12"
								if (row12 != null) {
									...
									// schema
									if (incomingEnforcer_tSalesforceOutput_1.getRuntimeSchema()
											.getField("Id") != null) {
									...
									// schema
									if (incomingEnforcer_tSalesforceOutput_1.getRuntimeSchema()
											.getField("Image_1_Link_Haddad__c") != null) {
										incomingEnforcer_tSalesforceOutput_1.put("Image_1_Link_Haddad__c",
												row12.Image_1_Link_Haddad__c);
									}
									// skip the put action if the input column doesn't appear in component runtime
									// schema
									if (incomingEnforcer_tSalesforceOutput_1.getRuntimeSchema()
											.getField("Image_1_Link_Type__c") != null) {
										incomingEnforcer_tSalesforceOutput_1.put("Image_1_Link_Type__c",
												row12.Image_1_Link_Type__c);
									}
									...
									outgoingMainRecordsIt_tSalesforceOutput_1 = outgoingMainRecordsList_tSalesforceOutput_1
											.iterator();
									while (outgoingMainRecordsIt_tSalesforceOutput_1.hasNext()) { // Start of data
																									// processing while
																									// block
											...
											if (factory_tSalesforceOutput_1OutMain == null) {
												factory_tSalesforceOutput_1OutMain = (org.talend.daikon.avro.converter.IndexedRecordConverter<Object, ? extends org.apache.avro.generic.IndexedRecord>) new org.talend.daikon.avro.AvroRegistry()
														.createIndexedRecordConverter(
																outgoingMain_tSalesforceOutput_1.getClass());
											}
...
///////////////////////		
											...
											if (row10.Id != null) { //
												...
												strBuffer_tLogRow_1.append(String.valueOf(row10.Id));
											...
											if (row10.Image_1_Link_Haddad__c != null) { //
												...
												strBuffer_tLogRow_1
														.append(String.valueOf(row10.Image_1_Link_Haddad__c));
											...
											if (row10.Image_1_Link_Type__c != null) { //
												...
												strBuffer_tLogRow_1.append(String.valueOf(row10.Image_1_Link_Type__c));
...
// Start of branch "out_2"
					if (out_2 != null) {
						...
						if (execStat) {
							runStat.updateStatOnConnection(iterateId, 1, 1, "out_2");
						}
...
// Start of branch "Update_Back_Image"
							if (Update_Back_Image != null) {
								...
								if (execStat) {
									runStat.updateStatOnConnection(iterateId, 1, 1, "Update_Back_Image");
								}
								...
								if (Update_Back_Image.Id == null) {
									...
									finder_tUniqRow_3.Id = Update_Back_Image.Id.toLowerCase();
								}
								...
								if (!keystUniqRow_3.contains(finder_tUniqRow_3)) {
									...
									if (Update_Back_Image.Id == null) {
										...
										new_tUniqRow_3.Id = Update_Back_Image.Id.toLowerCase();
									}
									...
									row13.Id = Update_Back_Image.Id;
									row13.Image_2_Link_Haddad__c = Update_Back_Image.Image_2_Link_Haddad__c;
									row13.Image_2_Link_Type__c = Update_Back_Image.Image_2_Link_Type__c;
...
// Start of branch "row13"
								if (row13 != null) {
									...
									// skip the put action if the input column doesn't appear in component runtime
									// schema
									if (incomingEnforcer_tSalesforceOutput_2.getRuntimeSchema()
											.getField("Id") != null) {
									...
									// schema
									if (incomingEnforcer_tSalesforceOutput_2.getRuntimeSchema()
											.getField("Image_2_Link_Haddad__c") != null) {
										incomingEnforcer_tSalesforceOutput_2.put("Image_2_Link_Haddad__c",
												row13.Image_2_Link_Haddad__c);
									}
									// skip the put action if the input column doesn't appear in component runtime
									// schema
									if (incomingEnforcer_tSalesforceOutput_2.getRuntimeSchema()
											.getField("Image_2_Link_Type__c") != null) {
										incomingEnforcer_tSalesforceOutput_2.put("Image_2_Link_Type__c",
												row13.Image_2_Link_Type__c);
									}
									org.apache.avro.generic.IndexedRecord data_tSalesforceOutput_2 = incomingEnforcer_tSalesforceOutput_2
											.getCurrentRecord();
									...
									if (!(writer_tSalesforceOutput_2 instanceof org.talend.components.api.component.runtime.WriterWithFeedback)) {
										...
										if (data_tSalesforceOutput_2 != null) {
											outgoingMainRecordsList_tSalesforceOutput_2 = java.util.Arrays
													.asList(data_tSalesforceOutput_2);
										}
									}
									...
									if (writer_tSalesforceOutput_2 instanceof org.talend.components.api.component.runtime.WriterWithFeedback) {
										...
										writerWithFeedbackMain_tSalesforceOutput_2 = new org.talend.codegen.flowvariables.runtime.FlowVariablesWriter(
												writerWithFeedbackMain_tSalesforceOutput_2,
												container_tSalesforceOutput_2);
										java.lang.Iterable<?> outgoingRecs_tSalesforceOutput_2 = writerWithFeedbackMain_tSalesforceOutput_2
												.getSuccessfulWrites();
										java.util.Iterator outgoingMainRecords_tSalesforceOutput_2 = outgoingRecs_tSalesforceOutput_2
												.iterator();
									...
									outgoingMainRecordsIt_tSalesforceOutput_2 = outgoingMainRecordsList_tSalesforceOutput_2
											.iterator();
									while (outgoingMainRecordsIt_tSalesforceOutput_2.hasNext()) { // Start of data
																									// processing while
																									// block

										if (outgoingMainRecordsIt_tSalesforceOutput_2.hasNext()) {
											row21 = new row21Struct();
											Object outgoingMain_tSalesforceOutput_2 = outgoingMainRecordsIt_tSalesforceOutput_2
													.next();

											// Construct the factory once when the first data arrives.
											if (factory_tSalesforceOutput_2OutMain == null) {
												factory_tSalesforceOutput_2OutMain = (org.talend.daikon.avro.converter.IndexedRecordConverter<Object, ? extends org.apache.avro.generic.IndexedRecord>) new org.talend.daikon.avro.AvroRegistry()
														.createIndexedRecordConverter(
																outgoingMain_tSalesforceOutput_2.getClass());
											}

											// Enforce the outgoing schema on the input.
											outgoingEnforcer_tSalesforceOutput_2OutMain
													.setWrapped(factory_tSalesforceOutput_2OutMain
															.convertToAvro(outgoingMain_tSalesforceOutput_2));
											Object columnValue_0_tSalesforceOutput_2OutMain = outgoingEnforcer_tSalesforceOutput_2OutMain
													.get(0);
											row21.Id = (String) (columnValue_0_tSalesforceOutput_2OutMain);
											Object columnValue_1_tSalesforceOutput_2OutMain = outgoingEnforcer_tSalesforceOutput_2OutMain
													.get(1);
											row21.Image_2_Link_Haddad__c = (String) (columnValue_1_tSalesforceOutput_2OutMain);
											Object columnValue_2_tSalesforceOutput_2OutMain = outgoingEnforcer_tSalesforceOutput_2OutMain
													.get(2);
...
///////////////////////		
											...
											if (row21.Id != null) { //
												...
												strBuffer_tLogRow_2.append(String.valueOf(row21.Id));
											...
											if (row21.Image_2_Link_Haddad__c != null) { //
												...
												strBuffer_tLogRow_2
														.append(String.valueOf(row21.Image_2_Link_Haddad__c));
											...
											if (row21.Image_2_Link_Type__c != null) { //
												...
												strBuffer_tLogRow_2.append(String.valueOf(row21.Image_2_Link_Type__c));
...
///////////////////////    			
									...
									if (writer_tSalesforceOutput_2 instanceof org.talend.components.api.component.runtime.WriterWithFeedback) {
										((org.talend.components.api.component.runtime.WriterWithFeedback) writer_tSalesforceOutput_2)
												.cleanWrites();
									}
...
// Start of branch "out_3"
					if (out_3 != null) {
						...
						if (execStat) {
							runStat.updateStatOnConnection(iterateId, 1, 1, "out_3");
						}
...
// # Filter conditions 
									...
									"Right".equals(row16.property_Photo_View) == true
											...
											|| ("Details".equals(row16.property_Photo_View) == true
													&& row16.name.indexOf("_D1") >= 0)

									) {
										copyOfUpdate_Back_Image_tmp.Id = out_3.Id;
										copyOfUpdate_Back_Image_tmp.Image_3_Link_Haddad__c = row16.webImage;
										copyOfUpdate_Back_Image_tmp.Image_3_Link_Type__c = (row16.name
												.indexOf("_F_R") >= 0 || row16.name.indexOf("_C_R") >= 0
												|| row16.name.indexOf("_M_R") >= 0 || row16.name.indexOf("_Q_R") >= 0
														? "Right"
														: (row16.name.indexOf("_M_F") >= 0 ? "Model"
																: (row16.name.indexOf("_F_L") >= 0
																		|| row16.name.indexOf("_C_L") >= 0
																		|| row16.name.indexOf("_M_L") >= 0
																		|| row16.name.indexOf("_Q_L") >= 0 ? "Left"
																				: "Detail")));
...
// Start of branch "copyOfUpdate_Back_Image"
							if (copyOfUpdate_Back_Image != null) {
								...
								if (execStat) {
									runStat.updateStatOnConnection(iterateId, 1, 1, "copyOfUpdate_Back_Image");
								}
								...
								if (copyOfUpdate_Back_Image.Id == null) {
									...
									finder_tUniqRow_4.Id = copyOfUpdate_Back_Image.Id.toLowerCase();
								}
								...
								if (!keystUniqRow_4.contains(finder_tUniqRow_4)) {
									...
									if (copyOfUpdate_Back_Image.Id == null) {
										...
										new_tUniqRow_4.Id = copyOfUpdate_Back_Image.Id.toLowerCase();
									}
									...
									row17.Id = copyOfUpdate_Back_Image.Id;
									row17.Image_3_Link_Haddad__c = copyOfUpdate_Back_Image.Image_3_Link_Haddad__c;
									row17.Image_3_Link_Type__c = copyOfUpdate_Back_Image.Image_3_Link_Type__c;
...
// Start of branch "row17"
								if (row17 != null) {
									...
									// skip the put action if the input column doesn't appear in component runtime
									// schema
									if (incomingEnforcer_tSalesforceOutput_3.getRuntimeSchema()
											.getField("Id") != null) {
									...
									// schema
									if (incomingEnforcer_tSalesforceOutput_3.getRuntimeSchema()
											.getField("Image_3_Link_Haddad__c") != null) {
										incomingEnforcer_tSalesforceOutput_3.put("Image_3_Link_Haddad__c",
												row17.Image_3_Link_Haddad__c);
									}
									// skip the put action if the input column doesn't appear in component runtime
									// schema
									if (incomingEnforcer_tSalesforceOutput_3.getRuntimeSchema()
											.getField("Image_3_Link_Type__c") != null) {
										incomingEnforcer_tSalesforceOutput_3.put("Image_3_Link_Type__c",
												row17.Image_3_Link_Type__c);
									}
									...
									outgoingMainRecordsIt_tSalesforceOutput_3 = outgoingMainRecordsList_tSalesforceOutput_3
											.iterator();
									while (outgoingMainRecordsIt_tSalesforceOutput_3.hasNext()) { // Start of data
																									// processing while
																									// block
										...
										if (outgoingMainRecordsIt_tSalesforceOutput_3.hasNext()) {
											...
											if (factory_tSalesforceOutput_3OutMain == null) {
												factory_tSalesforceOutput_3OutMain = (org.talend.daikon.avro.converter.IndexedRecordConverter<Object, ? extends org.apache.avro.generic.IndexedRecord>) new org.talend.daikon.avro.AvroRegistry()
														.createIndexedRecordConverter(
																outgoingMain_tSalesforceOutput_3.getClass());
											}
...
///////////////////////		
											...
											if (row22.Id != null) { //
												...
												strBuffer_tLogRow_3.append(String.valueOf(row22.Id));
											...
											if (row22.Image_3_Link_Haddad__c != null) { //
												...
												strBuffer_tLogRow_3
														.append(String.valueOf(row22.Image_3_Link_Haddad__c));
											...
											if (row22.Image_3_Link_Type__c != null) { //
												...
												strBuffer_tLogRow_3.append(String.valueOf(row22.Image_3_Link_Type__c));
...
// Start of branch "out_4"
					if (out_4 != null) {
						...
						if (execStat) {
							runStat.updateStatOnConnection(iterateId, 1, 1, "out_4");
						}
...
// # Filter conditions 
									...
									"Left".equals(row18.property_Photo_View) == true
											|| ("Details".equals(row18.property_Photo_View) == true
													&& row18.name.indexOf("_D2") >= 0)

									) {
										copyOfcopyOfUpdate_Back_Image_tmp.Id = out_4.Id;
										copyOfcopyOfUpdate_Back_Image_tmp.Image_4_Link_Haddad__c = row18.webImage;
										copyOfcopyOfUpdate_Back_Image_tmp.Image_4_Link_Type__c = (row18.name
												.indexOf("_F_L") >= 0 || row18.name.indexOf("_C_L") >= 0
												|| row18.name.indexOf("_M_L") >= 0 || row18.name.indexOf("_Q_L") >= 0
														? "Left"
														: "Detail");
...
// Start of branch "copyOfcopyOfUpdate_Back_Image"
							if (copyOfcopyOfUpdate_Back_Image != null) {
								...
								if (execStat) {
									runStat.updateStatOnConnection(iterateId, 1, 1, "copyOfcopyOfUpdate_Back_Image");
								}
								...
								if (copyOfcopyOfUpdate_Back_Image.Id == null) {
									...
									finder_tUniqRow_5.Id = copyOfcopyOfUpdate_Back_Image.Id.toLowerCase();
								}
								...
								if (!keystUniqRow_5.contains(finder_tUniqRow_5)) {
									...
									if (copyOfcopyOfUpdate_Back_Image.Id == null) {
										...
										new_tUniqRow_5.Id = copyOfcopyOfUpdate_Back_Image.Id.toLowerCase();
									}
									...
									row19.Id = copyOfcopyOfUpdate_Back_Image.Id;
									row19.Image_4_Link_Haddad__c = copyOfcopyOfUpdate_Back_Image.Image_4_Link_Haddad__c;
									row19.Image_4_Link_Type__c = copyOfcopyOfUpdate_Back_Image.Image_4_Link_Type__c;
...
// Start of branch "row19"
								if (row19 != null) {
									...
									// schema
									if (incomingEnforcer_tSalesforceOutput_4.getRuntimeSchema()
											.getField("Image_4_Link_Haddad__c") != null) {
										incomingEnforcer_tSalesforceOutput_4.put("Image_4_Link_Haddad__c",
												row19.Image_4_Link_Haddad__c);
									}
									// skip the put action if the input column doesn't appear in component runtime
									// schema
									if (incomingEnforcer_tSalesforceOutput_4.getRuntimeSchema()
											.getField("Image_4_Link_Type__c") != null) {
										incomingEnforcer_tSalesforceOutput_4.put("Image_4_Link_Type__c",
												row19.Image_4_Link_Type__c);
									}
									...
									if (!(writer_tSalesforceOutput_4 instanceof org.talend.components.api.component.runtime.WriterWithFeedback)) {
										...
										if (data_tSalesforceOutput_4 != null) {
											outgoingMainRecordsList_tSalesforceOutput_4 = java.util.Arrays
													.asList(data_tSalesforceOutput_4);
										}
									}
									...
									if (writer_tSalesforceOutput_4 instanceof org.talend.components.api.component.runtime.WriterWithFeedback) {
										...
										writerWithFeedbackMain_tSalesforceOutput_4 = new org.talend.codegen.flowvariables.runtime.FlowVariablesWriter(
												writerWithFeedbackMain_tSalesforceOutput_4,
												container_tSalesforceOutput_4);
										java.lang.Iterable<?> outgoingRecs_tSalesforceOutput_4 = writerWithFeedbackMain_tSalesforceOutput_4
												.getSuccessfulWrites();
										java.util.Iterator outgoingMainRecords_tSalesforceOutput_4 = outgoingRecs_tSalesforceOutput_4
												.iterator();
									...
									outgoingMainRecordsIt_tSalesforceOutput_4 = outgoingMainRecordsList_tSalesforceOutput_4
											.iterator();
									while (outgoingMainRecordsIt_tSalesforceOutput_4.hasNext()) { // Start of data
																									// processing while
																									// block

										if (outgoingMainRecordsIt_tSalesforceOutput_4.hasNext()) {
											row23 = new row23Struct();
											Object outgoingMain_tSalesforceOutput_4 = outgoingMainRecordsIt_tSalesforceOutput_4
													.next();

											// Construct the factory once when the first data arrives.
											if (factory_tSalesforceOutput_4OutMain == null) {
												factory_tSalesforceOutput_4OutMain = (org.talend.daikon.avro.converter.IndexedRecordConverter<Object, ? extends org.apache.avro.generic.IndexedRecord>) new org.talend.daikon.avro.AvroRegistry()
														.createIndexedRecordConverter(
																outgoingMain_tSalesforceOutput_4.getClass());
											}

											// Enforce the outgoing schema on the input.
											outgoingEnforcer_tSalesforceOutput_4OutMain
													.setWrapped(factory_tSalesforceOutput_4OutMain
															.convertToAvro(outgoingMain_tSalesforceOutput_4));
											Object columnValue_0_tSalesforceOutput_4OutMain = outgoingEnforcer_tSalesforceOutput_4OutMain
													.get(0);
											row23.Id = (String) (columnValue_0_tSalesforceOutput_4OutMain);
											Object columnValue_1_tSalesforceOutput_4OutMain = outgoingEnforcer_tSalesforceOutput_4OutMain
													.get(1);
											row23.Image_4_Link_Haddad__c = (String) (columnValue_1_tSalesforceOutput_4OutMain);
											Object columnValue_2_tSalesforceOutput_4OutMain = outgoingEnforcer_tSalesforceOutput_4OutMain
													.get(2);
...
///////////////////////		
											...
											if (row23.Id != null) { //
												...
												strBuffer_tLogRow_4.append(String.valueOf(row23.Id));
											...
											if (row23.Image_4_Link_Haddad__c != null) { //
												...
												strBuffer_tLogRow_4
														.append(String.valueOf(row23.Image_4_Link_Haddad__c));
											...
											if (row23.Image_4_Link_Type__c != null) { //
												...
												strBuffer_tLogRow_4.append(String.valueOf(row23.Image_4_Link_Type__c));
...
///////////////////////    			
									...
									if (writer_tSalesforceOutput_4 instanceof org.talend.components.api.component.runtime.WriterWithFeedback) {
										((org.talend.components.api.component.runtime.WriterWithFeedback) writer_tSalesforceOutput_4)
												.cleanWrites();
									}
...
// Start of branch "out_5"
					if (out_5 != null) {
						...
						if (execStat) {
							runStat.updateStatOnConnection(iterateId, 1, 1, "out_5");
						}
...
// Start of branch "copyOfcopyOfcopyOfUpdate_Back_Image"
							if (copyOfcopyOfcopyOfUpdate_Back_Image != null) {
								...
								if (execStat) {
									runStat.updateStatOnConnection(iterateId, 1, 1,
											"copyOfcopyOfcopyOfUpdate_Back_Image");
								}
								...
								if (copyOfcopyOfcopyOfUpdate_Back_Image.Id == null) {
									...
									finder_tUniqRow_6.Id = copyOfcopyOfcopyOfUpdate_Back_Image.Id.toLowerCase();
								}
								...
								if (!keystUniqRow_6.contains(finder_tUniqRow_6)) {
									...
									if (copyOfcopyOfcopyOfUpdate_Back_Image.Id == null) {
										...
										new_tUniqRow_6.Id = copyOfcopyOfcopyOfUpdate_Back_Image.Id.toLowerCase();
									}
									...
									row11.Id = copyOfcopyOfcopyOfUpdate_Back_Image.Id;
									row11.Image_5_Link_Haddad__c = copyOfcopyOfcopyOfUpdate_Back_Image.Image_5_Link_Haddad__c;
									row11.Image_5_Link_Type__c = copyOfcopyOfcopyOfUpdate_Back_Image.Image_5_Link_Type__c;
...
// Start of branch "row11"
								if (row11 != null) {
									...
									// skip the put action if the input column doesn't appear in component runtime
									// schema
									if (incomingEnforcer_tSalesforceOutput_5.getRuntimeSchema()
											.getField("Id") != null) {
									...
									// schema
									if (incomingEnforcer_tSalesforceOutput_5.getRuntimeSchema()
											.getField("Image_5_Link_Haddad__c") != null) {
										incomingEnforcer_tSalesforceOutput_5.put("Image_5_Link_Haddad__c",
												row11.Image_5_Link_Haddad__c);
									}
									// skip the put action if the input column doesn't appear in component runtime
									// schema
									if (incomingEnforcer_tSalesforceOutput_5.getRuntimeSchema()
											.getField("Image_5_Link_Type__c") != null) {
										incomingEnforcer_tSalesforceOutput_5.put("Image_5_Link_Type__c",
												row11.Image_5_Link_Type__c);
									}
									org.apache.avro.generic.IndexedRecord data_tSalesforceOutput_5 = incomingEnforcer_tSalesforceOutput_5
											.getCurrentRecord();
									...
									if (!(writer_tSalesforceOutput_5 instanceof org.talend.components.api.component.runtime.WriterWithFeedback)) {
										...
										if (data_tSalesforceOutput_5 != null) {
											outgoingMainRecordsList_tSalesforceOutput_5 = java.util.Arrays
													.asList(data_tSalesforceOutput_5);
										}
									}
									...
									if (writer_tSalesforceOutput_5 instanceof org.talend.components.api.component.runtime.WriterWithFeedback) {
										...
										writerWithFeedbackMain_tSalesforceOutput_5 = new org.talend.codegen.flowvariables.runtime.FlowVariablesWriter(
												writerWithFeedbackMain_tSalesforceOutput_5,
												container_tSalesforceOutput_5);
										java.lang.Iterable<?> outgoingRecs_tSalesforceOutput_5 = writerWithFeedbackMain_tSalesforceOutput_5
												.getSuccessfulWrites();
										java.util.Iterator outgoingMainRecords_tSalesforceOutput_5 = outgoingRecs_tSalesforceOutput_5
												.iterator();
									...
									outgoingMainRecordsIt_tSalesforceOutput_5 = outgoingMainRecordsList_tSalesforceOutput_5
											.iterator();
									while (outgoingMainRecordsIt_tSalesforceOutput_5.hasNext()) { // Start of data
																									// processing while
																									// block

										if (outgoingMainRecordsIt_tSalesforceOutput_5.hasNext()) {
											row20 = new row20Struct();
											Object outgoingMain_tSalesforceOutput_5 = outgoingMainRecordsIt_tSalesforceOutput_5
													.next();

											// Construct the factory once when the first data arrives.
											if (factory_tSalesforceOutput_5OutMain == null) {
												factory_tSalesforceOutput_5OutMain = (org.talend.daikon.avro.converter.IndexedRecordConverter<Object, ? extends org.apache.avro.generic.IndexedRecord>) new org.talend.daikon.avro.AvroRegistry()
														.createIndexedRecordConverter(
																outgoingMain_tSalesforceOutput_5.getClass());
											}

											// Enforce the outgoing schema on the input.
											outgoingEnforcer_tSalesforceOutput_5OutMain
													.setWrapped(factory_tSalesforceOutput_5OutMain
															.convertToAvro(outgoingMain_tSalesforceOutput_5));
											Object columnValue_0_tSalesforceOutput_5OutMain = outgoingEnforcer_tSalesforceOutput_5OutMain
													.get(0);
											row20.Id = (String) (columnValue_0_tSalesforceOutput_5OutMain);
											Object columnValue_1_tSalesforceOutput_5OutMain = outgoingEnforcer_tSalesforceOutput_5OutMain
													.get(1);
											row20.Image_5_Link_Haddad__c = (String) (columnValue_1_tSalesforceOutput_5OutMain);
											Object columnValue_2_tSalesforceOutput_5OutMain = outgoingEnforcer_tSalesforceOutput_5OutMain
													.get(2);
...
///////////////////////		
											...
											if (row20.Id != null) { //
												...
												strBuffer_tLogRow_5.append(String.valueOf(row20.Id));
											...
											if (row20.Image_5_Link_Haddad__c != null) { //
												...
												strBuffer_tLogRow_5
														.append(String.valueOf(row20.Image_5_Link_Haddad__c));
											...
											if (row20.Image_5_Link_Type__c != null) { //
												...
												strBuffer_tLogRow_5.append(String.valueOf(row20.Image_5_Link_Type__c));
...
///////////////////////    			
									...
									if (writer_tSalesforceOutput_5 instanceof org.talend.components.api.component.runtime.WriterWithFeedback) {
										((org.talend.components.api.component.runtime.WriterWithFeedback) writer_tSalesforceOutput_5)
												.cleanWrites();
									}
...
// ###############################      
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "updateSF_Front_Image");
				}
...
// end of generic
				...
				if (writer_tSalesforceOutput_1 instanceof org.talend.components.api.component.runtime.WriterWithFeedback) {
					org.talend.components.api.component.runtime.WriterWithFeedback writerWithFeedbackMain_tSalesforceOutput_1 = (org.talend.components.api.component.runtime.WriterWithFeedback) writer_tSalesforceOutput_1;
					writerWithFeedbackMain_tSalesforceOutput_1 = new org.talend.codegen.flowvariables.runtime.FlowVariablesWriter(
							writerWithFeedbackMain_tSalesforceOutput_1, container_tSalesforceOutput_1);
					java.lang.Iterable<?> outgoingRecs_tSalesforceOutput_1 = writerWithFeedbackMain_tSalesforceOutput_1
							.getSuccessfulWrites();
					java.util.Iterator outgoingMainRecords_tSalesforceOutput_1 = outgoingRecs_tSalesforceOutput_1
							.iterator();
				...
				while (outgoingMainRecordsIt_tSalesforceOutput_1.hasNext()) { // Start of data processing while block
					...
					if (outgoingMainRecordsIt_tSalesforceOutput_1.hasNext()) {
						...
						// Enforce the outgoing schema on the input.
						outgoingEnforcer_tSalesforceOutput_1OutMain.setWrapped(
								factory_tSalesforceOutput_1OutMain.convertToAvro(outgoingMain_tSalesforceOutput_1));
						Object columnValue_0_tSalesforceOutput_1OutMain = outgoingEnforcer_tSalesforceOutput_1OutMain
								.get(0);
						row10.Id = (String) (columnValue_0_tSalesforceOutput_1OutMain);
						Object columnValue_1_tSalesforceOutput_1OutMain = outgoingEnforcer_tSalesforceOutput_1OutMain
...
///////////////////////		
						...
						if (row10.Image_1_Link_Haddad__c != null) { //
							...
							strBuffer_tLogRow_1.append(String.valueOf(row10.Image_1_Link_Haddad__c));
...
// ###############################      
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "Update_Back_Image");
				}
...
// end of generic
				...
				if (writer_tSalesforceOutput_2 instanceof org.talend.components.api.component.runtime.WriterWithFeedback) {
					org.talend.components.api.component.runtime.WriterWithFeedback writerWithFeedbackMain_tSalesforceOutput_2 = (org.talend.components.api.component.runtime.WriterWithFeedback) writer_tSalesforceOutput_2;
					writerWithFeedbackMain_tSalesforceOutput_2 = new org.talend.codegen.flowvariables.runtime.FlowVariablesWriter(
							writerWithFeedbackMain_tSalesforceOutput_2, container_tSalesforceOutput_2);
					java.lang.Iterable<?> outgoingRecs_tSalesforceOutput_2 = writerWithFeedbackMain_tSalesforceOutput_2
							.getSuccessfulWrites();
					java.util.Iterator outgoingMainRecords_tSalesforceOutput_2 = outgoingRecs_tSalesforceOutput_2
							.iterator();
				...
				while (outgoingMainRecordsIt_tSalesforceOutput_2.hasNext()) { // Start of data processing while block
					...
					if (outgoingMainRecordsIt_tSalesforceOutput_2.hasNext()) {
						...
						// Enforce the outgoing schema on the input.
						outgoingEnforcer_tSalesforceOutput_2OutMain.setWrapped(
								factory_tSalesforceOutput_2OutMain.convertToAvro(outgoingMain_tSalesforceOutput_2));
						Object columnValue_0_tSalesforceOutput_2OutMain = outgoingEnforcer_tSalesforceOutput_2OutMain
								.get(0);
						row21.Id = (String) (columnValue_0_tSalesforceOutput_2OutMain);
						Object columnValue_1_tSalesforceOutput_2OutMain = outgoingEnforcer_tSalesforceOutput_2OutMain
...
///////////////////////		
						...
						if (row21.Image_2_Link_Haddad__c != null) { //
							...
							strBuffer_tLogRow_2.append(String.valueOf(row21.Image_2_Link_Haddad__c));
...
// ###############################      
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "copyOfUpdate_Back_Image");
				}
...
// end of generic
				...
				final java.util.Map<String, Object> resultMap_tSalesforceOutput_3 = writer_tSalesforceOutput_3
						.getWriteOperation()
						.finalize(java.util.Arrays.<org.talend.components.api.component.runtime.Result>asList(
								resultObject_tSalesforceOutput_3), container_tSalesforceOutput_3);
				if (resultMap_tSalesforceOutput_3 != null) {
					for (java.util.Map.Entry<String, Object> entry_tSalesforceOutput_3 : resultMap_tSalesforceOutput_3
						...
						case org.talend.components.api.component.ComponentDefinition.RETURN_ERROR_MESSAGE:
							container_tSalesforceOutput_3.setComponentData("tSalesforceOutput_3", "ERROR_MESSAGE",
									entry_tSalesforceOutput_3.getValue());
							break;
						case org.talend.components.api.component.ComponentDefinition.RETURN_TOTAL_RECORD_COUNT:
							container_tSalesforceOutput_3.setComponentData("tSalesforceOutput_3", "NB_LINE",
									entry_tSalesforceOutput_3.getValue());
							break;
						case org.talend.components.api.component.ComponentDefinition.RETURN_SUCCESS_RECORD_COUNT:
							container_tSalesforceOutput_3.setComponentData("tSalesforceOutput_3", "NB_SUCCESS",
									entry_tSalesforceOutput_3.getValue());
							break;
						case org.talend.components.api.component.ComponentDefinition.RETURN_REJECT_RECORD_COUNT:
							container_tSalesforceOutput_3.setComponentData("tSalesforceOutput_3", "NB_REJECT",
									entry_tSalesforceOutput_3.getValue());
							break;
						default:
							...
							for (int i_tSalesforceOutput_3 = 0; i_tSalesforceOutput_3 < entry_tSalesforceOutput_3
								...
								char ch_tSalesforceOutput_3 = entry_tSalesforceOutput_3.getKey()
										.charAt(i_tSalesforceOutput_3);
							...
							container_tSalesforceOutput_3.setComponentData("tSalesforceOutput_3",
									studio_key_tSalesforceOutput_3.toString().toUpperCase(java.util.Locale.ENGLISH),
									entry_tSalesforceOutput_3.getValue());
							break;
						}
					}
				...
				if (writer_tSalesforceOutput_3 instanceof org.talend.components.api.component.runtime.WriterWithFeedback) {
					org.talend.components.api.component.runtime.WriterWithFeedback writerWithFeedbackMain_tSalesforceOutput_3 = (org.talend.components.api.component.runtime.WriterWithFeedback) writer_tSalesforceOutput_3;
					writerWithFeedbackMain_tSalesforceOutput_3 = new org.talend.codegen.flowvariables.runtime.FlowVariablesWriter(
							writerWithFeedbackMain_tSalesforceOutput_3, container_tSalesforceOutput_3);
					java.lang.Iterable<?> outgoingRecs_tSalesforceOutput_3 = writerWithFeedbackMain_tSalesforceOutput_3
							.getSuccessfulWrites();
					java.util.Iterator outgoingMainRecords_tSalesforceOutput_3 = outgoingRecs_tSalesforceOutput_3
							.iterator();
				...
				while (outgoingMainRecordsIt_tSalesforceOutput_3.hasNext()) { // Start of data processing while block
					...
					if (outgoingMainRecordsIt_tSalesforceOutput_3.hasNext()) {
						...
						// Enforce the outgoing schema on the input.
						outgoingEnforcer_tSalesforceOutput_3OutMain.setWrapped(
								factory_tSalesforceOutput_3OutMain.convertToAvro(outgoingMain_tSalesforceOutput_3));
						Object columnValue_0_tSalesforceOutput_3OutMain = outgoingEnforcer_tSalesforceOutput_3OutMain
								.get(0);
						row22.Id = (String) (columnValue_0_tSalesforceOutput_3OutMain);
						Object columnValue_1_tSalesforceOutput_3OutMain = outgoingEnforcer_tSalesforceOutput_3OutMain
...
///////////////////////		
						...
						if (row22.Image_3_Link_Haddad__c != null) { //
							...
							strBuffer_tLogRow_3.append(String.valueOf(row22.Image_3_Link_Haddad__c));
...
// ###############################      
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "out_4");
				}
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "copyOfcopyOfUpdate_Back_Image");
				}
...
// end of generic
				...
				final java.util.Map<String, Object> resultMap_tSalesforceOutput_4 = writer_tSalesforceOutput_4
						.getWriteOperation()
						.finalize(java.util.Arrays.<org.talend.components.api.component.runtime.Result>asList(
								resultObject_tSalesforceOutput_4), container_tSalesforceOutput_4);
				if (resultMap_tSalesforceOutput_4 != null) {
					for (java.util.Map.Entry<String, Object> entry_tSalesforceOutput_4 : resultMap_tSalesforceOutput_4
						...
						case org.talend.components.api.component.ComponentDefinition.RETURN_ERROR_MESSAGE:
							container_tSalesforceOutput_4.setComponentData("tSalesforceOutput_4", "ERROR_MESSAGE",
									entry_tSalesforceOutput_4.getValue());
							break;
						case org.talend.components.api.component.ComponentDefinition.RETURN_TOTAL_RECORD_COUNT:
							container_tSalesforceOutput_4.setComponentData("tSalesforceOutput_4", "NB_LINE",
									entry_tSalesforceOutput_4.getValue());
							break;
						case org.talend.components.api.component.ComponentDefinition.RETURN_SUCCESS_RECORD_COUNT:
							container_tSalesforceOutput_4.setComponentData("tSalesforceOutput_4", "NB_SUCCESS",
									entry_tSalesforceOutput_4.getValue());
							break;
						case org.talend.components.api.component.ComponentDefinition.RETURN_REJECT_RECORD_COUNT:
							container_tSalesforceOutput_4.setComponentData("tSalesforceOutput_4", "NB_REJECT",
									entry_tSalesforceOutput_4.getValue());
							break;
						default:
							...
							for (int i_tSalesforceOutput_4 = 0; i_tSalesforceOutput_4 < entry_tSalesforceOutput_4
								...
								char ch_tSalesforceOutput_4 = entry_tSalesforceOutput_4.getKey()
										.charAt(i_tSalesforceOutput_4);
							...
							container_tSalesforceOutput_4.setComponentData("tSalesforceOutput_4",
									studio_key_tSalesforceOutput_4.toString().toUpperCase(java.util.Locale.ENGLISH),
									entry_tSalesforceOutput_4.getValue());
							break;
						}
					}
				...
				if (writer_tSalesforceOutput_4 instanceof org.talend.components.api.component.runtime.WriterWithFeedback) {
					org.talend.components.api.component.runtime.WriterWithFeedback writerWithFeedbackMain_tSalesforceOutput_4 = (org.talend.components.api.component.runtime.WriterWithFeedback) writer_tSalesforceOutput_4;
					writerWithFeedbackMain_tSalesforceOutput_4 = new org.talend.codegen.flowvariables.runtime.FlowVariablesWriter(
							writerWithFeedbackMain_tSalesforceOutput_4, container_tSalesforceOutput_4);
					java.lang.Iterable<?> outgoingRecs_tSalesforceOutput_4 = writerWithFeedbackMain_tSalesforceOutput_4
							.getSuccessfulWrites();
					java.util.Iterator outgoingMainRecords_tSalesforceOutput_4 = outgoingRecs_tSalesforceOutput_4
							.iterator();
				...
				while (outgoingMainRecordsIt_tSalesforceOutput_4.hasNext()) { // Start of data processing while block
					...
					if (outgoingMainRecordsIt_tSalesforceOutput_4.hasNext()) {
						...
						// Enforce the outgoing schema on the input.
						outgoingEnforcer_tSalesforceOutput_4OutMain.setWrapped(
								factory_tSalesforceOutput_4OutMain.convertToAvro(outgoingMain_tSalesforceOutput_4));
						Object columnValue_0_tSalesforceOutput_4OutMain = outgoingEnforcer_tSalesforceOutput_4OutMain
								.get(0);
						row23.Id = (String) (columnValue_0_tSalesforceOutput_4OutMain);
						Object columnValue_1_tSalesforceOutput_4OutMain = outgoingEnforcer_tSalesforceOutput_4OutMain
...
///////////////////////		
						...
						if (row23.Image_4_Link_Haddad__c != null) { //
							...
							strBuffer_tLogRow_4.append(String.valueOf(row23.Image_4_Link_Haddad__c));
...
// ###############################      
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "out_5");
				}
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "copyOfcopyOfcopyOfUpdate_Back_Image");
				}
...
// end of generic
				...
				org.talend.components.api.component.runtime.Result resultObject_tSalesforceOutput_5 = (org.talend.components.api.component.runtime.Result) writer_tSalesforceOutput_5
						.close();
				final java.util.Map<String, Object> resultMap_tSalesforceOutput_5 = writer_tSalesforceOutput_5
						.getWriteOperation()
						.finalize(java.util.Arrays.<org.talend.components.api.component.runtime.Result>asList(
								resultObject_tSalesforceOutput_5), container_tSalesforceOutput_5);
				if (resultMap_tSalesforceOutput_5 != null) {
					for (java.util.Map.Entry<String, Object> entry_tSalesforceOutput_5 : resultMap_tSalesforceOutput_5
							.entrySet()) {
						switch (entry_tSalesforceOutput_5.getKey()) {
						case org.talend.components.api.component.ComponentDefinition.RETURN_ERROR_MESSAGE:
							container_tSalesforceOutput_5.setComponentData("tSalesforceOutput_5", "ERROR_MESSAGE",
									entry_tSalesforceOutput_5.getValue());
							break;
						case org.talend.components.api.component.ComponentDefinition.RETURN_TOTAL_RECORD_COUNT:
							container_tSalesforceOutput_5.setComponentData("tSalesforceOutput_5", "NB_LINE",
									entry_tSalesforceOutput_5.getValue());
							break;
						case org.talend.components.api.component.ComponentDefinition.RETURN_SUCCESS_RECORD_COUNT:
							container_tSalesforceOutput_5.setComponentData("tSalesforceOutput_5", "NB_SUCCESS",
									entry_tSalesforceOutput_5.getValue());
							break;
						case org.talend.components.api.component.ComponentDefinition.RETURN_REJECT_RECORD_COUNT:
							container_tSalesforceOutput_5.setComponentData("tSalesforceOutput_5", "NB_REJECT",
									entry_tSalesforceOutput_5.getValue());
							break;
						default:
							StringBuilder studio_key_tSalesforceOutput_5 = new StringBuilder();
							for (int i_tSalesforceOutput_5 = 0; i_tSalesforceOutput_5 < entry_tSalesforceOutput_5
									.getKey().length(); i_tSalesforceOutput_5++) {
								char ch_tSalesforceOutput_5 = entry_tSalesforceOutput_5.getKey()
										.charAt(i_tSalesforceOutput_5);
							...
							container_tSalesforceOutput_5.setComponentData("tSalesforceOutput_5",
									studio_key_tSalesforceOutput_5.toString().toUpperCase(java.util.Locale.ENGLISH),
									entry_tSalesforceOutput_5.getValue());
							break;
						}
					}
				...
				if (writer_tSalesforceOutput_5 instanceof org.talend.components.api.component.runtime.WriterWithFeedback) {
					org.talend.components.api.component.runtime.WriterWithFeedback writerWithFeedbackMain_tSalesforceOutput_5 = (org.talend.components.api.component.runtime.WriterWithFeedback) writer_tSalesforceOutput_5;
					writerWithFeedbackMain_tSalesforceOutput_5 = new org.talend.codegen.flowvariables.runtime.FlowVariablesWriter(
							writerWithFeedbackMain_tSalesforceOutput_5, container_tSalesforceOutput_5);
					java.lang.Iterable<?> outgoingRecs_tSalesforceOutput_5 = writerWithFeedbackMain_tSalesforceOutput_5
							.getSuccessfulWrites();
					java.util.Iterator outgoingMainRecords_tSalesforceOutput_5 = outgoingRecs_tSalesforceOutput_5
							.iterator();
				...
				while (outgoingMainRecordsIt_tSalesforceOutput_5.hasNext()) { // Start of data processing while block
					...
					if (outgoingMainRecordsIt_tSalesforceOutput_5.hasNext()) {
						...
						// Enforce the outgoing schema on the input.
						outgoingEnforcer_tSalesforceOutput_5OutMain.setWrapped(
								factory_tSalesforceOutput_5OutMain.convertToAvro(outgoingMain_tSalesforceOutput_5));
						Object columnValue_0_tSalesforceOutput_5OutMain = outgoingEnforcer_tSalesforceOutput_5OutMain
								.get(0);
						row20.Id = (String) (columnValue_0_tSalesforceOutput_5OutMain);
						Object columnValue_1_tSalesforceOutput_5OutMain = outgoingEnforcer_tSalesforceOutput_5OutMain
...
///////////////////////		
						...
						if (row20.Image_5_Link_Haddad__c != null) { //
							...
							strBuffer_tLogRow_5.append(String.valueOf(row20.Image_5_Link_Haddad__c));
...
// finally of generic
				...
				if (resourceMap.get("finish_tSalesforceOutput_5") == null) {
					if (resourceMap.get("writer_tSalesforceOutput_5") != null) {
						try {
							((org.talend.components.api.component.runtime.Writer) resourceMap
									.get("writer_tSalesforceOutput_5")).close();
						} catch (java.io.IOException e_tSalesforceOutput_5) {
							String errorMessage_tSalesforceOutput_5 = "failed to release the resource in tSalesforceOutput_5 :"
									+ e_tSalesforceOutput_5.getMessage();
	...
	public void tFileExist_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeEntryMethodName == null || globalResumeTicket) {
				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tFileExist_2:OnSubjobOk", "",
						Thread.currentThread().getId() + "", "", "", "", "", "");
			}
	...
	public static class row9Struct implements routines.system.IPersistableComparableLookupRow<row9Struct> {
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				result = prime * result
						+ ((this.property_Color_Code == null) ? 0 : this.property_Color_Code.hashCode());

				result = prime * result
						+ ((this.property_Style_Code == null) ? 0 : this.property_Style_Code.hashCode());
	...
	public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// source node:tFileInputDelimited_1 - inputs:() outputs:(row9,row9) | target
				// node:tAdvancedHash_row9 - inputs:(row9) outputs:()
				// linked node: tMap_3 - inputs:(out1,row9) outputs:(updateSF_Front_Image)
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = "C:/Haddad_Interface_SF_JDE/Interface Bynder/hors eCom/recoverAssetsFromBynderToSF/assetsToInsertInSF.csv";
					...
					while (fid_tFileInputDelimited_1 != null && fid_tFileInputDelimited_1.nextRecord()) {
						...
						try {
							...
							row9.property_Color_Code = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 1;

							row9.property_Style_Code = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 2;

							row9.webImage = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 3;

							row9.property_Photo_View = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
							...
							row9.thul = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
...
// Start of branch "row9"
					...
					if (!((Object) ("C:/Haddad_Interface_SF_JDE/Interface Bynder/hors eCom/recoverAssetsFromBynderToSF/assetsToInsertInSF.csv") instanceof java.io.InputStream)) {
	...
	public void tFileInputDelimited_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// source node:tFileInputDelimited_2 - inputs:() outputs:(row14,row14) | target
				// node:tAdvancedHash_row14 - inputs:(row14) outputs:()
				// linked node: tMap_4 - inputs:(out_2,row14) outputs:(Update_Back_Image)
				...
				try {
					...
					Object filename_tFileInputDelimited_2 = "C:/Haddad_Interface_SF_JDE/Interface Bynder/hors eCom/recoverAssetsFromBynderToSF/assetsToInsertInSF.csv";
					...
					while (fid_tFileInputDelimited_2 != null && fid_tFileInputDelimited_2.nextRecord()) {
						...
						try {
							...
							row14.property_Color_Code = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 1;

							row14.property_Style_Code = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 2;

							row14.webImage = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 3;

							row14.property_Photo_View = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 4;

							row14.name = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 5;

							row14.thul = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);
	...
	public void tFileInputDelimited_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// source node:tFileInputDelimited_3 - inputs:() outputs:(row16,row16) | target
				// node:tAdvancedHash_row16 - inputs:(row16) outputs:()
				// linked node: tMap_5 - inputs:(out_3,row16) outputs:(copyOfUpdate_Back_Image)
				...
				try {
					...
					Object filename_tFileInputDelimited_3 = "C:/Haddad_Interface_SF_JDE/Interface Bynder/hors eCom/recoverAssetsFromBynderToSF/assetsToInsertInSF.csv";
					...
					while (fid_tFileInputDelimited_3 != null && fid_tFileInputDelimited_3.nextRecord()) {
						...
						try {
							...
							row16.property_Color_Code = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 1;

							row16.property_Style_Code = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 2;

							row16.webImage = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 3;

							row16.property_Photo_View = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 4;

							row16.name = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 5;

							row16.thul = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);
	...
	public void tFileInputDelimited_4Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// source node:tFileInputDelimited_4 - inputs:() outputs:(row18,row18) | target
				// node:tAdvancedHash_row18 - inputs:(row18) outputs:()
				// linked node: tMap_6 - inputs:(out_4,row18)
				// outputs:(copyOfcopyOfUpdate_Back_Image)

				org.talend.designer.components.lookup.common.ICommonLookup.MATCHING_MODE matchingModeEnum_row18 = org.talend.designer.components.lookup.common.ICommonLookup.MATCHING_MODE.ALL_MATCHES;
				...
				try {
					...
					Object filename_tFileInputDelimited_4 = "C:/Haddad_Interface_SF_JDE/Interface Bynder/hors eCom/recoverAssetsFromBynderToSF/assetsToInsertInSF.csv";
					...
					while (fid_tFileInputDelimited_4 != null && fid_tFileInputDelimited_4.nextRecord()) {
						...
						try {
							...
							row18.property_Color_Code = fid_tFileInputDelimited_4
									.get(columnIndexWithD_tFileInputDelimited_4);

							columnIndexWithD_tFileInputDelimited_4 = 1;

							row18.property_Style_Code = fid_tFileInputDelimited_4
									.get(columnIndexWithD_tFileInputDelimited_4);

							columnIndexWithD_tFileInputDelimited_4 = 2;

							row18.webImage = fid_tFileInputDelimited_4.get(columnIndexWithD_tFileInputDelimited_4);

							columnIndexWithD_tFileInputDelimited_4 = 3;

							row18.property_Photo_View = fid_tFileInputDelimited_4
									.get(columnIndexWithD_tFileInputDelimited_4);

							columnIndexWithD_tFileInputDelimited_4 = 4;

							row18.name = fid_tFileInputDelimited_4.get(columnIndexWithD_tFileInputDelimited_4);

							columnIndexWithD_tFileInputDelimited_4 = 5;

							row18.thul = fid_tFileInputDelimited_4.get(columnIndexWithD_tFileInputDelimited_4);
	...
	public void tFileInputDelimited_5Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// source node:tFileInputDelimited_5 - inputs:() outputs:(row24,row24) | target
				// node:tAdvancedHash_row24 - inputs:(row24) outputs:()
				// linked node: tMap_7 - inputs:(out_5,row24)
				// outputs:(copyOfcopyOfcopyOfUpdate_Back_Image)
				...
				try {
					...
					Object filename_tFileInputDelimited_5 = "C:/Haddad_Interface_SF_JDE/Interface Bynder/hors eCom/recoverAssetsFromBynderToSF/assetsToInsertInSF.csv";
					...
					while (fid_tFileInputDelimited_5 != null && fid_tFileInputDelimited_5.nextRecord()) {
						...
						try {
							...
							row24.property_Color_Code = fid_tFileInputDelimited_5
									.get(columnIndexWithD_tFileInputDelimited_5);

							columnIndexWithD_tFileInputDelimited_5 = 1;

							row24.property_Style_Code = fid_tFileInputDelimited_5
									.get(columnIndexWithD_tFileInputDelimited_5);

							columnIndexWithD_tFileInputDelimited_5 = 2;

							row24.webimage = fid_tFileInputDelimited_5.get(columnIndexWithD_tFileInputDelimited_5);

							columnIndexWithD_tFileInputDelimited_5 = 3;

							row24.property_Photo_View = fid_tFileInputDelimited_5
									.get(columnIndexWithD_tFileInputDelimited_5);

							columnIndexWithD_tFileInputDelimited_5 = 4;

							row24.name = fid_tFileInputDelimited_5.get(columnIndexWithD_tFileInputDelimited_5);

							columnIndexWithD_tFileInputDelimited_5 = 5;

							row24.thul = fid_tFileInputDelimited_5.get(columnIndexWithD_tFileInputDelimited_5);
	...
	public void tRESTClient_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				toSetVariableStruct row5 = toSetVariable;
				...
				try {
					...
					if (use_auth_tRESTClient_2 && "SAML".equals("BASIC")) {
						...
						final String decryptedPassword_tRESTClient_2 = routines.system.PasswordEncryptUtil
								.decryptPassword("ENC:[kTysNV+OssHvGimL/wm30t8l+6O5NQvuw9071ty84t/dCkppkkE=]");
					...
					if (use_auth_tRESTClient_2 && "BASIC".equals("BASIC")) {
						...
						final String decryptedPassword_tRESTClient_2 = routines.system.PasswordEncryptUtil
								.decryptPassword("ENC:[UI2hYXN47kXmkyoePAOf/TemJxb0JoJh6ZCvj81mi2t9eQtzmvg=]");
						...
						final String decryptedPassword_tRESTClient_2 = routines.system.PasswordEncryptUtil
								.decryptPassword("ENC:[D0ZOjtKTRac2wxHoVTIeRdtUNIK61L7ZZxQBdf4DoaLinHdHMvw=]");
					...
					if (!inOSGi) {
						...
						if (use_proxy_tRESTClient_2) {
							...
							final String decryptedPassword_tRESTClient_2 = routines.system.PasswordEncryptUtil
									.decryptPassword("ENC:[EE1dPL0TPyv+nOe/4PiLUB0CEitrEtKWgAH8Zg==]");
					...
					if (use_auth_tRESTClient_2 && "OIDC_PASSWORD_GRANT".equals("BASIC")) {
						...
						final String decryptedPassword_tRESTClient_2 = routines.system.PasswordEncryptUtil
								.decryptPassword("ENC:[dSXe7hBzoRC33gQ+WYXD2d6taBUB3VSyNH/+wTg8vwmvwUNgCM4=]");
...
// Start of branch "toSetVariable"
								if (toSetVariable != null) {
									...
									globalMap.put("ExcDate", TalendDate.formatDate("yyyyMMdd-HH'H'mm'm'ss",
...
// ###############################      
			...
			if (resumeEntryMethodName == null || globalResumeTicket) {
				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tRESTClient_2:OnSubjobOk", "",
						Thread.currentThread().getId() + "", "", "", "", "", "");
			}
	...
	public static class row38Struct implements routines.system.IPersistableComparableLookupRow<row38Struct> {
		...
		public void copyDataTo(row38Struct other) {
			...
			other.Brand_Haddad__c = this.Brand_Haddad__c;
			other.Product_Code_External_Id__c = this.Product_Code_External_Id__c;
		...
		public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
			try {
				...
				this.Brand_Haddad__c = readString(dis, ois);

				this.Product_Code_External_Id__c = readString(dis, ois);
				...
				this.Color_Haddad__r_Color_Name_External__c = readString(dis, ois);
		...
		public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
			try {
				...
				writeString(this.Brand_Haddad__c, dos, oos);

				writeString(this.Product_Code_External_Id__c, dos, oos);
				...
				writeString(this.Color_Haddad__r_Color_Name_External__c, dos, oos);
		...
		public int compareTo(row38Struct other) {
			...
			returnValue = checkNullsAndCompare(this.Color_Code_Haddad__c, other.Color_Code_Haddad__c);
			if (returnValue != 0) {
				return returnValue;
			}
	...
	public void tSalesforceInput_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// source node:tUniqRow_1 - inputs:(row34) outputs:(row38,row38) | target
				// node:tAdvancedHash_row38 - inputs:(row38) outputs:()
				// linked node: tMap_9 - inputs:(row32,row38) outputs:(outURL,updateMDBynder)
				...
				props_tSalesforceInput_3.connection.userPassword.setValue("useAuth", false);

				props_tSalesforceInput_3.connection.proxy.userPassword.setValue("useAuth", false);
				...
				props_tSalesforceInput_3.module.setValue("moduleName", "Product2");

				props_tSalesforceInput_3.module.connection.userPassword.setValue("useAuth", false);

				props_tSalesforceInput_3.module.connection.proxy.userPassword.setValue("useAuth", false);
				...
				class SchemaSettingTool_tSalesforceInput_3_1_fisrt {
					...
					String getSchemaValue() {
						...
						a("\"name\":\"IsActive\",\"type\":\"boolean\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"IsActive\",\"talend.field.dbColumnName\":\"IsActive\",\"di.column.talendType\":\"id_Boolean\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"IsActive\",\"di.column.relatedEntity\":\"\"},{",
								s);

						a("\"name\":\"ProductCode\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"ProductCode\",\"talend.field.dbColumnName\":\"ProductCode\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"255\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"ProductCode\",\"di.column.relatedEntity\":\"\"},{",
								s);

						a("\"name\":\"Brand_Haddad__c\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"Brand_Haddad__c\",\"talend.field.dbColumnName\":\"Brand_Haddad__c\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"18\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"Brand_Haddad__c\",\"di.column.relatedEntity\":\"\"},{",
								s);

						a("\"name\":\"Product_Code_External_Id__c\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"Product_Code_External_Id__c\",\"talend.field.dbColumnName\":\"Product_Code_External_Id__c\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"255\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"Product_Code_External_Id__c\",\"di.column.relatedEntity\":\"\"},{",
								s);

						a("\"name\":\"Age_Group_Haddad__c\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"Age_Group_Haddad__c\",\"talend.field.dbColumnName\":\"Age_Group_Haddad__c\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"255\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"Age_Group_Haddad__c\",\"di.column.relatedEntity\":\"\"},{",
								s);

						a("\"name\":\"Brand_Haddad__r_Name\",\"type\":\"string\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"Brand_Haddad__r_Name\",\"talend.field.dbColumnName\":\"Brand_Haddad__r_Name\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"255\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"Brand_Haddad__r_Name\",\"di.column.relatedEntity\":\"\"},{",
								s);

						a("\"name\":\"Category_Haddad__r_Name\",\"type\":\"string\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"Category_Haddad__r_Name\",\"talend.field.dbColumnName\":\"Category_Haddad__r_Name\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"255\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"Category_Haddad__r_Name\",\"di.column.relatedEntity\":\"\"},{",
								s);

						a("\"name\":\"Color_Code_Haddad__c\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"Color_Code_Haddad__c\",\"talend.field.dbColumnName\":\"Color_Code_Haddad__c\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"1300\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"Color_Code_Haddad__c\",\"di.column.relatedEntity\":\"\"},{",
								s);

						a("\"name\":\"Color_Haddad__r_Name\",\"type\":\"string\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"Color_Haddad__r_Name\",\"talend.field.dbColumnName\":\"Color_Haddad__r_Name\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"255\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"Color_Haddad__r_Name\",\"di.column.relatedEntity\":\"\"},{",
								s);

						a("\"name\":\"Color_Haddad__r_Color_Name_External__c\",\"type\":\"string\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"Color_Haddad__r_Color_Name_External__c\",\"talend.field.dbColumnName\":\"Color_Haddad__r_Color_Name_External__c\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"Color_Haddad__r_Color_Name_External__c\",\"di.column.relatedEntity\":\"\"},{",
								s);

						a("\"name\":\"Country_of_origin_Haddad__c\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"Country_of_origin_Haddad__c\",\"talend.field.dbColumnName\":\"Country_of_origin_Haddad__c\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"255\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"Country_of_origin_Haddad__c\",\"di.column.relatedEntity\":\"\"},{",
								s);

						a("\"name\":\"Description\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"Description\",\"talend.field.dbColumnName\":\"Description\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"4000\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"Description\",\"di.column.relatedEntity\":\"\"},{",
								s);

						a("\"name\":\"Gender_Haddad__c\",\"type\":\"string\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"Gender_Haddad__c\",\"talend.field.dbColumnName\":\"Gender_Haddad__c\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"255\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"Gender_Haddad__c\",\"di.column.relatedEntity\":\"\"},{",
								s);
						...
						a("\"name\":\"Product_Status__c\",\"type\":\"string\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"Product_Status__c\",\"talend.field.dbColumnName\":\"Product_Status__c\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"255\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"Product_Status__c\",\"di.column.relatedEntity\":\"\"},{",
								s);

						a("\"name\":\"Ref__c\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"Ref__c\",\"talend.field.dbColumnName\":\"Ref__c\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"1300\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"Ref__c\",\"di.column.relatedEntity\":\"\"},{",
								s);

						a("\"name\":\"Season_Product_Haddad__r_Name\",\"type\":\"string\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"Season_Product_Haddad__r_Name\",\"talend.field.dbColumnName\":\"Season_Product_Haddad__r_Name\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"255\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"Season_Product_Haddad__r_Name\",\"di.column.relatedEntity\":\"\"},{",
								s);

						a("\"name\":\"Style_Haddad__r_Name\",\"type\":\"string\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"Style_Haddad__r_Name\",\"talend.field.dbColumnName\":\"Style_Haddad__r_Name\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"255\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"Style_Haddad__r_Name\",\"di.column.relatedEntity\":\"\"}],\"di.table.name\":\"MAIN\",\"di.table.label\":\"MAIN\"}",
								s);
				...
				org.talend.daikon.runtime.RuntimeInfo runtime_info_tSalesforceInput_3 = def_tSalesforceInput_3
						.getRuntimeInfo(org.talend.components.api.component.runtime.ExecutionEngine.DI,
								props_tSalesforceInput_3, topology_tSalesforceInput_3);
				...
				org.talend.components.api.component.runtime.RuntimableRuntime componentRuntime_tSalesforceInput_3 = (org.talend.components.api.component.runtime.RuntimableRuntime) (Class
						.forName(runtime_info_tSalesforceInput_3.getRuntimeClassName()).newInstance());
				org.talend.daikon.properties.ValidationResult initVr_tSalesforceInput_3 = componentRuntime_tSalesforceInput_3
						.initialize(container_tSalesforceInput_3, props_tSalesforceInput_3);

				if (initVr_tSalesforceInput_3
						.getStatus() == org.talend.daikon.properties.ValidationResult.Result.ERROR) {
				...
				org.talend.codegen.enforcer.OutgoingSchemaEnforcer outgoingEnforcer_tSalesforceInput_3 = org.talend.codegen.enforcer.EnforcerCreator
						.createOutgoingEnforcer(schema_tSalesforceInput_3, false);
				...
				for (; available_tSalesforceInput_3; available_tSalesforceInput_3 = reader_tSalesforceInput_3
					...
					try {
						...
						outgoingEnforcer_tSalesforceInput_3
								.setWrapped(factory_tSalesforceInput_3.convertToAvro(data_tSalesforceInput_3));
						Object columnValue_0_tSalesforceInput_3 = outgoingEnforcer_tSalesforceInput_3.get(0);
						row34.Id = (String) (columnValue_0_tSalesforceInput_3);
						...
						if (columnValue_1_tSalesforceInput_3 == null) {
							row34.IsActive = false;
						} else {
							row34.IsActive = (boolean) (columnValue_1_tSalesforceInput_3);
						}
						Object columnValue_2_tSalesforceInput_3 = outgoingEnforcer_tSalesforceInput_3.get(2);
						row34.ProductCode = (String) (columnValue_2_tSalesforceInput_3);
						Object columnValue_3_tSalesforceInput_3 = outgoingEnforcer_tSalesforceInput_3.get(3);
						row34.Brand_Haddad__c = (String) (columnValue_3_tSalesforceInput_3);
						Object columnValue_4_tSalesforceInput_3 = outgoingEnforcer_tSalesforceInput_3.get(4);
						row34.Product_Code_External_Id__c = (String) (columnValue_4_tSalesforceInput_3);
						Object columnValue_5_tSalesforceInput_3 = outgoingEnforcer_tSalesforceInput_3.get(5);
						row34.Age_Group_Haddad__c = (String) (columnValue_5_tSalesforceInput_3);
						Object columnValue_6_tSalesforceInput_3 = outgoingEnforcer_tSalesforceInput_3.get(6);
						row34.Brand_Haddad__r_Name = (String) (columnValue_6_tSalesforceInput_3);
						Object columnValue_7_tSalesforceInput_3 = outgoingEnforcer_tSalesforceInput_3.get(7);
						row34.Category_Haddad__r_Name = (String) (columnValue_7_tSalesforceInput_3);
						Object columnValue_8_tSalesforceInput_3 = outgoingEnforcer_tSalesforceInput_3.get(8);
						row34.Color_Code_Haddad__c = (String) (columnValue_8_tSalesforceInput_3);
						Object columnValue_9_tSalesforceInput_3 = outgoingEnforcer_tSalesforceInput_3.get(9);
						row34.Color_Haddad__r_Name = (String) (columnValue_9_tSalesforceInput_3);
						Object columnValue_10_tSalesforceInput_3 = outgoingEnforcer_tSalesforceInput_3.get(10);
						row34.Color_Haddad__r_Color_Name_External__c = (String) (columnValue_10_tSalesforceInput_3);
						Object columnValue_11_tSalesforceInput_3 = outgoingEnforcer_tSalesforceInput_3.get(11);
						row34.Country_of_origin_Haddad__c = (String) (columnValue_11_tSalesforceInput_3);
						Object columnValue_12_tSalesforceInput_3 = outgoingEnforcer_tSalesforceInput_3.get(12);
						row34.Description = (String) (columnValue_12_tSalesforceInput_3);
						Object columnValue_13_tSalesforceInput_3 = outgoingEnforcer_tSalesforceInput_3.get(13);
						row34.Gender_Haddad__c = (String) (columnValue_13_tSalesforceInput_3);
						Object columnValue_14_tSalesforceInput_3 = outgoingEnforcer_tSalesforceInput_3.get(14);
						row34.Name = (String) (columnValue_14_tSalesforceInput_3);
						Object columnValue_15_tSalesforceInput_3 = outgoingEnforcer_tSalesforceInput_3.get(15);
						row34.Product_Status__c = (String) (columnValue_15_tSalesforceInput_3);
						Object columnValue_16_tSalesforceInput_3 = outgoingEnforcer_tSalesforceInput_3.get(16);
						row34.Ref__c = (String) (columnValue_16_tSalesforceInput_3);
						Object columnValue_17_tSalesforceInput_3 = outgoingEnforcer_tSalesforceInput_3.get(17);
						row34.Season_Product_Haddad__r_Name = (String) (columnValue_17_tSalesforceInput_3);
						Object columnValue_18_tSalesforceInput_3 = outgoingEnforcer_tSalesforceInput_3.get(18);
						row34.Style_Haddad__r_Name = (String) (columnValue_18_tSalesforceInput_3);
						...
						errorMessage_tSalesforceInput_3 = "Row " + nb_line_tSalesforceInput_3 + ": "
					...
					row38 = null;
					row38 = null;
					if (row34.Color_Code_Haddad__c == null) {
						finder_tUniqRow_1.Color_Code_Haddad__c = null;
					} else {
						finder_tUniqRow_1.Color_Code_Haddad__c = row34.Color_Code_Haddad__c.toLowerCase();
					}
					if (row34.Name == null) {
						finder_tUniqRow_1.Name = null;
					} else {
						finder_tUniqRow_1.Name = row34.Name.toLowerCase();
					}
					...
					if (!keystUniqRow_1.contains(finder_tUniqRow_1)) {
						...
						if (row34.Color_Code_Haddad__c == null) {
							...
							new_tUniqRow_1.Color_Code_Haddad__c = row34.Color_Code_Haddad__c.toLowerCase();
						}
						if (row34.Name == null) {
							new_tUniqRow_1.Name = null;
						} else {
							new_tUniqRow_1.Name = row34.Name.toLowerCase();
						}
						...
						row38.Id = row34.Id;
						row38.IsActive = row34.IsActive;
						row38.ProductCode = row34.ProductCode;
						row38.Brand_Haddad__c = row34.Brand_Haddad__c;
						row38.Product_Code_External_Id__c = row34.Product_Code_External_Id__c;
						row38.Age_Group_Haddad__c = row34.Age_Group_Haddad__c;
						row38.Brand_Haddad__r_Name = row34.Brand_Haddad__r_Name;
						row38.Category_Haddad__r_Name = row34.Category_Haddad__r_Name;
						row38.Color_Code_Haddad__c = row34.Color_Code_Haddad__c;
						row38.Color_Haddad__r_Name = row34.Color_Haddad__r_Name;
						row38.Color_Haddad__r_Color_Name_External__c = row34.Color_Haddad__r_Color_Name_External__c;
						row38.Country_of_origin_Haddad__c = row34.Country_of_origin_Haddad__c;
						row38.Description = row34.Description;
						row38.Gender_Haddad__c = row34.Gender_Haddad__c;
						row38.Name = row34.Name;
						row38.Product_Status__c = row34.Product_Status__c;
						row38.Ref__c = row34.Ref__c;
						row38.Season_Product_Haddad__r_Name = row34.Season_Product_Haddad__r_Name;
						row38.Style_Haddad__r_Name = row34.Style_Haddad__r_Name;
						if (row38 == null) {
...
// Start of branch "row38"
					if (row38 != null) {
						...
						row38_HashRow.IsActive = row38.IsActive;

						row38_HashRow.ProductCode = row38.ProductCode;

						row38_HashRow.Brand_Haddad__c = row38.Brand_Haddad__c;

						row38_HashRow.Product_Code_External_Id__c = row38.Product_Code_External_Id__c;

						row38_HashRow.Age_Group_Haddad__c = row38.Age_Group_Haddad__c;

						row38_HashRow.Brand_Haddad__r_Name = row38.Brand_Haddad__r_Name;

						row38_HashRow.Category_Haddad__r_Name = row38.Category_Haddad__r_Name;

						row38_HashRow.Color_Code_Haddad__c = row38.Color_Code_Haddad__c;

						row38_HashRow.Color_Haddad__r_Name = row38.Color_Haddad__r_Name;

						row38_HashRow.Color_Haddad__r_Color_Name_External__c = row38.Color_Haddad__r_Color_Name_External__c;

						row38_HashRow.Country_of_origin_Haddad__c = row38.Country_of_origin_Haddad__c;

						row38_HashRow.Description = row38.Description;

						row38_HashRow.Gender_Haddad__c = row38.Gender_Haddad__c;

						row38_HashRow.Name = row38.Name;

						row38_HashRow.Product_Status__c = row38.Product_Status__c;

						row38_HashRow.Ref__c = row38.Ref__c;

						row38_HashRow.Season_Product_Haddad__r_Name = row38.Season_Product_Haddad__r_Name;

						row38_HashRow.Style_Haddad__r_Name = row38.Style_Haddad__r_Name;
...
// end of generic
				...
				if (resultMap_tSalesforceInput_3 != null) {
					for (java.util.Map.Entry<String, Object> entry_tSalesforceInput_3 : resultMap_tSalesforceInput_3
						...
						case org.talend.components.api.component.ComponentDefinition.RETURN_ERROR_MESSAGE:
							container_tSalesforceInput_3.setComponentData("tSalesforceInput_3", "ERROR_MESSAGE",
									entry_tSalesforceInput_3.getValue());
							break;
						case org.talend.components.api.component.ComponentDefinition.RETURN_TOTAL_RECORD_COUNT:
							container_tSalesforceInput_3.setComponentData("tSalesforceInput_3", "NB_LINE",
									entry_tSalesforceInput_3.getValue());
							break;
						case org.talend.components.api.component.ComponentDefinition.RETURN_SUCCESS_RECORD_COUNT:
							container_tSalesforceInput_3.setComponentData("tSalesforceInput_3", "NB_SUCCESS",
									entry_tSalesforceInput_3.getValue());
							break;
						case org.talend.components.api.component.ComponentDefinition.RETURN_REJECT_RECORD_COUNT:
							container_tSalesforceInput_3.setComponentData("tSalesforceInput_3", "NB_REJECT",
									entry_tSalesforceInput_3.getValue());
							break;
						default:
							StringBuilder studio_key_tSalesforceInput_3 = new StringBuilder();
							for (int i_tSalesforceInput_3 = 0; i_tSalesforceInput_3 < entry_tSalesforceInput_3.getKey()
									.length(); i_tSalesforceInput_3++) {
								char ch_tSalesforceInput_3 = entry_tSalesforceInput_3.getKey()
										.charAt(i_tSalesforceInput_3);
							...
							container_tSalesforceInput_3.setComponentData("tSalesforceInput_3",
									studio_key_tSalesforceInput_3.toString().toUpperCase(java.util.Locale.ENGLISH),
									entry_tSalesforceInput_3.getValue());
							break;
						}
					}
...
// finally of generic
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				fileName_talendLogs_FILE = (new java.io.File(
						"C:/Haddad_Interface_SF_JDE/Interface Bynder/hors eCom/log" + "/" + "UploadAssetToBynder.log"))
								.getAbsolutePath().replace("\\", "/");
	...
	public static void main(String[] args) {
		final recoverAssetsFromBynderToSF recoverAssetsFromBynderToSFClass = new recoverAssetsFromBynderToSF();

		int exitCode = recoverAssetsFromBynderToSFClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = recoverAssetsFromBynderToSF.class.getClassLoader()
					.getResourceAsStream("dev/recoverassetsfrombyndertosf_0_4/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = recoverAssetsFromBynderToSF.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : recoverAssetsFromBynderToSF");
		}
...
/************************************************************************************************
 * 999099 characters generated by Talend Open Studio for Data Integration on the
 * 15 décembre 2023 14:41:11 GMT
 ************************************************************************************************/