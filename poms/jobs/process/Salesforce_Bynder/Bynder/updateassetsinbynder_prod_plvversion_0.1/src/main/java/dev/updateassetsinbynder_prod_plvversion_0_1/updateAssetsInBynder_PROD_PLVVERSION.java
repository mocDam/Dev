...
package dev.updateassetsinbynder_prod_plvversion_0_1;
...
/**
 * Job: updateAssetsInBynder_PROD_PLVVERSION Purpose: createAssetsInBynder_PROD<br>
 * Description: createAssetsInBynder_PROD <br>
 * @author user@talend.com
 * @version 7.3.1.20191031_1204-M3
 * @status 
 */
public class updateAssetsInBynder_PROD_PLVVERSION implements TalendJob {
...
public String getErrorFile(){
	...
	private final String jobName = "updateAssetsInBynder_PROD_PLVVERSION";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				updateAssetsInBynder_PROD_PLVVERSION.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(updateAssetsInBynder_PROD_PLVVERSION.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row15Struct implements routines.system.IPersistableRow<row15Struct> {
    final static byte[] commonByteArrayLock_DEV_updateAssetsInBynder_PROD_PLVVERSION = new byte[0];
    static byte[] commonByteArray_DEV_updateAssetsInBynder_PROD_PLVVERSION = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_DEV_updateAssetsInBynder_PROD_PLVVERSION.length) {
				if(length < 1024 && commonByteArray_DEV_updateAssetsInBynder_PROD_PLVVERSION.length == 0) {
   					commonByteArray_DEV_updateAssetsInBynder_PROD_PLVVERSION = new byte[1024];
				} else {
   					commonByteArray_DEV_updateAssetsInBynder_PROD_PLVVERSION = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_DEV_updateAssetsInBynder_PROD_PLVVERSION, 0, length);
			strReturn = new String(commonByteArray_DEV_updateAssetsInBynder_PROD_PLVVERSION, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_DEV_updateAssetsInBynder_PROD_PLVVERSION) {
...
try {
	...
	final String decryptedPassword_tRESTClient_3 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[xKTgYnlk+Loe9IxKNh1/aj0HPsGWJfElIyDUJpUHe4YjvbXTKVA=]");
	...
	final String decryptedPassword_tRESTClient_3 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[Jp+ZjIlioqmag+9ivGpaWIG60jUzzBdu3iokqE8OJ4LcLVyzPaY=]");
	...
	final String decryptedPassword_tRESTClient_3 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[ivmMCUCwjEJkyuwG3EsMec1LtEj0zNFVPxx6K7xaVu8RVZDu2FI=]");
	...
	final String decryptedPassword_tRESTClient_3 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[5leWydG6WYQpVX5xHXnz8aFHtINa9RlraKvWdg==]");
	...
	final String decryptedPassword_tRESTClient_3 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[xBRYRr1MO7AMc0a4u0iWcBO6bL4wnJtEivwVvsoJ1DCzH9BKJBE=]");
...
public static class row7Struct implements routines.system.IPersistableRow<row7Struct> {
    ...
    static byte[] commonByteArray_DEV_updateAssetsInBynder_PROD_PLVVERSION = new byte[0];
			    ...
			    public String StyleCodeForRequest;

				public String getStyleCodeForRequest () {
					return this.StyleCodeForRequest;
				}
		...
		synchronized(commonByteArrayLock_DEV_updateAssetsInBynder_PROD_PLVVERSION) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.StyleCodeForRequest = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.StyleCodeForRequest,dos);
    ...
    public String toString() {
		...
		sb.append(",NewTags="+NewTags);
		sb.append(",PhotoView="+PhotoView);
		sb.append(",StyleCodeForRequest="+StyleCodeForRequest);
	    sb.append("]");
...
+"here  Style_Haddad__c!='' and Name in (" + (String)globalMap.get("StyleColors") + ") ");
 		                    ...
 		                    "");
 		                        ...
 		                        routines.system.PasswordEncryptUtil.decryptPassword("ENC:[rpqjJEAtqgrRkG2PrPsPiUpSbhDwuMy2w1yu5U72ckc0lcQMDud22IAFO664MBfQyqRlOp8=]"));
 		                    ...
 		                    "systemuser@haddadeurope.com");
 		                        ...
 		                        routines.system.PasswordEncryptUtil.decryptPassword("ENC:[xe27f/4nmhGXb0S0s4Y4rhpcbSlzgoZ1J0hWfOzk0vNqKwoDDiN8PDtZnQXr]"));
 		                    ...
 		                    "");
 		                        ...
 		                        routines.system.PasswordEncryptUtil.decryptPassword("ENC:[NJOvuwgqtrpnWSyOy5N5p8yKU8kAlD2lwZVnNzaiJeWtoZebZXC9nVb/oo9KaMiCEpIY4xw=]"));
 		                    ...
 		                    "systemuser@haddadeurope.com");
 		                        ...
 		                        routines.system.PasswordEncryptUtil.decryptPassword("ENC:[jEbihNn28tU9I+T4l18kw9Gaoi2duCwKPdA6ewqQa9Lmopflu5IaJJDEtrx2]"));
 					    ...
 					    boolean forceLooprow13 = false;
 							...
 							row13Struct row13ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_3 = false;
                        		    		...
                        		    		row13HashKey.StyleCode = StringHandling.DOWNCASE(row12.Style_Haddad__r_Name ) ;
                        		    		
                        		    		row13HashKey.ColorCode = StringHandling.DOWNCASE(row12.Color_Code_Haddad__c ) ;
...
Var.var1 = ( row12.Season_Product_Haddad__r_Name == null ? "No season" : (row12.Season_Product_Haddad__r_Name.equals("All SEASONS") ? "All Seasons" : "20" + StringHandling.RIGHT(row12.Season_Product_Haddad__r_Name, 2)) ) ;
...
out5_tmp.Style_Haddad__r_Name = row13.StyleCodeFromBynder ;
out5_tmp.NewTags = row13.NewTags ;
out5_tmp.PhotoView = row13.PhotoView ;
out5_tmp.StyleCodeForRequest = row13.StyleCodeFromBynder.replace(" ", "_") ;
out5 = out5_tmp;
...
outputSF_tmp.Style_Haddad__r_Name = StringHandling.DOWNCASE(row13.StyleCodeFromBynder ) ;
...
try {
	...
	final String decryptedPassword_tRESTClient_4 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[2LPawQFD78xBSvVp92fUAio9ihLrcLWVqdYsStU7Oc0b7cpR+YU=]");
	...
	final String decryptedPassword_tRESTClient_4 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[BnOI9NmYTULcromE0s0VvARjom7i/L5qsOirMXGtD0/Odi4GW9A=]");
	...
	final String decryptedPassword_tRESTClient_4 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[DJTvmXHiYehTM7mvSTkf8k1Ajsy4q242qSuLzs9apB++WRvOrdo=]");
	...
	final String decryptedPassword_tRESTClient_4 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[fN05kBIAWbZF70R0AlI2Vo8SFqvWWqHqv5heXw==]");
	...
	final String decryptedPassword_tRESTClient_4 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[mBNnf+mtD9QEoM2jQIzl8UtI3g4ud4k5q85QKGlAhrI6B92dsxw=]");
	...
	// if FORM request then capture query parameters into Form, otherwise set them as queries
			...
			webClient_tRESTClient_4.query("property_Style_Code" ,row7.StyleCodeForRequest);
 					    ...
 					    boolean forceLooprow9 = false;
 							...
 							row9Struct row9ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_4 = false;
                        		    		...
                        		    		row9HashKey.Style_Haddad__r_Name = StringHandling.DOWNCASE(StringHandling.TRIM(row8.property_Style_Code).replace("_"," ") ) ;
...
copyOfout10_tmp.newProperty_Asset_Type = (StringHandling.INDEX(row27.name,"_C_")>0 ? "CADs" :  ( (StringHandling.INDEX(row27.name,"_F_")>0 || StringHandling.INDEX(row27.name,"_Q_")>0) ? "Image" : 
 (StringHandling.INDEX(row27.name,"_M_")>0 ? "Lifestyle_image":""))    ) ;
...
try {
	...
	final String decryptedPassword_tRESTClient_2 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[oOSp2ksPk1Zy/VEHNZh+rIWSCl10FTQ9F3vvVmJqFT1TJ2EanIU=]");
	...
	final String decryptedPassword_tRESTClient_2 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[Y84+Hmwqk1bZlVPmMQ65ZFEQN7D1faHgvidlID2XSO8EVAxV1Yg=]");
	...
	final String decryptedPassword_tRESTClient_2 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[lOU5aqox3Q8hq2SedVBmMUNguB6ZY4sXlAWBQb6ydKHA0otlxuI=]");
	...
	final String decryptedPassword_tRESTClient_2 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[BGshRf6TDoDDcliin3ghm7FDgmNb0mhWbkCeqQ==]");
	...
	final String decryptedPassword_tRESTClient_2 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[hSNu1ewu+aDjbhbbqGFuryQFFGDklCygpnBzApaHUK+2yuewH8o=]");
...
public static class row13Struct implements routines.system.IPersistableComparableLookupRow<row13Struct> {
    ...
    public String loopKey;
			    ...
			    public String StyleCodeFromBynder;

				public String getStyleCodeFromBynder () {
					return this.StyleCodeFromBynder;
				}
	...
	public void copyDataTo(row13Struct other) {
		...
		other.FileName = this.FileName;
	            ...
	            other.NewTags = this.NewTags;
	            other.PhotoView = this.PhotoView;
	            other.StyleCodeFromBynder = this.StyleCodeFromBynder;
    ...
    public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
        try {
			...
			int length = 0;
						...
						this.StyleCodeFromBynder = readString(dis,ois);
    ...
    public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
        try {
						...
						writeString(this.StyleCodeFromBynder, dos, oos);
    ...
    public String toString() {
		...
		sb.append(",NewTags="+NewTags);
		sb.append(",PhotoView="+PhotoView);
		sb.append(",StyleCodeFromBynder="+StyleCodeFromBynder);
	    sb.append("]");
...
public static class tolowerStruct implements routines.system.IPersistableRow<tolowerStruct> {
    final static byte[] commonByteArrayLock_DEV_updateAssetsInBynder_PROD_PLVVERSION = new byte[0];
    static byte[] commonByteArray_DEV_updateAssetsInBynder_PROD_PLVVERSION = new byte[0];
		...
		synchronized(commonByteArrayLock_DEV_updateAssetsInBynder_PROD_PLVVERSION) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.StyleCodeFromBynder = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.StyleCodeFromBynder,dos);
     ...
     * Compare keys
     */
    public int compareTo(tolowerStruct other) {
...
tolowerStruct tolower = new tolowerStruct();
row13Struct row13 = new row13Struct();
	...
	currentComponent="tAdvancedHash_row13";
		...
		int tos_count_tAdvancedHash_row13 = 0;
			   		...
			   		// source node:tUniqRow_5 - inputs:(tolower) outputs:(row13,row13) | target node:tAdvancedHash_row13 - inputs:(row13) outputs:()
...
// ###############################
// # Outputs initialization
tolowerStruct tolower_tmp = new tolowerStruct();
// ###############################
...
// # Output table : 'tolower'
tolower_tmp.FileName = row6.FileName ;
tolower_tmp.AssetName = row6.AssetName ;
tolower_tmp.StyleCode = StringHandling.DOWNCASE(row6.StyleCode ) ;
tolower_tmp.ColorCode = StringHandling.DOWNCASE(row6.ColorCode ) ;
tolower_tmp.NewTags = row6.NewTags ;
tolower_tmp.PhotoView = row6.PhotoView ;
tolower_tmp.StyleCodeFromBynder = row6.StyleCode ;
tolower = tolower_tmp;
// ###############################
...
if(tolower.StyleCode == null){
	finder_tUniqRow_5.StyleCode = null;
}else{
	finder_tUniqRow_5.StyleCode = tolower.StyleCode.toLowerCase();
}
if(tolower.ColorCode == null){
	finder_tUniqRow_5.ColorCode = null;
}else{
	finder_tUniqRow_5.ColorCode = tolower.ColorCode.toLowerCase();
}	
...
if(tolower.StyleCode == null){
	...
	new_tUniqRow_5.StyleCode = tolower.StyleCode.toLowerCase();
}
if(tolower.ColorCode == null){
	new_tUniqRow_5.ColorCode = null;
}else{
	new_tUniqRow_5.ColorCode = tolower.ColorCode.toLowerCase();
}
		
		keystUniqRow_5.add(new_tUniqRow_5);if(row13 == null){ 
	
	row13 = new row13Struct();
}row13.FileName = tolower.FileName;			row13.AssetName = tolower.AssetName;			row13.StyleCode = tolower.StyleCode;			row13.ColorCode = tolower.ColorCode;			row13.NewTags = tolower.NewTags;			row13.PhotoView = tolower.PhotoView;			row13.StyleCodeFromBynder = tolower.StyleCodeFromBynder;			if(row13 == null){ 
	
	row13 = new row13Struct();
}row13.FileName = tolower.FileName;			row13.AssetName = tolower.AssetName;			row13.StyleCode = tolower.StyleCode;			row13.ColorCode = tolower.ColorCode;			row13.NewTags = tolower.NewTags;			row13.PhotoView = tolower.PhotoView;			row13.StyleCodeFromBynder = tolower.StyleCodeFromBynder;					
...
if(row13 != null) { 
	...
	currentComponent="tAdvancedHash_row13";
				...
				row13_HashRow.StyleCodeFromBynder = row13.StyleCodeFromBynder;
 ...
 */
    ...
    public String contextStr = "BynderPhotoContext";
    ...
    public static void main(String[] args){
        final updateAssetsInBynder_PROD_PLVVERSION updateAssetsInBynder_PROD_PLVVERSIONClass = new updateAssetsInBynder_PROD_PLVVERSION();

        int exitCode = updateAssetsInBynder_PROD_PLVVERSIONClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = updateAssetsInBynder_PROD_PLVVERSION.class.getClassLoader().getResourceAsStream("dev/updateassetsinbynder_prod_plvversion_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = updateAssetsInBynder_PROD_PLVVERSION.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : updateAssetsInBynder_PROD_PLVVERSION");
        }
...
/************************************************************************************************
 *     806804 characters generated by Talend Open Studio for Data Integration 
 *     on the 27 décembre 2023 12:20:06 GMT
 ************************************************************************************************/