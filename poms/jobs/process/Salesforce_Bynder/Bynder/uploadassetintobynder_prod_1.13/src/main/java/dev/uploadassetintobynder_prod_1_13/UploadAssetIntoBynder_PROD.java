...
package dev.uploadassetintobynder_prod_1_13;
...
public String getJarPath(){
	...
	private final String jobVersion = "1.13";
...
final Process ps_tSystem_1 = runtime_tSystem_1.exec( "java -jar \"C:/Haddad_Interface_SF_JDE/Interface Bynder/bin/UploadAssetToBynder.jar\"" ,env_tSystem_1,new java.io.File("C:/Program Files/Java/jre1.8.0_291/bin"));
	...
	final routines.system.RowState rowstate_tFileInputDelimited_3 = new routines.system.RowState();
			...
			if(footer_value_tFileInputDelimited_3 >0 || random_value_tFileInputDelimited_3 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_3 = new org.talend.fileprocess.FileInputDelimited(context.bynderDirectory + "/temp/assetTrated.txt", "ISO-8859-15",";","\n",true,0,0,
 ...
 */
	...
	currentComponent="tFileInputDelimited_3";
                ...
                if(!((Object)(context.bynderDirectory + "/temp/assetTrated.txt") instanceof java.io.InputStream)){
...
end_Hash.put("tFileInputDelimited_3", System.currentTimeMillis());
   			...
   			if (!((Integer)globalMap.get("tFileInputDelimited_2_NB_LINE")).equals(((Integer)globalMap.get("tFileInputDelimited_3_NB_LINE"))) ) {
 ...
 */
	...
	try {
				tLogCatcher_1.addMessage("tDie", "tDie_2", 5, "Error detected while uploading file : " + ((Integer)globalMap.get("tFileInputDelimited_2_NB_LINE")) + " : " +  ((Integer)globalMap.get("tFileInputDelimited_3_NB_LINE")), 4);
				tLogCatcher_1Process(globalMap);
				
				talendLogs_LOGS.addMessage("tDie", "tDie_2", 5, "Error detected while uploading file : " + ((Integer)globalMap.get("tFileInputDelimited_2_NB_LINE")) + " : " +  ((Integer)globalMap.get("tFileInputDelimited_3_NB_LINE")), 4);
				talendLogs_LOGSProcess(globalMap);
				
	globalMap.put("tDie_2_DIE_PRIORITY", 5);
	System.err.println("Error detected while uploading file : " + ((Integer)globalMap.get("tFileInputDelimited_2_NB_LINE")) + " : " +  ((Integer)globalMap.get("tFileInputDelimited_3_NB_LINE")));
	
	globalMap.put("tDie_2_DIE_MESSAGE", "Error detected while uploading file : " + ((Integer)globalMap.get("tFileInputDelimited_2_NB_LINE")) + " : " +  ((Integer)globalMap.get("tFileInputDelimited_3_NB_LINE")));
	globalMap.put("tDie_2_DIE_MESSAGES", "Error detected while uploading file : " + ((Integer)globalMap.get("tFileInputDelimited_2_NB_LINE")) + " : " +  ((Integer)globalMap.get("tFileInputDelimited_3_NB_LINE")));
 ...
 */
	...
	try {
				...
				talendLogs_LOGS.addMessage("tDie", "tDie_1", 5, "Error Upload Salesforce Information into Bynder", 4);
				talendLogs_LOGSProcess(globalMap);
...
java.io.File file_tFileExist_5 = new java.io.File("C:/Haddad_Interface_SF_JDE/Interface Bynder/hors eCom/log/UploadAssetToBynder.log");
...
globalMap.put("tFileExist_5_FILENAME","C:/Haddad_Interface_SF_JDE/Interface Bynder/hors eCom/log/UploadAssetToBynder.log");
...
class DeleteFoldertFileDelete_5{
    ...
    java.io.File file_tFileDelete_5=new java.io.File((String)globalMap.get("tFileList_5_CURRENT_FILEPATH"));
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = UploadAssetIntoBynder_PROD.class.getClassLoader().getResourceAsStream("dev/uploadassetintobynder_prod_1_13/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     455033 characters generated by Talend Open Studio for Data Integration 
