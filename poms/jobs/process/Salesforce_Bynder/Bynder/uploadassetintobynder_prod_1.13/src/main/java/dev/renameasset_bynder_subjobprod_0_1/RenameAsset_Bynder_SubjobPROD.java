...
package dev.renameasset_bynder_subjobprod_0_1;
...
/**
 * Job: RenameAsset_Bynder_SubjobPROD Purpose: RenameAsset_Bynder_SubjobPROD<br>
 * Description: RenameAsset_Bynder_SubjobPROD <br>
 * @author user@talend.com
 * @version 7.3.1.20191031_1204-M3
 * @status 
 */
public class RenameAsset_Bynder_SubjobPROD implements TalendJob {
...
public java.lang.String getSQLSERVER_LOG_Password(){
	...
	private final String jobName = "RenameAsset_Bynder_SubjobPROD";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				RenameAsset_Bynder_SubjobPROD.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(RenameAsset_Bynder_SubjobPROD.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tFileList_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
  ...
  String directory_tFileList_1 = context.bynderDirectory + "/image/01Front";
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		obj_tRunJob_1 = context.bynderDirectory + "/image/01Front/CAD/";
		if(obj_tRunJob_1!=null) {
			paraList_tRunJob_1.add("--context_param bynderSubDirectory=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_1));
		} else {
			paraList_tRunJob_1.add("--context_param bynderSubDirectory=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_1.put("bynderSubDirectory", obj_tRunJob_1);
	
		obj_tRunJob_1 = "_C_F";
		if(obj_tRunJob_1!=null) {
			paraList_tRunJob_1.add("--context_param AssetFlag=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_1));
		} else {
			paraList_tRunJob_1.add("--context_param AssetFlag=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_1.put("AssetFlag", obj_tRunJob_1);
		...
		dev.ecom_renameasset_bynder_sujob_prod_0_1.Ecom_RenameAsset_Bynder_SuJob_PROD childJob_tRunJob_1 = new dev.ecom_renameasset_bynder_sujob_prod_0_1.Ecom_RenameAsset_Bynder_SuJob_PROD();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		obj_tRunJob_2 = context.bynderDirectory + "/image/01Front/FlatShot/";
		if(obj_tRunJob_2!=null) {
			paraList_tRunJob_2.add("--context_param bynderSubDirectory=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_2));
		} else {
			paraList_tRunJob_2.add("--context_param bynderSubDirectory=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_2.put("bynderSubDirectory", obj_tRunJob_2);
	
		obj_tRunJob_2 = "_F_F";
		if(obj_tRunJob_2!=null) {
			paraList_tRunJob_2.add("--context_param AssetFlag=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_2));
		} else {
			paraList_tRunJob_2.add("--context_param AssetFlag=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_2.put("AssetFlag", obj_tRunJob_2);
	
		obj_tRunJob_2 = context.bynderDirectory;
		if(obj_tRunJob_2!=null) {
		...
		dev.ecom_renameasset_bynder_sujob_prod_0_1.Ecom_RenameAsset_Bynder_SuJob_PROD childJob_tRunJob_2 = new dev.ecom_renameasset_bynder_sujob_prod_0_1.Ecom_RenameAsset_Bynder_SuJob_PROD();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		obj_tRunJob_3 = context.bynderDirectory + "/image/01Front/Mannequin/";
		if(obj_tRunJob_3!=null) {
			paraList_tRunJob_3.add("--context_param bynderSubDirectory=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_3));
		} else {
			paraList_tRunJob_3.add("--context_param bynderSubDirectory=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_3.put("bynderSubDirectory", obj_tRunJob_3);
	
		obj_tRunJob_3 = "_Q_F";
		if(obj_tRunJob_3!=null) {
			paraList_tRunJob_3.add("--context_param AssetFlag=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_3));
		} else {
			paraList_tRunJob_3.add("--context_param AssetFlag=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_3.put("AssetFlag", obj_tRunJob_3);
	
		obj_tRunJob_3 = context.bynderDirectory;
		if(obj_tRunJob_3!=null) {
			paraList_tRunJob_3.add("--context_param bynderDirectory=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_3));
		} else {
			paraList_tRunJob_3.add("--context_param bynderDirectory=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_3.put("bynderDirectory", obj_tRunJob_3);
	
	
		dev.ecom_renameasset_bynder_sujob_prod_0_1.Ecom_RenameAsset_Bynder_SuJob_PROD childJob_tRunJob_3 = new dev.ecom_renameasset_bynder_sujob_prod_0_1.Ecom_RenameAsset_Bynder_SuJob_PROD();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_4 = null;
		...
		obj_tRunJob_4 = context.bynderDirectory + "/image/01Front/Model/";
		if(obj_tRunJob_4!=null) {
			paraList_tRunJob_4.add("--context_param bynderSubDirectory=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_4));
		} else {
			paraList_tRunJob_4.add("--context_param bynderSubDirectory=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_4.put("bynderSubDirectory", obj_tRunJob_4);
	
		obj_tRunJob_4 = "_M_F";
		if(obj_tRunJob_4!=null) {
			paraList_tRunJob_4.add("--context_param AssetFlag=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_4));
		} else {
			paraList_tRunJob_4.add("--context_param AssetFlag=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_4.put("AssetFlag", obj_tRunJob_4);
		...
		dev.ecom_renameasset_bynder_sujob_prod_0_1.Ecom_RenameAsset_Bynder_SuJob_PROD childJob_tRunJob_4 = new dev.ecom_renameasset_bynder_sujob_prod_0_1.Ecom_RenameAsset_Bynder_SuJob_PROD();
	    // pass DataSources
...
public void tFileList_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
  ...
  String directory_tFileList_2 = context.bynderDirectory + "/image/02Back";
 ...
 */
	...
	Object obj_tRunJob_5 = null;
		...
		obj_tRunJob_5 = context.bynderDirectory + "/image/02Back/CAD/";
		if(obj_tRunJob_5!=null) {
			paraList_tRunJob_5.add("--context_param bynderSubDirectory=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_5));
		} else {
			paraList_tRunJob_5.add("--context_param bynderSubDirectory=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_5.put("bynderSubDirectory", obj_tRunJob_5);
	
		obj_tRunJob_5 = "_C_B";
		if(obj_tRunJob_5!=null) {
			paraList_tRunJob_5.add("--context_param AssetFlag=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_5));
		} else {
			paraList_tRunJob_5.add("--context_param AssetFlag=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_5.put("AssetFlag", obj_tRunJob_5);
	
		obj_tRunJob_5 = context.bynderDirectory;
		if(obj_tRunJob_5!=null) {
			paraList_tRunJob_5.add("--context_param bynderDirectory=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_5));
		} else {
			paraList_tRunJob_5.add("--context_param bynderDirectory=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_5.put("bynderDirectory", obj_tRunJob_5);
	
	
		dev.ecom_renameasset_bynder_sujob_prod_0_1.Ecom_RenameAsset_Bynder_SuJob_PROD childJob_tRunJob_5 = new dev.ecom_renameasset_bynder_sujob_prod_0_1.Ecom_RenameAsset_Bynder_SuJob_PROD();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_6 = null;
		...
		obj_tRunJob_6 = context.bynderDirectory + "/image/02Back/FlatShot/";
		if(obj_tRunJob_6!=null) {
			paraList_tRunJob_6.add("--context_param bynderSubDirectory=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_6));
		} else {
			paraList_tRunJob_6.add("--context_param bynderSubDirectory=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_6.put("bynderSubDirectory", obj_tRunJob_6);
	
		obj_tRunJob_6 = "_F_B";
		if(obj_tRunJob_6!=null) {
			paraList_tRunJob_6.add("--context_param AssetFlag=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_6));
		} else {
			paraList_tRunJob_6.add("--context_param AssetFlag=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_6.put("AssetFlag", obj_tRunJob_6);
	
		obj_tRunJob_6 = context.bynderDirectory;
		if(obj_tRunJob_6!=null) {
			paraList_tRunJob_6.add("--context_param bynderDirectory=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_6));
		} else {
			paraList_tRunJob_6.add("--context_param bynderDirectory=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_6.put("bynderDirectory", obj_tRunJob_6);
	
	
		dev.ecom_renameasset_bynder_sujob_prod_0_1.Ecom_RenameAsset_Bynder_SuJob_PROD childJob_tRunJob_6 = new dev.ecom_renameasset_bynder_sujob_prod_0_1.Ecom_RenameAsset_Bynder_SuJob_PROD();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_7 = null;
		...
		obj_tRunJob_7 = context.bynderDirectory + "/image/02Back/Mannequin/";
		if(obj_tRunJob_7!=null) {
			paraList_tRunJob_7.add("--context_param bynderSubDirectory=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_7));
		} else {
			paraList_tRunJob_7.add("--context_param bynderSubDirectory=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_7.put("bynderSubDirectory", obj_tRunJob_7);
	
		obj_tRunJob_7 = "_Q_B";
		if(obj_tRunJob_7!=null) {
			paraList_tRunJob_7.add("--context_param AssetFlag=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_7));
		} else {
			paraList_tRunJob_7.add("--context_param AssetFlag=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_7.put("AssetFlag", obj_tRunJob_7);
	
		obj_tRunJob_7 = context.bynderDirectory;
		if(obj_tRunJob_7!=null) {
			paraList_tRunJob_7.add("--context_param bynderDirectory=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_7));
		} else {
			paraList_tRunJob_7.add("--context_param bynderDirectory=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_7.put("bynderDirectory", obj_tRunJob_7);
	
	
		dev.ecom_renameasset_bynder_sujob_prod_0_1.Ecom_RenameAsset_Bynder_SuJob_PROD childJob_tRunJob_7 = new dev.ecom_renameasset_bynder_sujob_prod_0_1.Ecom_RenameAsset_Bynder_SuJob_PROD();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_8 = null;
		...
		obj_tRunJob_8 = context.bynderDirectory + "/image/02Back/Model/";
		if(obj_tRunJob_8!=null) {
			paraList_tRunJob_8.add("--context_param bynderSubDirectory=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_8));
		} else {
			paraList_tRunJob_8.add("--context_param bynderSubDirectory=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_8.put("bynderSubDirectory", obj_tRunJob_8);
	
		obj_tRunJob_8 = "_M_B";
		if(obj_tRunJob_8!=null) {
			paraList_tRunJob_8.add("--context_param AssetFlag=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_8));
		} else {
			paraList_tRunJob_8.add("--context_param AssetFlag=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_8.put("AssetFlag", obj_tRunJob_8);
	
		obj_tRunJob_8 = context.bynderDirectory;
		if(obj_tRunJob_8!=null) {
			paraList_tRunJob_8.add("--context_param bynderDirectory=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_8));
		} else {
			paraList_tRunJob_8.add("--context_param bynderDirectory=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_8.put("bynderDirectory", obj_tRunJob_8);
	
	
		dev.ecom_renameasset_bynder_sujob_prod_0_1.Ecom_RenameAsset_Bynder_SuJob_PROD childJob_tRunJob_8 = new dev.ecom_renameasset_bynder_sujob_prod_0_1.Ecom_RenameAsset_Bynder_SuJob_PROD();
	    // pass DataSources
...
public void tFileList_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
  ...
  String directory_tFileList_3 = context.bynderDirectory + "/image/03Left";
 ...
 */
	...
	Object obj_tRunJob_9 = null;
		...
		obj_tRunJob_9 = context.bynderDirectory + "/image/03Left/CAD/";
		if(obj_tRunJob_9!=null) {
			paraList_tRunJob_9.add("--context_param bynderSubDirectory=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_9));
		} else {
			paraList_tRunJob_9.add("--context_param bynderSubDirectory=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_9.put("bynderSubDirectory", obj_tRunJob_9);
	
		obj_tRunJob_9 = "_C_L";
		if(obj_tRunJob_9!=null) {
			paraList_tRunJob_9.add("--context_param AssetFlag=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_9));
		} else {
			paraList_tRunJob_9.add("--context_param AssetFlag=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_9.put("AssetFlag", obj_tRunJob_9);
	
		obj_tRunJob_9 = context.bynderDirectory;
		if(obj_tRunJob_9!=null) {
			paraList_tRunJob_9.add("--context_param bynderDirectory=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_9));
		} else {
			paraList_tRunJob_9.add("--context_param bynderDirectory=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_9.put("bynderDirectory", obj_tRunJob_9);
	
	
		dev.ecom_renameasset_bynder_sujob_prod_0_1.Ecom_RenameAsset_Bynder_SuJob_PROD childJob_tRunJob_9 = new dev.ecom_renameasset_bynder_sujob_prod_0_1.Ecom_RenameAsset_Bynder_SuJob_PROD();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_10 = null;
		...
		obj_tRunJob_10 = context.bynderDirectory + "/image/03Left/FlatShot/";
		if(obj_tRunJob_10!=null) {
			paraList_tRunJob_10.add("--context_param bynderSubDirectory=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_10));
		} else {
			paraList_tRunJob_10.add("--context_param bynderSubDirectory=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_10.put("bynderSubDirectory", obj_tRunJob_10);
	
		obj_tRunJob_10 = "_F_L";
		if(obj_tRunJob_10!=null) {
			paraList_tRunJob_10.add("--context_param AssetFlag=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_10));
		} else {
			paraList_tRunJob_10.add("--context_param AssetFlag=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_10.put("AssetFlag", obj_tRunJob_10);
	
		obj_tRunJob_10 = context.bynderDirectory;
		if(obj_tRunJob_10!=null) {
			paraList_tRunJob_10.add("--context_param bynderDirectory=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_10));
		} else {
			paraList_tRunJob_10.add("--context_param bynderDirectory=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_10.put("bynderDirectory", obj_tRunJob_10);
	
	
		dev.ecom_renameasset_bynder_sujob_prod_0_1.Ecom_RenameAsset_Bynder_SuJob_PROD childJob_tRunJob_10 = new dev.ecom_renameasset_bynder_sujob_prod_0_1.Ecom_RenameAsset_Bynder_SuJob_PROD();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_11 = null;
		...
		obj_tRunJob_11 = context.bynderDirectory + "/image/03Left/Mannequin/";
		if(obj_tRunJob_11!=null) {
			paraList_tRunJob_11.add("--context_param bynderSubDirectory=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_11));
		} else {
			paraList_tRunJob_11.add("--context_param bynderSubDirectory=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_11.put("bynderSubDirectory", obj_tRunJob_11);
	
		obj_tRunJob_11 = "_Q_L";
		if(obj_tRunJob_11!=null) {
			paraList_tRunJob_11.add("--context_param AssetFlag=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_11));
		} else {
			paraList_tRunJob_11.add("--context_param AssetFlag=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_11.put("AssetFlag", obj_tRunJob_11);
	
		obj_tRunJob_11 = context.bynderDirectory;
		if(obj_tRunJob_11!=null) {
			paraList_tRunJob_11.add("--context_param bynderDirectory=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_11));
		} else {
			paraList_tRunJob_11.add("--context_param bynderDirectory=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_11.put("bynderDirectory", obj_tRunJob_11);
	
	
		dev.ecom_renameasset_bynder_sujob_prod_0_1.Ecom_RenameAsset_Bynder_SuJob_PROD childJob_tRunJob_11 = new dev.ecom_renameasset_bynder_sujob_prod_0_1.Ecom_RenameAsset_Bynder_SuJob_PROD();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_12 = null;
		...
		obj_tRunJob_12 = context.bynderDirectory + "/image/03Left/Model/";
		if(obj_tRunJob_12!=null) {
			paraList_tRunJob_12.add("--context_param bynderSubDirectory=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_12));
		} else {
			paraList_tRunJob_12.add("--context_param bynderSubDirectory=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_12.put("bynderSubDirectory", obj_tRunJob_12);
	
		obj_tRunJob_12 = "_M_L";
		if(obj_tRunJob_12!=null) {
			paraList_tRunJob_12.add("--context_param AssetFlag=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_12));
		} else {
			paraList_tRunJob_12.add("--context_param AssetFlag=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_12.put("AssetFlag", obj_tRunJob_12);
	
		obj_tRunJob_12 = context.bynderDirectory;
		if(obj_tRunJob_12!=null) {
			paraList_tRunJob_12.add("--context_param bynderDirectory=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_12));
		} else {
			paraList_tRunJob_12.add("--context_param bynderDirectory=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_12.put("bynderDirectory", obj_tRunJob_12);
	
	
		dev.ecom_renameasset_bynder_sujob_prod_0_1.Ecom_RenameAsset_Bynder_SuJob_PROD childJob_tRunJob_12 = new dev.ecom_renameasset_bynder_sujob_prod_0_1.Ecom_RenameAsset_Bynder_SuJob_PROD();
	    // pass DataSources
...
public void tFileList_4Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
  ...
  String directory_tFileList_4 = context.bynderDirectory + "/image/04Right";
 ...
 */
	...
	Object obj_tRunJob_13 = null;
		...
		obj_tRunJob_13 = context.bynderDirectory + "/image/04Right/CAD/";
		if(obj_tRunJob_13!=null) {
			paraList_tRunJob_13.add("--context_param bynderSubDirectory=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_13));
		} else {
			paraList_tRunJob_13.add("--context_param bynderSubDirectory=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_13.put("bynderSubDirectory", obj_tRunJob_13);
	
		obj_tRunJob_13 = "_C_R";
		if(obj_tRunJob_13!=null) {
			paraList_tRunJob_13.add("--context_param AssetFlag=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_13));
		} else {
			paraList_tRunJob_13.add("--context_param AssetFlag=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_13.put("AssetFlag", obj_tRunJob_13);
	
		obj_tRunJob_13 = context.bynderDirectory;
		if(obj_tRunJob_13!=null) {
			paraList_tRunJob_13.add("--context_param bynderDirectory=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_13));
		} else {
			paraList_tRunJob_13.add("--context_param bynderDirectory=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_13.put("bynderDirectory", obj_tRunJob_13);
	
	
		dev.ecom_renameasset_bynder_sujob_prod_0_1.Ecom_RenameAsset_Bynder_SuJob_PROD childJob_tRunJob_13 = new dev.ecom_renameasset_bynder_sujob_prod_0_1.Ecom_RenameAsset_Bynder_SuJob_PROD();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_14 = null;
		...
		obj_tRunJob_14 = context.bynderDirectory + "/image/04Right/FlatShot/";
		if(obj_tRunJob_14!=null) {
			paraList_tRunJob_14.add("--context_param bynderSubDirectory=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_14));
		} else {
			paraList_tRunJob_14.add("--context_param bynderSubDirectory=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_14.put("bynderSubDirectory", obj_tRunJob_14);
	
		obj_tRunJob_14 = "_F_R";
		if(obj_tRunJob_14!=null) {
			paraList_tRunJob_14.add("--context_param AssetFlag=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_14));
		} else {
			paraList_tRunJob_14.add("--context_param AssetFlag=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_14.put("AssetFlag", obj_tRunJob_14);
	
		obj_tRunJob_14 = context.bynderDirectory;
		if(obj_tRunJob_14!=null) {
			paraList_tRunJob_14.add("--context_param bynderDirectory=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_14));
		} else {
			paraList_tRunJob_14.add("--context_param bynderDirectory=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_14.put("bynderDirectory", obj_tRunJob_14);
	
	
		dev.ecom_renameasset_bynder_sujob_prod_0_1.Ecom_RenameAsset_Bynder_SuJob_PROD childJob_tRunJob_14 = new dev.ecom_renameasset_bynder_sujob_prod_0_1.Ecom_RenameAsset_Bynder_SuJob_PROD();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_15 = null;
		...
		obj_tRunJob_15 = context.bynderDirectory + "/image/04Right/Mannequin/";
		if(obj_tRunJob_15!=null) {
			paraList_tRunJob_15.add("--context_param bynderSubDirectory=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_15));
		} else {
			paraList_tRunJob_15.add("--context_param bynderSubDirectory=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_15.put("bynderSubDirectory", obj_tRunJob_15);
	
		obj_tRunJob_15 = "_Q_R";
		if(obj_tRunJob_15!=null) {
			paraList_tRunJob_15.add("--context_param AssetFlag=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_15));
		} else {
			paraList_tRunJob_15.add("--context_param AssetFlag=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_15.put("AssetFlag", obj_tRunJob_15);
	
		obj_tRunJob_15 = context.bynderDirectory;
		if(obj_tRunJob_15!=null) {
			paraList_tRunJob_15.add("--context_param bynderDirectory=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_15));
		} else {
			paraList_tRunJob_15.add("--context_param bynderDirectory=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_15.put("bynderDirectory", obj_tRunJob_15);
	
	
		dev.ecom_renameasset_bynder_sujob_prod_0_1.Ecom_RenameAsset_Bynder_SuJob_PROD childJob_tRunJob_15 = new dev.ecom_renameasset_bynder_sujob_prod_0_1.Ecom_RenameAsset_Bynder_SuJob_PROD();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_16 = null;
		...
		obj_tRunJob_16 = context.bynderDirectory + "/image/04Right/Model/";
		if(obj_tRunJob_16!=null) {
			paraList_tRunJob_16.add("--context_param bynderSubDirectory=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_16));
		} else {
			paraList_tRunJob_16.add("--context_param bynderSubDirectory=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_16.put("bynderSubDirectory", obj_tRunJob_16);
	
		obj_tRunJob_16 = "_M_R";
		if(obj_tRunJob_16!=null) {
			paraList_tRunJob_16.add("--context_param AssetFlag=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_16));
		} else {
			paraList_tRunJob_16.add("--context_param AssetFlag=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_16.put("AssetFlag", obj_tRunJob_16);
	
		obj_tRunJob_16 = context.bynderDirectory;
		if(obj_tRunJob_16!=null) {
			paraList_tRunJob_16.add("--context_param bynderDirectory=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_16));
		} else {
			paraList_tRunJob_16.add("--context_param bynderDirectory=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_16.put("bynderDirectory", obj_tRunJob_16);
	
	
		dev.ecom_renameasset_bynder_sujob_prod_0_1.Ecom_RenameAsset_Bynder_SuJob_PROD childJob_tRunJob_16 = new dev.ecom_renameasset_bynder_sujob_prod_0_1.Ecom_RenameAsset_Bynder_SuJob_PROD();
	    // pass DataSources
...
public void tFileList_5Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
  ...
  String directory_tFileList_5 = context.bynderDirectory + "/image/05Details";
 ...
 */
	...
	Object obj_tRunJob_17 = null;
		...
		obj_tRunJob_17 = context.bynderDirectory + "/image/05Details/CAD/";
		if(obj_tRunJob_17!=null) {
			paraList_tRunJob_17.add("--context_param bynderSubDirectory=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_17));
		} else {
			paraList_tRunJob_17.add("--context_param bynderSubDirectory=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_17.put("bynderSubDirectory", obj_tRunJob_17);
	
		obj_tRunJob_17 = "_C_D";
		if(obj_tRunJob_17!=null) {
			paraList_tRunJob_17.add("--context_param AssetFlag=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_17));
		} else {
			paraList_tRunJob_17.add("--context_param AssetFlag=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_17.put("AssetFlag", obj_tRunJob_17);
	
		obj_tRunJob_17 = context.bynderDirectory;
		if(obj_tRunJob_17!=null) {
			paraList_tRunJob_17.add("--context_param bynderDirectory=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_17));
		} else {
			paraList_tRunJob_17.add("--context_param bynderDirectory=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_17.put("bynderDirectory", obj_tRunJob_17);
	
	
		dev.ecom_renameasset_bynder_sujob_prod_0_1.Ecom_RenameAsset_Bynder_SuJob_PROD childJob_tRunJob_17 = new dev.ecom_renameasset_bynder_sujob_prod_0_1.Ecom_RenameAsset_Bynder_SuJob_PROD();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_18 = null;
		...
		obj_tRunJob_18 = context.bynderDirectory + "/image/05Details/FlatShot/";
		if(obj_tRunJob_18!=null) {
			paraList_tRunJob_18.add("--context_param bynderSubDirectory=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_18));
		} else {
			paraList_tRunJob_18.add("--context_param bynderSubDirectory=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_18.put("bynderSubDirectory", obj_tRunJob_18);
	
		obj_tRunJob_18 = "_F_D";
		if(obj_tRunJob_18!=null) {
			paraList_tRunJob_18.add("--context_param AssetFlag=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_18));
		} else {
			paraList_tRunJob_18.add("--context_param AssetFlag=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_18.put("AssetFlag", obj_tRunJob_18);
	
		obj_tRunJob_18 = context.bynderDirectory;
		if(obj_tRunJob_18!=null) {
			paraList_tRunJob_18.add("--context_param bynderDirectory=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_18));
		} else {
			paraList_tRunJob_18.add("--context_param bynderDirectory=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_18.put("bynderDirectory", obj_tRunJob_18);
	
	
		dev.ecom_renameasset_bynder_sujob_prod_0_1.Ecom_RenameAsset_Bynder_SuJob_PROD childJob_tRunJob_18 = new dev.ecom_renameasset_bynder_sujob_prod_0_1.Ecom_RenameAsset_Bynder_SuJob_PROD();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_19 = null;
		...
		obj_tRunJob_19 = context.bynderDirectory + "/image/05Details/Mannequin/";
		if(obj_tRunJob_19!=null) {
			paraList_tRunJob_19.add("--context_param bynderSubDirectory=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_19));
		} else {
			paraList_tRunJob_19.add("--context_param bynderSubDirectory=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_19.put("bynderSubDirectory", obj_tRunJob_19);
	
		obj_tRunJob_19 = "_Q_D";
		if(obj_tRunJob_19!=null) {
			paraList_tRunJob_19.add("--context_param AssetFlag=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_19));
		} else {
			paraList_tRunJob_19.add("--context_param AssetFlag=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_19.put("AssetFlag", obj_tRunJob_19);
	
		obj_tRunJob_19 = context.bynderDirectory;
		if(obj_tRunJob_19!=null) {
			paraList_tRunJob_19.add("--context_param bynderDirectory=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_19));
		} else {
			paraList_tRunJob_19.add("--context_param bynderDirectory=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_19.put("bynderDirectory", obj_tRunJob_19);
	
	
		dev.ecom_renameasset_bynder_sujob_prod_0_1.Ecom_RenameAsset_Bynder_SuJob_PROD childJob_tRunJob_19 = new dev.ecom_renameasset_bynder_sujob_prod_0_1.Ecom_RenameAsset_Bynder_SuJob_PROD();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_20 = null;
		...
		obj_tRunJob_20 = context.bynderDirectory + "/image/05Details/Model/";
		if(obj_tRunJob_20!=null) {
			paraList_tRunJob_20.add("--context_param bynderSubDirectory=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_20));
		} else {
			paraList_tRunJob_20.add("--context_param bynderSubDirectory=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_20.put("bynderSubDirectory", obj_tRunJob_20);
	
		obj_tRunJob_20 = "_M_D";
		if(obj_tRunJob_20!=null) {
			paraList_tRunJob_20.add("--context_param AssetFlag=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_20));
		} else {
			paraList_tRunJob_20.add("--context_param AssetFlag=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_20.put("AssetFlag", obj_tRunJob_20);
	
		obj_tRunJob_20 = context.bynderDirectory;
		if(obj_tRunJob_20!=null) {
			paraList_tRunJob_20.add("--context_param bynderDirectory=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_20));
		} else {
			paraList_tRunJob_20.add("--context_param bynderDirectory=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_20.put("bynderDirectory", obj_tRunJob_20);
	
	
		dev.ecom_renameasset_bynder_sujob_prod_0_1.Ecom_RenameAsset_Bynder_SuJob_PROD childJob_tRunJob_20 = new dev.ecom_renameasset_bynder_sujob_prod_0_1.Ecom_RenameAsset_Bynder_SuJob_PROD();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final RenameAsset_Bynder_SubjobPROD RenameAsset_Bynder_SubjobPRODClass = new RenameAsset_Bynder_SubjobPROD();

        int exitCode = RenameAsset_Bynder_SubjobPRODClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = RenameAsset_Bynder_SubjobPROD.class.getClassLoader().getResourceAsStream("dev/renameasset_bynder_subjobprod_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = RenameAsset_Bynder_SubjobPROD.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : RenameAsset_Bynder_SubjobPROD");
        }
...
/************************************************************************************************
 *     231424 characters generated by Talend Open Studio for Data Integration 
