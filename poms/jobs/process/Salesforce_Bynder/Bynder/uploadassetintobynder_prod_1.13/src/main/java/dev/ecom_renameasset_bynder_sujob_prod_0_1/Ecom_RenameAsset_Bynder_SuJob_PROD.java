...
package dev.ecom_renameasset_bynder_sujob_prod_0_1;
...
/**
 * Job: Ecom_RenameAsset_Bynder_SuJob_PROD Purpose: Ecom_RenameAsset_Bynder_SuJob_PROD<br>
 * Description: Ecom_RenameAsset_Bynder_SuJob_PROD <br>
 * @author user@talend.com
 * @version 7.3.1.20191031_1204-M3
 * @status 
 */
public class Ecom_RenameAsset_Bynder_SuJob_PROD implements TalendJob {
...
public String getSQLSERVER_LOG_Server(){
	...
	private final String jobName = "Ecom_RenameAsset_Bynder_SuJob_PROD";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Ecom_RenameAsset_Bynder_SuJob_PROD.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Ecom_RenameAsset_Bynder_SuJob_PROD.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
String AssetFlag = context.AssetFlag;
...
end_Hash.put("tJava_1", System.currentTimeMillis());
   			...
   			if (StringHandling.RIGHT(context.AssetFlag,2).equals("_F") || StringHandling.RIGHT(context.AssetFlag,2).equals("_B") || StringHandling.RIGHT(context.AssetFlag,2).equals("_L") || StringHandling.RIGHT(context.AssetFlag,2).equals("_R") ) {
...
public static class copyOfoutput_0Struct implements routines.system.IPersistableRow<copyOfoutput_0Struct> {
    final static byte[] commonByteArrayLock_DEV_Ecom_RenameAsset_Bynder_SuJob_PROD = new byte[0];
    static byte[] commonByteArray_DEV_Ecom_RenameAsset_Bynder_SuJob_PROD = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_DEV_Ecom_RenameAsset_Bynder_SuJob_PROD.length) {
				if(length < 1024 && commonByteArray_DEV_Ecom_RenameAsset_Bynder_SuJob_PROD.length == 0) {
   					commonByteArray_DEV_Ecom_RenameAsset_Bynder_SuJob_PROD = new byte[1024];
				} else {
   					commonByteArray_DEV_Ecom_RenameAsset_Bynder_SuJob_PROD = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_DEV_Ecom_RenameAsset_Bynder_SuJob_PROD, 0, length);
			strReturn = new String(commonByteArray_DEV_Ecom_RenameAsset_Bynder_SuJob_PROD, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_DEV_Ecom_RenameAsset_Bynder_SuJob_PROD) {
...
copyOfoutput_0Struct copyOfoutput_0 = new copyOfoutput_0Struct();
  ...
  String directory_tFileList_3 = context.bynderSubDirectory;
...
java.io.File file_tFileProperties_3 = new java.io.File((String)globalMap.get("tFileList_3_CURRENT_FILEPATH"));
row6 = new row6Struct();
...
row7.File_Datetime = TalendDate.formatDate("yyyy-MM-dd HH:mm:ss", TalendDate.parseDateLocale("EEE MMM dd HH:mm:ss z yyyy", row7.mtime_string, "EN"));

context.File_Datetime = TalendDate.formatDate("yyyy-MM-dd HH:mm:ss", TalendDate.parseDateLocale("EEE MMM dd HH:mm:ss z yyyy", row7.mtime_string, "EN"));

row7.StyleColor = StringHandling.LEFT(row7.basename,6) + "-" + StringHandling.RIGHT(StringHandling.LEFT(row7.basename,10),3);
...
Var.FileExtenstion = row7.basename.substring(row7.basename.indexOf(".") ,  StringHandling.LEN(row7.basename)) ;// ###############################
        // ###############################
        // # Output tables
...
copyOfoutput_0_tmp.NewAssetName = Var.Style_Code + "-" +  Var.Color_Code + context.AssetFlag + row7.AssetSuffix;
...
copyOfoutputStruct copyOfoutput = new copyOfoutputStruct();
  ...
  String directory_tFileList_2 = context.bynderSubDirectory;
...
row4.File_Datetime = TalendDate.formatDate("yyyy-MM-dd HH:mm:ss", TalendDate.parseDateLocale("EEE MMM dd HH:mm:ss z yyyy", row4.mtime_string, "EN"));

context.File_Datetime = TalendDate.formatDate("yyyy-MM-dd HH:mm:ss", TalendDate.parseDateLocale("EEE MMM dd HH:mm:ss z yyyy", row4.mtime_string, "EN"));


System.out.println("StyleColor   " + row4.StyleColor  );

if (StringHandling.INDEX("PLV", row4.basename) > 0)
{
	row4.StyleColor = StringHandling.LEFT(row4.basename,StringHandling.INDEX("_PLV", row4.basename)) + "-PLV" ;
	
}
else
{
	
row4.StyleColor = StringHandling.LEFT(row4.basename,6) + "-" + StringHandling.RIGHT(StringHandling.LEFT(row4.basename,10),3);
...
Var.Style_Code = StringHandling.INDEX("PLV", row4.basename) > 0 ? StringHandling.LEFT(row4.basename,StringHandling.INDEX("PLV", row4.basename)) : StringHandling.LEFT(row4.basename,6) ;
Var.Color_Code = StringHandling.INDEX("PLV", row4.basename) > 0 ? "PLV" : StringHandling.RIGHT(StringHandling.LEFT(row4.basename,10),3) ;
Var.FileExtenstion = row4.basename.substring(row4.basename.indexOf(".") ,  StringHandling.LEN(row4.basename)) ;// ###############################
        // ###############################
        // # Output tables
 ...
 */
    ...
    public static void main(String[] args){
        final Ecom_RenameAsset_Bynder_SuJob_PROD Ecom_RenameAsset_Bynder_SuJob_PRODClass = new Ecom_RenameAsset_Bynder_SuJob_PROD();

        int exitCode = Ecom_RenameAsset_Bynder_SuJob_PRODClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Ecom_RenameAsset_Bynder_SuJob_PROD.class.getClassLoader().getResourceAsStream("dev/ecom_renameasset_bynder_sujob_prod_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Ecom_RenameAsset_Bynder_SuJob_PROD.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Ecom_RenameAsset_Bynder_SuJob_PROD");
        }
...
/************************************************************************************************
 *     156419 characters generated by Talend Open Studio for Data Integration 
