...
package dev.buy_integration_0_31;
...
public class BUY_INTEGRATION implements TalendJob {
	...
	private final String jobVersion = "0.31";
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tFileArchive_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("ENC:[OEXqyuNdWQI31N3DJs8RypxwTn/1q7Fy9upL5A==]");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_connectionStatsLogs = routines.system.PasswordEncryptUtil
						.decryptPassword(
								"ENC:[AD5LrUPSnYqC3y0hAB7BE068d1NARSHcL2erNPuAqoTWZNInpK6Cuc+Xjd3QTs/KD8Uwf6d2U+g=]");
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = BUY_INTEGRATION.class.getClassLoader()
					.getResourceAsStream("dev/buy_integration_0_31/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 447641 characters generated by Talend Open Studio for Data Integration on the
 * 7 septembre 2022 16:44:13 CEST
 ************************************************************************************************/