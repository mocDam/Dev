...
package dev.uploadfileinsharepoint_4_0;
...
/**
 * Job: UploadFileInSharepoint Purpose: Send an email office 365 OAUTH2<br>
 * Description: Send an email office 365 OAUTH2 <br>
 * @author user@talend.com
 * @version 7.3.1.20191031_1204-M3
 * @status TEST
 */
public class UploadFileInSharepoint implements TalendJob {
	...
	public class ContextProperties extends PropertiesWithType {
		...
		public void synchronizeContext(){
			...
			if(FilePathToUpload != null){
					...
					this.setProperty("FilePathToUpload", FilePathToUpload.toString());
				
			}
			
			if(SharepointAuthenticationUrl != null){
				
					this.setProperty("SharepointAuthenticationUrl", SharepointAuthenticationUrl.toString());
				
			}
			
			if(SharepointClientId != null){
				
					this.setProperty("SharepointClientId", SharepointClientId.toString());
				
			}
			
			if(SharepointDirectory != null){
				
					this.setProperty("SharepointDirectory", SharepointDirectory.toString());
				
			}
			
			if(SharepointPostURL != null){
				
					this.setProperty("SharepointPostURL", SharepointPostURL.toString());
				
			}
			
			if(SharepointResource != null){
				
					this.setProperty("SharepointResource", SharepointResource.toString());
				
			}
			
			if(SharepointSecretId != null){
				
					this.setProperty("SharepointSecretId", SharepointSecretId.toString());
				
			}
			
			if(SharepointTenant != null){
				
					this.setProperty("SharepointTenant", SharepointTenant.toString());
				
			}
			
			if(SharepointToken != null){
				
					this.setProperty("SharepointToken", SharepointToken.toString());
...
public String SharepointAuthenticationUrl;
public String getSharepointAuthenticationUrl(){
	return this.SharepointAuthenticationUrl;
}
public java.lang.String SharepointClientId;
public java.lang.String getSharepointClientId(){
	return this.SharepointClientId;
}
public String SharepointDirectory;
public String getSharepointDirectory(){
	return this.SharepointDirectory;
}
public String SharepointPostURL;
public String getSharepointPostURL(){
	return this.SharepointPostURL;
}
public java.lang.String SharepointResource;
public java.lang.String getSharepointResource(){
	return this.SharepointResource;
}
public java.lang.String SharepointSecretId;
public java.lang.String getSharepointSecretId(){
	return this.SharepointSecretId;
}
public java.lang.String SharepointTenant;
public java.lang.String getSharepointTenant(){
	return this.SharepointTenant;
}
...
public String getSQLSERVER_LOG_Server(){
	...
	private final String jobName = "UploadFileInSharepoint";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				UploadFileInSharepoint.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(UploadFileInSharepoint.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
try {
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_3", "", Thread.currentThread().getId() + "", "INFO","","Start job","", "");
	talendLogs_LOGS.addMessage("tWarn", "tWarn_3", 3, "Start job", 3);
	talendLogs_LOGSProcess(globalMap);
	globalMap.put("tWarn_3_WARN_MESSAGES", "Start job"); 
...
globalMap.put("FileNameToUpload", "");
globalMap.put("Path", "");
...
end_Hash.put("tLibraryLoad_3", System.currentTimeMillis());
   			...
   			if (context.FilePathToUpload == null || context.FilePathToUpload.equals("")) {
 ...
 */
	...
	try {
				talendLogs_LOGS.addMessage("tDie", "tDie_1", 5, "File attribute is not defined", 4);
				talendLogs_LOGSProcess(globalMap);
				
	globalMap.put("tDie_1_DIE_PRIORITY", 5);
	System.err.println("File attribute is not defined");
	
	globalMap.put("tDie_1_DIE_MESSAGE", "File attribute is not defined");
	globalMap.put("tDie_1_DIE_MESSAGES", "File attribute is not defined");
...
java.io.File file_tFileExist_1 = new java.io.File(context.FilePathToUpload);
...
globalMap.put("tFileExist_1_FILENAME",context.FilePathToUpload);
 ...
 */
	...
	try {
				talendLogs_LOGS.addMessage("tDie", "tDie_2", 5, "File not found", 4);
				talendLogs_LOGSProcess(globalMap);
				
	globalMap.put("tDie_2_DIE_PRIORITY", 5);
	System.err.println("File not found");
	
	globalMap.put("tDie_2_DIE_MESSAGE", "File not found");
	globalMap.put("tDie_2_DIE_MESSAGES", "File not found");
...
public static class row6Struct implements routines.system.IPersistableRow<row6Struct> {
    final static byte[] commonByteArrayLock_DEV_UploadFileInSharepoint = new byte[0];
    static byte[] commonByteArray_DEV_UploadFileInSharepoint = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_DEV_UploadFileInSharepoint.length) {
				if(length < 1024 && commonByteArray_DEV_UploadFileInSharepoint.length == 0) {
   					commonByteArray_DEV_UploadFileInSharepoint = new byte[1024];
				} else {
   					commonByteArray_DEV_UploadFileInSharepoint = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_DEV_UploadFileInSharepoint, 0, length);
			strReturn = new String(commonByteArray_DEV_UploadFileInSharepoint, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_DEV_UploadFileInSharepoint) {
...
java.io.File file_tFileProperties_1 = new java.io.File(context.FilePathToUpload);
row6 = new row6Struct();
...
globalMap.put("FileNameToUpload",row6.basename) ;
globalMap.put("Path",row6.dirname) ;
System.out.println(((String)globalMap.get("FileNameToUpload")));
System.out.println(((String)globalMap.get("Path")));
    nb_line_tJavaRow_5++;   
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		dev.gettokensharepoint_4_0.GetTokenSharepoint childJob_tRunJob_1 = new dev.gettokensharepoint_4_0.GetTokenSharepoint();
	    // pass DataSources
			...
			for (String[] item_tRunJob_1 : childReturn_tRunJob_1) { 
				if(childJob_tRunJob_1.hastBufferOutputComponent() || true){
						...
						if(0 < item_tRunJob_1.length){				
				           		...
				           		row1.access_token = item_tRunJob_1[0];
 ...
 */
    ...
    System.out.println("FROM CHILD JOB");
System.out.println(row1.access_token);
context.SharepointToken = row1.access_token;
...
end_Hash.put("tJavaRow_1", System.currentTimeMillis());
   			...
   			if (context.SharepointToken !=  null) {
...
// TalendUtils(String sPath, String sFileName, String sharePointpostURL, String sharepointFolder, String sharepointToken, boolean isSharepoint )

	TalendUtils talend = new TalendUtils((String)globalMap.get("Path") + "/" , (String)globalMap.get("FileNameToUpload"), 				context.SharepointPostURL,context.SharepointDirectory , context.SharepointToken, true );
	

	talend.callUploadSharepoint();
...
try {
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_2", "", Thread.currentThread().getId() + "", "INFO","","End job","", "");
	talendLogs_LOGS.addMessage("tWarn", "tWarn_2", 3, "End job", 3);
	talendLogs_LOGSProcess(globalMap);
	globalMap.put("tWarn_2_WARN_MESSAGES", "End job"); 
 ...
 */
    ...
    public static void main(String[] args){
        final UploadFileInSharepoint UploadFileInSharepointClass = new UploadFileInSharepoint();

        int exitCode = UploadFileInSharepointClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = UploadFileInSharepoint.class.getClassLoader().getResourceAsStream("dev/uploadfileinsharepoint_4_0/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = UploadFileInSharepoint.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
            ...
            class ContextProcessing {
                private void processContext_0() {
                        context.setContextType("FilePathToUpload", "id_String");
                            context.FilePathToUpload=(String) context.getProperty("FilePathToUpload");
                        context.setContextType("SharepointAuthenticationUrl", "id_String");
                            context.SharepointAuthenticationUrl=(String) context.getProperty("SharepointAuthenticationUrl");
                        context.setContextType("SharepointClientId", "id_Password");
                            String pwd_SharepointClientId_value = context.getProperty("SharepointClientId");
                            context.SharepointClientId = null;
                            if(pwd_SharepointClientId_value!=null) {
                                if(context_param.containsKey("SharepointClientId")) {//no need to decrypt if it come from program argument or parent job runtime
                                    context.SharepointClientId = pwd_SharepointClientId_value;
                                } else if (!pwd_SharepointClientId_value.isEmpty()) {
                                    try {
                                        context.SharepointClientId = routines.system.PasswordEncryptUtil.decryptPassword(pwd_SharepointClientId_value);
                                        context.put("SharepointClientId",context.SharepointClientId);
                                    } catch (java.lang.RuntimeException e) {
                                        //do nothing
                                    }
                                }
                            }
                        context.setContextType("SharepointDirectory", "id_String");
                            context.SharepointDirectory=(String) context.getProperty("SharepointDirectory");
                        context.setContextType("SharepointPostURL", "id_String");
                            context.SharepointPostURL=(String) context.getProperty("SharepointPostURL");
                        context.setContextType("SharepointResource", "id_Password");
                            String pwd_SharepointResource_value = context.getProperty("SharepointResource");
                            context.SharepointResource = null;
                            if(pwd_SharepointResource_value!=null) {
                                if(context_param.containsKey("SharepointResource")) {//no need to decrypt if it come from program argument or parent job runtime
                                    context.SharepointResource = pwd_SharepointResource_value;
                                } else if (!pwd_SharepointResource_value.isEmpty()) {
                                    try {
                                        context.SharepointResource = routines.system.PasswordEncryptUtil.decryptPassword(pwd_SharepointResource_value);
                                        context.put("SharepointResource",context.SharepointResource);
                                    } catch (java.lang.RuntimeException e) {
                                        //do nothing
                                    }
                                }
                            }
                        context.setContextType("SharepointSecretId", "id_Password");
                            String pwd_SharepointSecretId_value = context.getProperty("SharepointSecretId");
                            context.SharepointSecretId = null;
                            if(pwd_SharepointSecretId_value!=null) {
                                if(context_param.containsKey("SharepointSecretId")) {//no need to decrypt if it come from program argument or parent job runtime
                                    context.SharepointSecretId = pwd_SharepointSecretId_value;
                                } else if (!pwd_SharepointSecretId_value.isEmpty()) {
                                    try {
                                        context.SharepointSecretId = routines.system.PasswordEncryptUtil.decryptPassword(pwd_SharepointSecretId_value);
                                        context.put("SharepointSecretId",context.SharepointSecretId);
                                    } catch (java.lang.RuntimeException e) {
                                        //do nothing
                                    }
                                }
                            }
                        context.setContextType("SharepointTenant", "id_Password");
                            String pwd_SharepointTenant_value = context.getProperty("SharepointTenant");
                            context.SharepointTenant = null;
                            if(pwd_SharepointTenant_value!=null) {
                                if(context_param.containsKey("SharepointTenant")) {//no need to decrypt if it come from program argument or parent job runtime
                                    context.SharepointTenant = pwd_SharepointTenant_value;
                                } else if (!pwd_SharepointTenant_value.isEmpty()) {
                                    try {
                                        context.SharepointTenant = routines.system.PasswordEncryptUtil.decryptPassword(pwd_SharepointTenant_value);
                                        context.put("SharepointTenant",context.SharepointTenant);
                                    } catch (java.lang.RuntimeException e) {
                                        //do nothing
                                    }
                                }
                            }
                        context.setContextType("SharepointToken", "id_String");
                            context.SharepointToken=(String) context.getProperty("SharepointToken");
        ...
        if (parentContextMap != null && !parentContextMap.isEmpty()) {if (parentContextMap.containsKey("FilePathToUpload")) {
                context.FilePathToUpload = (String) parentContextMap.get("FilePathToUpload");
            }if (parentContextMap.containsKey("SharepointAuthenticationUrl")) {
                context.SharepointAuthenticationUrl = (String) parentContextMap.get("SharepointAuthenticationUrl");
            }if (parentContextMap.containsKey("SharepointClientId")) {
                context.SharepointClientId = (java.lang.String) parentContextMap.get("SharepointClientId");
            }if (parentContextMap.containsKey("SharepointDirectory")) {
                context.SharepointDirectory = (String) parentContextMap.get("SharepointDirectory");
            }if (parentContextMap.containsKey("SharepointPostURL")) {
                context.SharepointPostURL = (String) parentContextMap.get("SharepointPostURL");
            }if (parentContextMap.containsKey("SharepointResource")) {
                context.SharepointResource = (java.lang.String) parentContextMap.get("SharepointResource");
            }if (parentContextMap.containsKey("SharepointSecretId")) {
                context.SharepointSecretId = (java.lang.String) parentContextMap.get("SharepointSecretId");
            }if (parentContextMap.containsKey("SharepointTenant")) {
                context.SharepointTenant = (java.lang.String) parentContextMap.get("SharepointTenant");
            }if (parentContextMap.containsKey("SharepointToken")) {
                context.SharepointToken = (String) parentContextMap.get("SharepointToken");
		...
		List<String> parametersToEncrypt = new java.util.ArrayList<String>();
			parametersToEncrypt.add("SharepointClientId");
			parametersToEncrypt.add("SharepointResource");
			parametersToEncrypt.add("SharepointSecretId");
			parametersToEncrypt.add("SharepointTenant");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : UploadFileInSharepoint");
        }
...
/************************************************************************************************
 *     140383 characters generated by Talend Open Studio for Data Integration 
 *     on the 3 janvier 2024 14:59:25 GMT
 ************************************************************************************************/