...
package dev.test_send_email_0_1;
...
/**
 * Job: TEST_SEND_EMAIL Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class TEST_SEND_EMAIL implements TalendJob {
	...
	private final String jobName = "TEST_SEND_EMAIL";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					TEST_SEND_EMAIL.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(TEST_SEND_EMAIL.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (osName_tRunJob_1 != null && osName_tRunJob_1.toLowerCase().startsWith("win")) {
					...
					jvm_argument_helper_tRunJob_1.addArgumentsTo(paraList_tRunJob_1,
							dealChildJobLibrary_tRunJob_1.replaceJarPathsFromCrcMap(
									"C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/workspace/DEV/poms/jobs/process/Common/sendmailoffice365_0.1/target/classpath.jar;"));

					jvm_argument_helper_tRunJob_1.addArgumentsTo(paraList_tRunJob_1,
							"dev.sendmailoffice365_0_1.SendMailOffice365");
					...
					jvm_argument_helper_tRunJob_1.addArgumentsTo(paraList_tRunJob_1,
							dealChildJobLibrary_tRunJob_1.replaceJarPathsFromCrcMap(
									"C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/workspace/DEV/poms/jobs/process/Common/sendmailoffice365_0.1/target/classes:C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/workspace/DEV/poms/jobs/process/Common/sendmailoffice365_0.1/src/main/ext-resources:C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/workspace/DEV/poms/jobs/process/Common/gettokenandsendmailoauth2_5.0/target/classes:C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/workspace/DEV/poms/jobs/process/Common/gettokenandsendmailoauth2_5.0/src/main/ext-resources:C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/workspace/DEV/poms/code/routines/target/classes:.:C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/configuration/.m2/repository/org/talend/libraries/crypto-utils/6.0.0-SNAPSHOT/crypto-utils-6.0.0-SNAPSHOT.jar:C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/configuration/.m2/repository/dom4j/dom4j/1.6.1/dom4j-1.6.1.jar:C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/configuration/.m2/repository/log4j/log4j/1.2.17/log4j-1.2.17.jar:C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/configuration/.m2/repository/org/talend/libraries/mssql-jdbc/6.0.0/mssql-jdbc-6.0.0.jar:")
				...
				obj_tRunJob_1 = "mon body <b> avec un peu d'HTML </b>";
				if (obj_tRunJob_1 != null) {
					paraList_tRunJob_1
							.add("--context_param Content=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_1));
				} else {
				...
				obj_tRunJob_1 = "Subject";
				if (obj_tRunJob_1 != null) {
					paraList_tRunJob_1
							.add("--context_param Subject=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_1));
				} else {
					paraList_tRunJob_1.add(
				...
				obj_tRunJob_1 = "fdjebiri@b-wizz-u.com;fdjebiri@gmail.com";
				if (obj_tRunJob_1 != null) {
					paraList_tRunJob_1
							.add("--context_param ToAddress=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_1));
				} else {
					paraList_tRunJob_1.add(
				...
				if (obj_tRunJob_1 != null) {
					paraList_tRunJob_1.add(
							"--context_param AttachmentsList=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_1));
				} else {
					paraList_tRunJob_1.add("--context_param AttachmentsList="
							+ NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
				}
	...
	public static class row_talendLogs_LOGSStruct
		...
		final static byte[] commonByteArrayLock_DEV_TEST_SEND_EMAIL = new byte[0];
		static byte[] commonByteArray_DEV_TEST_SEND_EMAIL = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_DEV_TEST_SEND_EMAIL.length) {
					if (length < 1024 && commonByteArray_DEV_TEST_SEND_EMAIL.length == 0) {
						commonByteArray_DEV_TEST_SEND_EMAIL = new byte[1024];
					} else {
						commonByteArray_DEV_TEST_SEND_EMAIL = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_DEV_TEST_SEND_EMAIL, 0, length);
				strReturn = new String(commonByteArray_DEV_TEST_SEND_EMAIL, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DEV_TEST_SEND_EMAIL) {
	...
	public static void main(String[] args) {
		final TEST_SEND_EMAIL TEST_SEND_EMAILClass = new TEST_SEND_EMAIL();

		int exitCode = TEST_SEND_EMAILClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = TEST_SEND_EMAIL.class.getClassLoader()
					.getResourceAsStream("dev/test_send_email_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = TEST_SEND_EMAIL.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : TEST_SEND_EMAIL");
		}
...
/************************************************************************************************
 * 84178 characters generated by Talend Open Studio for Data Integration on the
 * 24 février 2023 12:03:22 CET
 ************************************************************************************************/