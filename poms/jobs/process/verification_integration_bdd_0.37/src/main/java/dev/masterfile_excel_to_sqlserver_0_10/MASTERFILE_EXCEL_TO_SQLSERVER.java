...
package dev.masterfile_excel_to_sqlserver_0_10;
...
/**
 * Job: MASTERFILE_EXCEL_TO_SQLSERVER Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20191031_1204-M3
 * @status DEV
 */
public class MASTERFILE_EXCEL_TO_SQLSERVER implements TalendJob {
	...
	public class ContextProperties extends PropertiesWithType {
		...
		public void synchronizeContext(){
			...
			if(SQLSERVERSCHEMA_MASTERFILE_AdditionalParams != null){
					...
					this.setProperty("SQLSERVERSCHEMA_MASTERFILE_AdditionalParams", SQLSERVERSCHEMA_MASTERFILE_AdditionalParams.toString());
...
public String getSQLSERVERSCHEMA_MASTERFILE_Server(){
	...
	private final String jobName = "MASTERFILE_EXCEL_TO_SQLSERVER";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				MASTERFILE_EXCEL_TO_SQLSERVER.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(MASTERFILE_EXCEL_TO_SQLSERVER.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
    final static byte[] commonByteArrayLock_DEV_MASTERFILE_EXCEL_TO_SQLSERVER = new byte[0];
    static byte[] commonByteArray_DEV_MASTERFILE_EXCEL_TO_SQLSERVER = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_DEV_MASTERFILE_EXCEL_TO_SQLSERVER) {
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_DEV_MASTERFILE_EXCEL_TO_SQLSERVER.length) {
				if(length < 1024 && commonByteArray_DEV_MASTERFILE_EXCEL_TO_SQLSERVER.length == 0) {
   					commonByteArray_DEV_MASTERFILE_EXCEL_TO_SQLSERVER = new byte[1024];
				} else {
   					commonByteArray_DEV_MASTERFILE_EXCEL_TO_SQLSERVER = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_DEV_MASTERFILE_EXCEL_TO_SQLSERVER, 0, length);
			strReturn = new String(commonByteArray_DEV_MASTERFILE_EXCEL_TO_SQLSERVER, 0, length, utf8Charset);
		}
		return strReturn;
	}
 ...
 */
	...
	final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[Mg6K7Wjcu39zVlh2JiaNDTlOQP8TQrk3KiZtPw==]");
...
{
	context.ErrorHeader += "Column GBP RRP not found \n";
	context.hasErrorHeader = true;
}
...
if (fieldsMap.get("DELIVERYFLOW") == null) 
{
	context.ErrorHeader += "Column DELIVERYFLOW not found \n";
	context.hasErrorHeader = true;
}

if (fieldsMap.get("PRODUCT CHANNEL") == null) 
{
	context.ErrorHeader += "Column PRODUCT CHANNEL not found \n";
	context.hasErrorHeader = true;
}

if (fieldsMap.get("SUSTAINABILITY") == null) 
{
	context.ErrorHeader += "Column SUSTAINABILITY not found \n";
	context.hasErrorHeader = true;
}
...
public static class row12Struct implements routines.system.IPersistableRow<row12Struct> {
    ...
    static byte[] commonByteArray_DEV_MASTERFILE_EXCEL_TO_SQLSERVER = new byte[0];
			    ...
			    public String DELIVERYFLOW_NOT_FOUND;

				public String getDELIVERYFLOW_NOT_FOUND () {
					return this.DELIVERYFLOW_NOT_FOUND;
				}
			    ...
			    public String PRODUCT_CHANNEL_NOT_FOUND;

				public String getPRODUCT_CHANNEL_NOT_FOUND () {
					return this.PRODUCT_CHANNEL_NOT_FOUND;
				}
				
			    public String SUSTAINABILITY_NOT_FOUND;

				public String getSUSTAINABILITY_NOT_FOUND () {
					return this.SUSTAINABILITY_NOT_FOUND;
				}
		...
		synchronized(commonByteArrayLock_DEV_MASTERFILE_EXCEL_TO_SQLSERVER) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.DELIVERYFLOW_NOT_FOUND = readString(dis);
					
					this.PRODUCT_CHANNEL = readString(dis);
					
					this.PRODUCT_CHANNEL_NOT_FOUND = readString(dis);
					
					this.SUSTAINABILITY_NOT_FOUND = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.DELIVERYFLOW_NOT_FOUND,dos);
					...
					// String
						...
						writeString(this.PRODUCT_CHANNEL_NOT_FOUND,dos);
					
					// String
				
						writeString(this.SUSTAINABILITY_NOT_FOUND,dos);
    ...
    public String toString() {
		...
		sb.append(",EAN="+EAN);
		sb.append(",DELIVERYFLOW="+DELIVERYFLOW);
		sb.append(",DELIVERYFLOW_NOT_FOUND="+DELIVERYFLOW_NOT_FOUND);
		sb.append(",PRODUCT_CHANNEL="+PRODUCT_CHANNEL);
		sb.append(",PRODUCT_CHANNEL_NOT_FOUND="+PRODUCT_CHANNEL_NOT_FOUND);
		sb.append(",SUSTAINABILITY_NOT_FOUND="+SUSTAINABILITY_NOT_FOUND);
	    sb.append("]");
...
public static class DedoublonneStruct implements routines.system.IPersistableRow<DedoublonneStruct> {
    final static byte[] commonByteArrayLock_DEV_MASTERFILE_EXCEL_TO_SQLSERVER = new byte[0];
    static byte[] commonByteArray_DEV_MASTERFILE_EXCEL_TO_SQLSERVER = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(DedoublonneStruct other) {
...
DedoublonneStruct Dedoublonne = new DedoublonneStruct();
...
String dbUser_tDBOutput_1 = null;
    dbschema_tDBOutput_1 = context.SQLSERVERSCHEMA_MASTERFILE_Schema;
    String driverClass_tDBOutput_1 = "com.microsoft.sqlserver.jdbc.SQLServerDriver";
	
    java.lang.Class.forName(driverClass_tDBOutput_1);
    String port_tDBOutput_1 = context.SQLSERVERSCHEMA_MASTERFILE_Port;
    String dbname_tDBOutput_1 = context.SQLSERVERSCHEMA_MASTERFILE_Database ;
    String url_tDBOutput_1 = "jdbc:sqlserver://" + context.SQLSERVERSCHEMA_MASTERFILE_Server ; 
    if (!"".equals(port_tDBOutput_1)) {
    	url_tDBOutput_1 += ":" + context.SQLSERVERSCHEMA_MASTERFILE_Port;
    }
    if (!"".equals(dbname_tDBOutput_1)) {		    
		    	url_tDBOutput_1 += ";databaseName=" + context.SQLSERVERSCHEMA_MASTERFILE_Database; 
	
    }
    url_tDBOutput_1 += ";appName=" + projectName + ";" + context.SQLSERVERSCHEMA_MASTERFILE_AdditionalParams;
    dbUser_tDBOutput_1 = context.SQLSERVERSCHEMA_MASTERFILE_Login;


	final String decryptedPassword_tDBOutput_1 = context.SQLSERVERSCHEMA_MASTERFILE_Password; 
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
    tableName_tDBOutput_1 = "Products";
} else {
    tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "].[" + "Products";
}
	int count_tDBOutput_1=0;

        String insert_tDBOutput_1 = "INSERT INTO [" + tableName_tDBOutput_1 + "] ([lineNumber],[fileName],[creationDate],[BRAND],[SEASON],[CATEGORY],[REF],[DESCRIPTION],[STYLE],[COLOR],[FASHION],[STYLECOLORLABEL],[COLORNAME],[LBL],[STYLE_COLOR],[GENDER],[AGE_RANGE],[SIZE_RANGE],[SIZE],[US_SIZE],[CM_SIZE],[PRODUCT],[PRODUCT_STATUS],[PRODUCT_TIER],[ACCT_EXCLUS],[CARTON_QTY],[EUR_RRP],[EUR_WSP],[GBP_RRP],[GBP_WSP],[CHF_RRP],[CHF_WSP],[NOK_RRP],[NOK_WSP],[DKK_RRP],[DKK_WSP],[SEK_RRP],[SEK_WSP],[EUR_FINN_RRP],[EUR_FINN_WSP],[FABRICATION],[COO],[CUSTOM_TARIFF_CODE],[UPC],[DELIVERYFLOW],[PRODUCT_CHANNEL]) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
        ...
        public void setTableName(String name) {
            ...
            private StringBuilder print(String[] fillChars) {
                ...
                sb.append(fillChars[0]);                
                    ...
                    //last column
                    for (int i = 0; i < colLengths[78] - fillChars[1].length() + 1; i++) {
                        sb.append(fillChars[2]);
                    }         
                sb.append(fillChars[1]);
                sb.append("\n");               
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_1=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row37Struct> tHashFile_tHashOutput_1 = null;
		String hashKey_tHashOutput_1 = "tHashFile_MASTERFILE_EXCEL_TO_SQLSERVER_" + pid + "_tHashOutput_1";
			synchronized(org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.get(hashKey_tHashOutput_1)){
			    if(mf_tHashOutput_1.getResourceMap().get(hashKey_tHashOutput_1) == null){
	      		    mf_tHashOutput_1.getResourceMap().put(hashKey_tHashOutput_1, new org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row37Struct>(org.talend.designer.components.hashfile.common.MATCHING_MODE.KEEP_ALL));
 ...
 */
	...
	currentComponent="tUniqRow_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"Dedoublonne");
					}
		...
		class KeyStruct_tUniqRow_1 {
			...
			public int hashCode() {
				if (this.hashCodeDirty) {
					...
					int result = DEFAULT_HASHCODE;
								...
								result = prime * result + ((this.STYLECOLORLABEL == null) ? 0 : this.STYLECOLORLABEL.hashCode());
			...
			public boolean equals(Object obj) {
				...
				final KeyStruct_tUniqRow_1 other = (KeyStruct_tUniqRow_1) obj;
									...
									if (this.STYLECOLORLABEL == null) {
										if (other.STYLECOLORLABEL != null) 
											return false;
								
									} else if (!this.STYLECOLORLABEL.equals(other.STYLECOLORLABEL))
...
DedoublonneStruct Dedoublonne_tmp = new DedoublonneStruct();
// ###############################
...
class  Var__tMap_1__Struct  {
	...
	String Fn_PRODUCTCHANNEL;
	String Fn_SUSTAINABILITY;
}
 ...
 */
	...
	final String decryptedPassword_tFileInputExcel_2 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[6QyvDi5oRMItAMmKCHX4na3/QHq4tlJMjH/G5w==]");
		...
		try {
		excelReader_tFileInputExcel_2.addSheetName(context.excelSheetName, false);
		int start_column_tFileInputExcel_2 = 1-1;
		int end_column_tFileInputExcel_2 = 80-1;
		if(start_column_tFileInputExcel_2 >=0) {//follow start column
			
				end_column_tFileInputExcel_2 = start_column_tFileInputExcel_2 + 82 - 1;
			
		} else if(end_column_tFileInputExcel_2 >= 0) {//follow end column
			start_column_tFileInputExcel_2 = end_column_tFileInputExcel_2 - 82 + 1;
		}
		...
		if(source_tFileInputExcel_2 instanceof String){
			excelReader_tFileInputExcel_2.parse((String)source_tFileInputExcel_2,"ISO-8859-15", password_tFileInputExcel_2);
		} else if(source_tFileInputExcel_2 instanceof java.io.InputStream) {
			excelReader_tFileInputExcel_2.parse((java.io.InputStream)source_tFileInputExcel_2,"ISO-8859-15", password_tFileInputExcel_2);
		}
...
Var.Fn_PRODUCTCHANNEL = ((Map<String,String>)globalMap.get("fieldMap")).get("PRODUCT CHANNEL") ;
Var.Fn_SUSTAINABILITY = ((Map<String,String>)globalMap.get("fieldMap")).get("SUSTAINABILITY") ;// ###############################
        // ###############################
        // # Output tables
...
sortie_Excel_tmp.SIZE_RATIO_SPLIT = "";
sortie_Excel_tmp.REC_SIZE_SPLIT = "";
sortie_Excel_tmp.CARTON_QTY = (String) row3.getClass().getField(Var.Fn_CARTON_QTY).get(row3) ;
sortie_Excel_tmp.ATTRIBUTE = "";
sortie_Excel_tmp.UNITS = "";
...
sortie_Excel_tmp.SMU_TYPE = "";
sortie_Excel_tmp.EAN = (String) row3.getClass().getField(Var.Fn_EAN).get(row3) ;
sortie_Excel_tmp.DELIVERYFLOW = (String) row3.getClass().getField(Var.Fn_DELIVERYFLOW).get(row3) ;
sortie_Excel_tmp.PRODUCT_CHANNEL = (String) row3.getClass().getField(Var.Fn_PRODUCTCHANNEL).get(row3) ;
sortie_Excel_tmp.SUSTAINABILITY = (String) row3.getClass().getField(Var.Fn_SUSTAINABILITY).get(row3) ;
...
validate_fields_tmp.STYLECOLORLABEL_NOT_FOUND = StringHandling.TRIM(sortie_Excel.STYLECOLORLABEL ) == "" || StringHandling.TRIM(sortie_Excel.STYLECOLORLABEL) == null ? "ERROR : BLANK FORBIDDEN" : ( !StringHandling.TRIM(sortie_Excel.STYLECOLORLABEL).equals( StringHandling.TRIM(sortie_Excel.STYLE ).concat("-").concat(StringHandling.TRIM(sortie_Excel.COLOR )).concat("-").concat(StringHandling.TRIM(sortie_Excel.LBL ) ) ) ? "ERROR : STYLE NOT WELL FORMATTED" : ""          ) ;
...
validate_fields_tmp.US_SIZE_NOT_FOUND = "";
...
validate_fields_tmp.PRODUCT_TIER_NOT_FOUND = "";
...
validate_fields_tmp.EAN = sortie_Excel.EAN ;
validate_fields_tmp.DELIVERYFLOW = sortie_Excel.DELIVERYFLOW ;
validate_fields_tmp.DELIVERYFLOW_NOT_FOUND = "";
validate_fields_tmp.PRODUCT_CHANNEL = sortie_Excel.PRODUCT_CHANNEL ;
validate_fields_tmp.PRODUCT_CHANNEL_NOT_FOUND = "";
validate_fields_tmp.SUSTAINABILITY = StringHandling.BTRIM(StringHandling.FTRIM(sortie_Excel.SUSTAINABILITY)) ;
validate_fields_tmp.SUSTAINABILITY_NOT_FOUND = StringHandling.TRIM(sortie_Excel.SUSTAINABILITY ) == "" || StringHandling.TRIM(sortie_Excel.SUSTAINABILITY) == null ? "" : ( StringHandling.DOWNCASE(StringHandling.TRIM(sortie_Excel.SUSTAINABILITY )).equals("x") || StringHandling.DOWNCASE(StringHandling.TRIM(sortie_Excel.SUSTAINABILITY )).equals("true")  || StringHandling.DOWNCASE(StringHandling.TRIM(sortie_Excel.SUSTAINABILITY )).equals("false")  || StringHandling.DOWNCASE(StringHandling.TRIM(sortie_Excel.SUSTAINABILITY )).equals("oui")  || StringHandling.DOWNCASE(StringHandling.TRIM(sortie_Excel.SUSTAINABILITY )).equals("non")  || 
StringHandling.DOWNCASE(StringHandling.TRIM(sortie_Excel.SUSTAINABILITY )).equals("vrai")  || StringHandling.DOWNCASE(StringHandling.TRIM(sortie_Excel.SUSTAINABILITY )).equals("faux")  || 
StringHandling.DOWNCASE(StringHandling.TRIM(sortie_Excel.SUSTAINABILITY )).equals("yes")  || StringHandling.DOWNCASE(StringHandling.TRIM(sortie_Excel.SUSTAINABILITY )).equals("no")  || 
StringHandling.DOWNCASE(StringHandling.TRIM(sortie_Excel.SUSTAINABILITY )).equals("0")  || StringHandling.DOWNCASE(StringHandling.TRIM(sortie_Excel.SUSTAINABILITY )).equals("1") ) ? "":"ERROR " + StringHandling.TRIM(sortie_Excel.SUSTAINABILITY ) ;
...
if(validate_fields != null) { 
    ...
    if (ope_tFilterRow_8.getMatchFlag()) {
              if(row32 == null){ 
               ...
               row32.EAN = validate_fields.EAN;
               row32.DELIVERYFLOW = validate_fields.DELIVERYFLOW;
               row32.DELIVERYFLOW_NOT_FOUND = validate_fields.DELIVERYFLOW_NOT_FOUND;
               row32.PRODUCT_CHANNEL = validate_fields.PRODUCT_CHANNEL;
               row32.PRODUCT_CHANNEL_NOT_FOUND = validate_fields.PRODUCT_CHANNEL_NOT_FOUND;
               row32.SUSTAINABILITY = validate_fields.SUSTAINABILITY;
               row32.SUSTAINABILITY_NOT_FOUND = validate_fields.SUSTAINABILITY_NOT_FOUND;    
...
sortie_tmp.FASHION = StringHandling.CHANGE(row10.FASHION ," - ","-").replaceAll (" ", " ") ;
...
sortie_tmp.PRODUCT = StringHandling.CHANGE(row10.PRODUCT ," - ","-").replaceAll (" ", " ") ;
...
sortie_tmp.EAN = row10.EAN ;
sortie_tmp.DELIVERYFLOW = row10.DELIVERYFLOW ;
sortie_tmp.DELIVERYFLOW_NOT_FOUND = row10.DELIVERYFLOW_NOT_FOUND ;
sortie_tmp.PRODUCT_CHANNEL = row10.PRODUCT_CHANNEL ;
sortie_tmp.PRODUCT_CHANNEL_NOT_FOUND = row10.PRODUCT_CHANNEL_NOT_FOUND ;
sortie_tmp.SUSTAINABILITY_NOT_FOUND = row10.SUSTAINABILITY_NOT_FOUND ;
sortie = sortie_tmp;

// # Output table : 'Dedoublonne'
Dedoublonne_tmp.STYLECOLORLABEL = row10.STYLECOLORLABEL ;
Dedoublonne_tmp.SIZE = row10.SIZE ;
Dedoublonne = Dedoublonne_tmp;
// ###############################
...
///////////////////////		
				...
				String[] row_tLogRow_4 = new String[79];
	    		...
	    		if(sortie.EAN != null) { //              
                 row_tLogRow_4[73]=    						    
				                String.valueOf(sortie.EAN)			
					          ;	
							
	    		} //			
    			   				
	    		if(sortie.DELIVERYFLOW != null) { //              
                 row_tLogRow_4[74]=    						    
				                String.valueOf(sortie.DELIVERYFLOW)			
					          ;	
							
	    		} //			
    			   				
	    		if(sortie.DELIVERYFLOW_NOT_FOUND != null) { //              
                 row_tLogRow_4[75]=    						    
				                String.valueOf(sortie.DELIVERYFLOW_NOT_FOUND)			
					          ;	
							
	    		} //			
    			   				
	    		if(sortie.PRODUCT_CHANNEL != null) { //              
                 row_tLogRow_4[76]=    						    
				                String.valueOf(sortie.PRODUCT_CHANNEL)			
					          ;	
							
	    		} //			
    			   				
	    		if(sortie.PRODUCT_CHANNEL_NOT_FOUND != null) { //              
                 row_tLogRow_4[77]=    						    
				                String.valueOf(sortie.PRODUCT_CHANNEL_NOT_FOUND)			
					          ;	
							
	    		} //			
    			   				
	    		if(sortie.SUSTAINABILITY_NOT_FOUND != null) { //              
                 row_tLogRow_4[78]=    						    
				                String.valueOf(sortie.SUSTAINABILITY_NOT_FOUND)			
					          ;	
...
sortie_Brand_tmp.lineNumber = row12.LINE_NUMBER ;
sortie_Brand_tmp.fileName = context.ExcelFileName;
sortie_Brand_tmp.creationDate = (String)globalMap.get("SQLDate");
...
sortie_Brand_tmp.DELIVERYFLOW = row12.DELIVERYFLOW ;
sortie_Brand_tmp.PRODUCT_CHANNEL = row12.PRODUCT_CHANNEL ;
...
if(sortie_Brand != null) { 
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
                    if(sortie_Brand.lineNumber == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(1, sortie_Brand.lineNumber);
}

                    if(sortie_Brand.fileName == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, sortie_Brand.fileName);
}

                    if(sortie_Brand.creationDate == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(3, sortie_Brand.creationDate);
}

                    if(sortie_Brand.BRAND == null) {
pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(4, sortie_Brand.BRAND);
}

                    if(sortie_Brand.SEASON == null) {
pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(5, sortie_Brand.SEASON);
}

                    if(sortie_Brand.CATEGORY == null) {
pstmt_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(6, sortie_Brand.CATEGORY);
}

                    if(sortie_Brand.REF == null) {
pstmt_tDBOutput_1.setNull(7, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(7, sortie_Brand.REF);
}

                    if(sortie_Brand.DESCRIPTION == null) {
pstmt_tDBOutput_1.setNull(8, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(8, sortie_Brand.DESCRIPTION);
}

                    if(sortie_Brand.STYLE == null) {
pstmt_tDBOutput_1.setNull(9, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(9, sortie_Brand.STYLE);
}

                    if(sortie_Brand.COLOR == null) {
pstmt_tDBOutput_1.setNull(10, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(10, sortie_Brand.COLOR);
}

                    if(sortie_Brand.FASHION == null) {
pstmt_tDBOutput_1.setNull(11, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(11, sortie_Brand.FASHION);
}

                    if(sortie_Brand.STYLECOLORLABEL == null) {
pstmt_tDBOutput_1.setNull(12, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(12, sortie_Brand.STYLECOLORLABEL);
}

                    if(sortie_Brand.COLORNAME == null) {
pstmt_tDBOutput_1.setNull(13, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(13, sortie_Brand.COLORNAME);
}

                    if(sortie_Brand.LBL == null) {
pstmt_tDBOutput_1.setNull(14, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(14, sortie_Brand.LBL);
}

                    if(sortie_Brand.STYLE_COLOR == null) {
pstmt_tDBOutput_1.setNull(15, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(15, sortie_Brand.STYLE_COLOR);
}

                    if(sortie_Brand.GENDER == null) {
pstmt_tDBOutput_1.setNull(16, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(16, sortie_Brand.GENDER);
}

                    if(sortie_Brand.AGE_RANGE == null) {
pstmt_tDBOutput_1.setNull(17, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(17, sortie_Brand.AGE_RANGE);
}

                    if(sortie_Brand.SIZE_RANGE == null) {
pstmt_tDBOutput_1.setNull(18, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(18, sortie_Brand.SIZE_RANGE);
}

                    if(sortie_Brand.SIZE == null) {
pstmt_tDBOutput_1.setNull(19, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(19, sortie_Brand.SIZE);
}

                    if(sortie_Brand.US_SIZE == null) {
pstmt_tDBOutput_1.setNull(20, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(20, sortie_Brand.US_SIZE);
}

                    if(sortie_Brand.CM_SIZE == null) {
pstmt_tDBOutput_1.setNull(21, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(21, sortie_Brand.CM_SIZE);
}

                    if(sortie_Brand.PRODUCT == null) {
pstmt_tDBOutput_1.setNull(22, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(22, sortie_Brand.PRODUCT);
}

                    if(sortie_Brand.PRODUCT_STATUS == null) {
pstmt_tDBOutput_1.setNull(23, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(23, sortie_Brand.PRODUCT_STATUS);
}

                    if(sortie_Brand.PRODUCT_TIER == null) {
pstmt_tDBOutput_1.setNull(24, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(24, sortie_Brand.PRODUCT_TIER);
}

                    if(sortie_Brand.ACCT_EXCLUS == null) {
pstmt_tDBOutput_1.setNull(25, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(25, sortie_Brand.ACCT_EXCLUS);
}

                    if(sortie_Brand.CARTON_QTY == null) {
pstmt_tDBOutput_1.setNull(26, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(26, sortie_Brand.CARTON_QTY);
}

                    if(sortie_Brand.EUR_RRP == null) {
pstmt_tDBOutput_1.setNull(27, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(27, sortie_Brand.EUR_RRP);
}

                    if(sortie_Brand.EUR_WSP == null) {
pstmt_tDBOutput_1.setNull(28, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(28, sortie_Brand.EUR_WSP);
}

                    if(sortie_Brand.GBP_RRP == null) {
pstmt_tDBOutput_1.setNull(29, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(29, sortie_Brand.GBP_RRP);
}

                    if(sortie_Brand.GBP_WSP == null) {
pstmt_tDBOutput_1.setNull(30, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(30, sortie_Brand.GBP_WSP);
}

                    if(sortie_Brand.CHF_RRP == null) {
pstmt_tDBOutput_1.setNull(31, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(31, sortie_Brand.CHF_RRP);
}

                    if(sortie_Brand.CHF_WSP == null) {
pstmt_tDBOutput_1.setNull(32, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(32, sortie_Brand.CHF_WSP);
}

                    if(sortie_Brand.NOK_RRP == null) {
pstmt_tDBOutput_1.setNull(33, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(33, sortie_Brand.NOK_RRP);
}

                    if(sortie_Brand.NOK_WSP == null) {
pstmt_tDBOutput_1.setNull(34, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(34, sortie_Brand.NOK_WSP);
}

                    if(sortie_Brand.DKK_RRP == null) {
pstmt_tDBOutput_1.setNull(35, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(35, sortie_Brand.DKK_RRP);
}

                    if(sortie_Brand.DKK_WSP == null) {
pstmt_tDBOutput_1.setNull(36, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(36, sortie_Brand.DKK_WSP);
}

                    if(sortie_Brand.SEK_RRP == null) {
pstmt_tDBOutput_1.setNull(37, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(37, sortie_Brand.SEK_RRP);
}

                    if(sortie_Brand.SEK_WSP == null) {
pstmt_tDBOutput_1.setNull(38, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(38, sortie_Brand.SEK_WSP);
}

                    if(sortie_Brand.EUR_FINN_RRP == null) {
pstmt_tDBOutput_1.setNull(39, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(39, sortie_Brand.EUR_FINN_RRP);
}

                    if(sortie_Brand.EUR_FINN_WSP == null) {
pstmt_tDBOutput_1.setNull(40, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(40, sortie_Brand.EUR_FINN_WSP);
}

                    if(sortie_Brand.FABRICATION == null) {
pstmt_tDBOutput_1.setNull(41, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(41, sortie_Brand.FABRICATION);
}

                    if(sortie_Brand.COO == null) {
pstmt_tDBOutput_1.setNull(42, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(42, sortie_Brand.COO);
}

                    if(sortie_Brand.CUSTOM_TARIFF_CODE == null) {
pstmt_tDBOutput_1.setNull(43, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(43, sortie_Brand.CUSTOM_TARIFF_CODE);
}

                    if(sortie_Brand.UPC == null) {
pstmt_tDBOutput_1.setNull(44, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(44, sortie_Brand.UPC);
}

                    if(sortie_Brand.DELIVERYFLOW == null) {
pstmt_tDBOutput_1.setNull(45, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(45, sortie_Brand.DELIVERYFLOW);
}

                    if(sortie_Brand.PRODUCT_CHANNEL == null) {
pstmt_tDBOutput_1.setNull(46, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(46, sortie_Brand.PRODUCT_CHANNEL);
}
...
if(Dedoublonne != null) { 
	...
	currentComponent="tUniqRow_1";
					...
					if(execStat){
						runStat.updateStatOnConnection(iterateId,1,1,"Dedoublonne");
					}
					
row37 = null;			
if(Dedoublonne.STYLECOLORLABEL == null){
	finder_tUniqRow_1.STYLECOLORLABEL = null;
}else{
	finder_tUniqRow_1.STYLECOLORLABEL = Dedoublonne.STYLECOLORLABEL.toLowerCase();
}
if(Dedoublonne.SIZE == null){
	finder_tUniqRow_1.SIZE = null;
}else{
	finder_tUniqRow_1.SIZE = Dedoublonne.SIZE.toLowerCase();
}	
...
if(Dedoublonne.STYLECOLORLABEL == null){
	new_tUniqRow_1.STYLECOLORLABEL = null;
}else{
	new_tUniqRow_1.STYLECOLORLABEL = Dedoublonne.STYLECOLORLABEL.toLowerCase();
}
if(Dedoublonne.SIZE == null){
	new_tUniqRow_1.SIZE = null;
}else{
	new_tUniqRow_1.SIZE = Dedoublonne.SIZE.toLowerCase();
}
...
}				row37.STYLECOLORLABEL = Dedoublonne.STYLECOLORLABEL;			row37.SIZE = Dedoublonne.SIZE;			
...
if(row37 != null) { 
	...
	currentComponent="tHashOutput_1";
		...
		row37Struct oneRow_tHashOutput_1 = new row37Struct();
				
					oneRow_tHashOutput_1.STYLECOLORLABEL = row37.STYLECOLORLABEL;
					oneRow_tHashOutput_1.SIZE = row37.SIZE;
...
globalMap.put("tUniqRow_1_NB_DUPLICATES",nb_duplicates_tUniqRow_1);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"Dedoublonne");
			  	}
...
try {
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_1", "", Thread.currentThread().getId() + "", "INFO","","Line inserted in SQL : " + ((Integer)globalMap.get("tDBOutput_1_NB_LINE"))+  " " + context.SQLSERVER_Database +  " " + context.SQLSERVER_LOG_Server,"", "");
	talendLogs_LOGS.addMessage("tWarn", "tWarn_1", 3, "Line inserted in SQL : " + ((Integer)globalMap.get("tDBOutput_1_NB_LINE"))+  " " + context.SQLSERVER_Database +  " " + context.SQLSERVER_LOG_Server, 3);
	talendLogs_LOGSProcess(globalMap);
	globalMap.put("tWarn_1_WARN_MESSAGES", "Line inserted in SQL : " + ((Integer)globalMap.get("tDBOutput_1_NB_LINE"))+  " " + context.SQLSERVER_Database +  " " + context.SQLSERVER_LOG_Server); 
...
globalMap.put("SQLDate",  TalendDate.formatDate("yyyy-MM-dd HH:mm:ss", new Date()) );
...
new org.apache.poi.xssf.usermodel.XSSFWorkbook(context.IntegrationExcelPath + context.ExcelFileName);


System.out.println(workbook1.getSheetName(0));

context.excelSheetName = workbook1.getSheetName(0);
...
sortie_color_mapStruct sortie_color_map = new sortie_color_mapStruct();
	...
	currentComponent="tAdvancedHash_sortie_color_map";
		...
		int tos_count_tAdvancedHash_sortie_color_map = 0;
			   		...
			   		// linked node: tMap_2 - inputs:(row10,sortie_color_map) outputs:(sortie,Dedoublonne)
...
try {
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_2", "", Thread.currentThread().getId() + "", "INFO","","Start job","", "");
	talendLogs_LOGS.addMessage("tWarn", "tWarn_2", 3, "Start job", 3);
	talendLogs_LOGSProcess(globalMap);
	globalMap.put("tWarn_2_WARN_MESSAGES", "Start job"); 
 ...
 */
    ...
    public static void main(String[] args){
        final MASTERFILE_EXCEL_TO_SQLSERVER MASTERFILE_EXCEL_TO_SQLSERVERClass = new MASTERFILE_EXCEL_TO_SQLSERVER();

        int exitCode = MASTERFILE_EXCEL_TO_SQLSERVERClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = MASTERFILE_EXCEL_TO_SQLSERVER.class.getClassLoader().getResourceAsStream("dev/masterfile_excel_to_sqlserver_0_10/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = MASTERFILE_EXCEL_TO_SQLSERVER.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
            ...
            class ContextProcessing {
                private void processContext_0() {
                        ...
                        context.setContextType("SQLSERVERSCHEMA_MASTERFILE_Login", "id_String");
                            context.SQLSERVERSCHEMA_MASTERFILE_Login=(String) context.getProperty("SQLSERVERSCHEMA_MASTERFILE_Login");
                        context.setContextType("SQLSERVERSCHEMA_MASTERFILE_AdditionalParams", "id_String");
                            context.SQLSERVERSCHEMA_MASTERFILE_AdditionalParams=(String) context.getProperty("SQLSERVERSCHEMA_MASTERFILE_AdditionalParams");
                        context.setContextType("SQLSERVERSCHEMA_MASTERFILE_Password", "id_Password");
                            String pwd_SQLSERVERSCHEMA_MASTERFILE_Password_value = context.getProperty("SQLSERVERSCHEMA_MASTERFILE_Password");
                            context.SQLSERVERSCHEMA_MASTERFILE_Password = null;
                            if(pwd_SQLSERVERSCHEMA_MASTERFILE_Password_value!=null) {
                                if(context_param.containsKey("SQLSERVERSCHEMA_MASTERFILE_Password")) {//no need to decrypt if it come from program argument or parent job runtime
                                    ...
                                    try {
                                        context.SQLSERVERSCHEMA_MASTERFILE_Password = routines.system.PasswordEncryptUtil.decryptPassword(pwd_SQLSERVERSCHEMA_MASTERFILE_Password_value);
                                        context.put("SQLSERVERSCHEMA_MASTERFILE_Password",context.SQLSERVERSCHEMA_MASTERFILE_Password);
                                    } catch (java.lang.RuntimeException e) {
                                        //do nothing
                                    }
                                }
                        ...
                        context.setContextType("SQLSERVERSCHEMA_MASTERFILE_Port", "id_String");
                            context.SQLSERVERSCHEMA_MASTERFILE_Port=(String) context.getProperty("SQLSERVERSCHEMA_MASTERFILE_Port");
                        context.setContextType("SQLSERVERSCHEMA_MASTERFILE_Database", "id_String");
                            context.SQLSERVERSCHEMA_MASTERFILE_Database=(String) context.getProperty("SQLSERVERSCHEMA_MASTERFILE_Database");
                        context.setContextType("SQLSERVERSCHEMA_MASTERFILE_Schema", "id_String");
                            context.SQLSERVERSCHEMA_MASTERFILE_Schema=(String) context.getProperty("SQLSERVERSCHEMA_MASTERFILE_Schema");
                        context.setContextType("SQLSERVERSCHEMA_MASTERFILE_Server", "id_String");
                            context.SQLSERVERSCHEMA_MASTERFILE_Server=(String) context.getProperty("SQLSERVERSCHEMA_MASTERFILE_Server");
                } 
        ...
        if (parentContextMap != null && !parentContextMap.isEmpty()) {if (parentContextMap.containsKey("ErrorHeader")) {
                ...
                context.SQLSERVERSCHEMA_MASTERFILE_Login = (String) parentContextMap.get("SQLSERVERSCHEMA_MASTERFILE_Login");
            }if (parentContextMap.containsKey("SQLSERVERSCHEMA_MASTERFILE_AdditionalParams")) {
                context.SQLSERVERSCHEMA_MASTERFILE_AdditionalParams = (String) parentContextMap.get("SQLSERVERSCHEMA_MASTERFILE_AdditionalParams");
            }if (parentContextMap.containsKey("SQLSERVERSCHEMA_MASTERFILE_Password")) {
                context.SQLSERVERSCHEMA_MASTERFILE_Password = (java.lang.String) parentContextMap.get("SQLSERVERSCHEMA_MASTERFILE_Password");
            }if (parentContextMap.containsKey("SQLSERVERSCHEMA_MASTERFILE_Port")) {
                context.SQLSERVERSCHEMA_MASTERFILE_Port = (String) parentContextMap.get("SQLSERVERSCHEMA_MASTERFILE_Port");
            }if (parentContextMap.containsKey("SQLSERVERSCHEMA_MASTERFILE_Database")) {
                context.SQLSERVERSCHEMA_MASTERFILE_Database = (String) parentContextMap.get("SQLSERVERSCHEMA_MASTERFILE_Database");
            }if (parentContextMap.containsKey("SQLSERVERSCHEMA_MASTERFILE_Schema")) {
                context.SQLSERVERSCHEMA_MASTERFILE_Schema = (String) parentContextMap.get("SQLSERVERSCHEMA_MASTERFILE_Schema");
            }if (parentContextMap.containsKey("SQLSERVERSCHEMA_MASTERFILE_Server")) {
                context.SQLSERVERSCHEMA_MASTERFILE_Server = (String) parentContextMap.get("SQLSERVERSCHEMA_MASTERFILE_Server");
            }
        }
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : MASTERFILE_EXCEL_TO_SQLSERVER");
        }
...
/************************************************************************************************
 *     678275 characters generated by Talend Open Studio for Data Integration 
 *     on the 14 février 2023 09:31:42 CET
 ************************************************************************************************/