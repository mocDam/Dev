...
package dev.verification_integration_bdd_0_37;
...
/**
 * Job: VERIFICATION_INTEGRATION_BDD Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20191031_1204-M3
 * @status 
 */
public class VERIFICATION_INTEGRATION_BDD implements TalendJob {
...
public Boolean getInsertSQLMode(){
	...
	private final String jobName = "VERIFICATION_INTEGRATION_BDD";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				VERIFICATION_INTEGRATION_BDD.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(VERIFICATION_INTEGRATION_BDD.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row18Struct implements routines.system.IPersistableRow<row18Struct> {
    final static byte[] commonByteArrayLock_DEV_VERIFICATION_INTEGRATION_BDD = new byte[0];
    static byte[] commonByteArray_DEV_VERIFICATION_INTEGRATION_BDD = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_DEV_VERIFICATION_INTEGRATION_BDD.length) {
				if(length < 1024 && commonByteArray_DEV_VERIFICATION_INTEGRATION_BDD.length == 0) {
   					commonByteArray_DEV_VERIFICATION_INTEGRATION_BDD = new byte[1024];
				} else {
   					commonByteArray_DEV_VERIFICATION_INTEGRATION_BDD = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_DEV_VERIFICATION_INTEGRATION_BDD, 0, length);
			strReturn = new String(commonByteArray_DEV_VERIFICATION_INTEGRATION_BDD, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_DEV_VERIFICATION_INTEGRATION_BDD) {
...
java.io.File file_tFileExist_1 = new java.io.File(context.IntegrationPath + ((String)globalMap.get("tFileList_1_CURRENT_FILE")));
...
globalMap.put("tFileExist_1_FILENAME",context.IntegrationPath + ((String)globalMap.get("tFileList_1_CURRENT_FILE")));
...
class DeleteFoldertFileDelete_1{
    ...
    java.io.File file_tFileDelete_1=new java.io.File(context.IntegrationPath + ((String)globalMap.get("tFileList_1_CURRENT_FILE")));
	...
	globalMap.put("tFileDelete_1_DELETE_PATH",context.IntegrationPath + ((String)globalMap.get("tFileList_1_CURRENT_FILE")));
...
try {
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_10", "", Thread.currentThread().getId() + "", "INFO","","Delete excel file : " + ((String)globalMap.get("tFileList_1_CURRENT_FILE")),"", "");
	talendLogs_LOGS.addMessage("tWarn", "tWarn_10", 3, "Delete excel file : " + ((String)globalMap.get("tFileList_1_CURRENT_FILE")), 3);
	talendLogs_LOGSProcess(globalMap);
	globalMap.put("tWarn_10_WARN_MESSAGES", "Delete excel file : " + ((String)globalMap.get("tFileList_1_CURRENT_FILE"))); 
...
try {
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_6", "", Thread.currentThread().getId() + "", "INFO","","Job terminé","", "");
...
try {
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_8", "", Thread.currentThread().getId() + "", "INFO","","Job terminé","", "");
	...
	logIgnoredError(String.format("tWarn_8 - tWarn failed to log message due to internal error: %s", e_tWarn_8), e_tWarn_8);
}
...
java.io.File file_tFileExist_7 = new java.io.File(context.IntegrationPath + ((String)globalMap.get("tFileList_1_CURRENT_FILE")));
...
globalMap.put("tFileExist_7_FILENAME",context.IntegrationPath + ((String)globalMap.get("tFileList_1_CURRENT_FILE")));
 ...
 */
	...
	currentComponent="tFileCopy_9";
        ...
        String srcFileName_tFileCopy_9 = context.IntegrationPath + ((String)globalMap.get("tFileList_1_CURRENT_FILE"));
		...
		String desFileName_tFileCopy_9 =  globalMap.get("dateError")  + "_" + ((String)globalMap.get("tFileList_1_CURRENT_FILE")) ;
		...
		if (!srcFile_tFileCopy_9.getPath().equals(desFile_tFileCopy_9.getPath())  ) {
				...
				java.io.File isRemoved_tFileCopy_9 = new java.io.File(context.IntegrationPath + ((String)globalMap.get("tFileList_1_CURRENT_FILE")));
...
try {
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_9", "", Thread.currentThread().getId() + "", "ERROR","","Job en erreur","", "");
 ...
 */
	...
	Object obj_tRunJob_4 = null;
		...
		if(obj_tRunJob_4!=null) {
			paraList_tRunJob_4.add("--context_param Subject=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_4));
		} else {
			paraList_tRunJob_4.add("--context_param Subject=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		...
		if(obj_tRunJob_4!=null) {
			paraList_tRunJob_4.add("--context_param Content=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_4));
		} else {
			paraList_tRunJob_4.add("--context_param Content=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		...
		if(obj_tRunJob_4!=null) {
			paraList_tRunJob_4.add("--context_param AttachmentsList=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_4));
		} else {
			paraList_tRunJob_4.add("--context_param AttachmentsList=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		...
		if(obj_tRunJob_4!=null) {
			paraList_tRunJob_4.add("--context_param ToAddress=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_4));
		} else {
			paraList_tRunJob_4.add("--context_param ToAddress=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
...
java.io.File file_tFileExist_2 = new java.io.File(context.IntegrationPath + ((String)globalMap.get("tFileList_1_CURRENT_FILE")));
...
globalMap.put("tFileExist_2_FILENAME",context.IntegrationPath + ((String)globalMap.get("tFileList_1_CURRENT_FILE")));
...
try {
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_2", "", Thread.currentThread().getId() + "", "INFO","","Validation OK","", "");
 ...
 */
	...
	java.util.List<String> paraList_tRunJob_2 = new java.util.ArrayList<String>();
			...
			if (osName_tRunJob_2 != null && osName_tRunJob_2.toLowerCase().startsWith("win")){
		      			...
		      			paraList_tRunJob_2.add("java");
		      					...
		      					jvm_argument_helper_tRunJob_2.addArgumentsTo(paraList_tRunJob_2, "-Dmail.smtp.ssl.protocols=TLSv1.2");
		      				
		      					jvm_argument_helper_tRunJob_2.addArgumentsTo(paraList_tRunJob_2, "-cp");
		      				
		        				jvm_argument_helper_tRunJob_2.addArgumentsTo(paraList_tRunJob_2, dealChildJobLibrary_tRunJob_2.replaceJarPathsFromCrcMap(".;../lib/routines.jar;../lib/advancedPersistentLookupLib-1.2.jar;../lib/commons-collections-3.2.2.jar;../lib/commons-collections4-4.1.jar;../lib/commons-compress-1.19.jar;../lib/commons-lang3-3.8.1.jar;../lib/commons-math3-3.6.1.jar;../lib/crypto-utils.jar;../lib/dom4j-1.6.1.jar;../lib/geronimo-stax-api_1.0_spec-1.0.1.jar;../lib/jboss-serialization.jar;../lib/log4j-1.2.17.jar;../lib/mssql-jdbc.jar;../lib/poi-4.1.0-20190523141255_modified_talend.jar;../lib/poi-ooxml-4.1.0-20190523141255_modified_talend.jar;../lib/poi-ooxml-schemas-4.1.0-20190523141255_modified_talend.jar;../lib/poi-scratchpad-4.1.0-20190523141255_modified_talend.jar;../lib/simpleexcel-2.2-20190722.jar;../lib/talendExcel-1.5-20190731.jar;../lib/talend_DB_mssqlUtil-1.3-20190523.jar;../lib/talend_file_enhanced_20070724.jar;../lib/thashfile-3.1-20190910.jar;../lib/trove.jar;../lib/xmlbeans-3.1.0.jar;masterfile_excel_to_sqlserver_0_10.jar;"));
		      				
		      					jvm_argument_helper_tRunJob_2.addArgumentsTo(paraList_tRunJob_2, "dev.masterfile_excel_to_sqlserver_0_10.MASTERFILE_EXCEL_TO_SQLSERVER");
						...
						paraList_tRunJob_2.add("java");
								...
								jvm_argument_helper_tRunJob_2.addArgumentsTo(paraList_tRunJob_2, dealChildJobLibrary_tRunJob_2.replaceJarPathsFromCrcMap(".:$ROOT_PATH:$ROOT_PATH/../lib/routines.jar:$ROOT_PATH/../lib/advancedPersistentLookupLib-1.2.jar:$ROOT_PATH/../lib/commons-collections-3.2.2.jar:$ROOT_PATH/../lib/commons-collections4-4.1.jar:$ROOT_PATH/../lib/commons-compress-1.19.jar:$ROOT_PATH/../lib/commons-lang3-3.8.1.jar:$ROOT_PATH/../lib/commons-math3-3.6.1.jar:$ROOT_PATH/../lib/crypto-utils.jar:$ROOT_PATH/../lib/dom4j-1.6.1.jar:$ROOT_PATH/../lib/geronimo-stax-api_1.0_spec-1.0.1.jar:$ROOT_PATH/../lib/jboss-serialization.jar:$ROOT_PATH/../lib/log4j-1.2.17.jar:$ROOT_PATH/../lib/mssql-jdbc.jar:$ROOT_PATH/../lib/poi-4.1.0-20190523141255_modified_talend.jar:$ROOT_PATH/../lib/poi-ooxml-4.1.0-20190523141255_modified_talend.jar:$ROOT_PATH/../lib/poi-ooxml-schemas-4.1.0-20190523141255_modified_talend.jar:$ROOT_PATH/../lib/poi-scratchpad-4.1.0-20190523141255_modified_talend.jar:$ROOT_PATH/../lib/simpleexcel-2.2-20190722.jar:$ROOT_PATH/../lib/talendExcel-1.5-20190731.jar:$ROOT_PATH/../lib/talend_DB_mssqlUtil-1.3-20190523.jar:$ROOT_PATH/../lib/talend_file_enhanced_20070724.jar:$ROOT_PATH/../lib/thashfile-3.1-20190910.jar:$ROOT_PATH/../lib/trove.jar:$ROOT_PATH/../lib/xmlbeans-3.1.0.jar:$ROOT_PATH/masterfile_excel_to_sqlserver_0_10.jar:").replace("$ROOT_PATH",System.getProperty("user.dir")));
	...
	Object obj_tRunJob_2 = null;
		...
		if(obj_tRunJob_2!=null) {
			paraList_tRunJob_2.add("--context_param errorFile=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_2));
		} else {
			paraList_tRunJob_2.add("--context_param errorFile=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
...
try {
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_3", "", Thread.currentThread().getId() + "", "INFO","","Insert to SQL OK","", "");
...
try {
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_12", "", Thread.currentThread().getId() + "", "ERROR","","Validation KO. Check file : " + context.LogPath + globalMap.get("dateError") + "_ERROR_" + ((String)globalMap.get("tFileList_1_CURRENT_FILE")),"", "");
	talendLogs_LOGS.addMessage("tWarn", "tWarn_12", 5, "Validation KO. Check file : " + context.LogPath + globalMap.get("dateError") + "_ERROR_" + ((String)globalMap.get("tFileList_1_CURRENT_FILE")), 4);
	talendLogs_LOGSProcess(globalMap);
	globalMap.put("tWarn_12_WARN_MESSAGES", "Validation KO. Check file : " + context.LogPath + globalMap.get("dateError") + "_ERROR_" + ((String)globalMap.get("tFileList_1_CURRENT_FILE"))); 
...
try {
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_13", "", Thread.currentThread().getId() + "", "ERROR","","Job en erreur","", "");
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		obj_tRunJob_3 = context.LogPath + globalMap.get("dateError") + "_ERROR_" + ((String)globalMap.get("tFileList_1_CURRENT_FILE"));
		if(obj_tRunJob_3!=null) {
			paraList_tRunJob_3.add("--context_param AttachmentsList=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_3));
		} else {
			paraList_tRunJob_3.add("--context_param AttachmentsList=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
...
java.io.File file_tFileProperties_1 = new java.io.File(context.IntegrationPath +((String)globalMap.get("tFileList_1_CURRENT_FILE")));
row1 = new row1Struct();
...
try {
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_7", "", Thread.currentThread().getId() + "", "INFO","","File size : " + globalMap.get("fileSize"),"", "");
 ...
 */
	...
	java.util.List<String> paraList_tRunJob_1 = new java.util.ArrayList<String>();
			...
			if (osName_tRunJob_1 != null && osName_tRunJob_1.toLowerCase().startsWith("win")){
		      			...
		      			paraList_tRunJob_1.add("java");
		        				...
		        				jvm_argument_helper_tRunJob_1.addArgumentsTo(paraList_tRunJob_1, dealChildJobLibrary_tRunJob_1.replaceJarPathsFromCrcMap(".;../lib/routines.jar;../lib/advancedPersistentLookupLib-1.2.jar;../lib/commons-collections-3.2.2.jar;../lib/commons-collections4-4.1.jar;../lib/commons-compress-1.19.jar;../lib/commons-lang3-3.8.1.jar;../lib/commons-math3-3.6.1.jar;../lib/crypto-utils.jar;../lib/dom4j-1.6.1.jar;../lib/filecopy.jar;../lib/geronimo-stax-api_1.0_spec-1.0.1.jar;../lib/jboss-serialization.jar;../lib/log4j-1.2.17.jar;../lib/mssql-jdbc.jar;../lib/poi-4.1.0-20190523141255_modified_talend.jar;../lib/poi-ooxml-4.1.0-20190523141255_modified_talend.jar;../lib/poi-ooxml-schemas-4.1.0-20190523141255_modified_talend.jar;../lib/poi-scratchpad-4.1.0-20190523141255_modified_talend.jar;../lib/simpleexcel-2.2-20190722.jar;../lib/talendExcel-1.5-20190731.jar;../lib/talend_DB_mssqlUtil-1.3-20190523.jar;../lib/talend_file_enhanced_20070724.jar;../lib/talendcsv.jar;../lib/thashfile-3.1-20190910.jar;../lib/trove.jar;../lib/xmlbeans-3.1.0.jar;buy_validation_0_11.jar;"));
		      				
		      					jvm_argument_helper_tRunJob_1.addArgumentsTo(paraList_tRunJob_1, "dev.buy_validation_0_11.BUY_VALIDATION");
						...
						paraList_tRunJob_1.add("java");
								...
								jvm_argument_helper_tRunJob_1.addArgumentsTo(paraList_tRunJob_1, dealChildJobLibrary_tRunJob_1.replaceJarPathsFromCrcMap(".:$ROOT_PATH:$ROOT_PATH/../lib/routines.jar:$ROOT_PATH/../lib/advancedPersistentLookupLib-1.2.jar:$ROOT_PATH/../lib/commons-collections-3.2.2.jar:$ROOT_PATH/../lib/commons-collections4-4.1.jar:$ROOT_PATH/../lib/commons-compress-1.19.jar:$ROOT_PATH/../lib/commons-lang3-3.8.1.jar:$ROOT_PATH/../lib/commons-math3-3.6.1.jar:$ROOT_PATH/../lib/crypto-utils.jar:$ROOT_PATH/../lib/dom4j-1.6.1.jar:$ROOT_PATH/../lib/filecopy.jar:$ROOT_PATH/../lib/geronimo-stax-api_1.0_spec-1.0.1.jar:$ROOT_PATH/../lib/jboss-serialization.jar:$ROOT_PATH/../lib/log4j-1.2.17.jar:$ROOT_PATH/../lib/mssql-jdbc.jar:$ROOT_PATH/../lib/poi-4.1.0-20190523141255_modified_talend.jar:$ROOT_PATH/../lib/poi-ooxml-4.1.0-20190523141255_modified_talend.jar:$ROOT_PATH/../lib/poi-ooxml-schemas-4.1.0-20190523141255_modified_talend.jar:$ROOT_PATH/../lib/poi-scratchpad-4.1.0-20190523141255_modified_talend.jar:$ROOT_PATH/../lib/simpleexcel-2.2-20190722.jar:$ROOT_PATH/../lib/talendExcel-1.5-20190731.jar:$ROOT_PATH/../lib/talend_DB_mssqlUtil-1.3-20190523.jar:$ROOT_PATH/../lib/talend_file_enhanced_20070724.jar:$ROOT_PATH/../lib/talendcsv.jar:$ROOT_PATH/../lib/thashfile-3.1-20190910.jar:$ROOT_PATH/../lib/trove.jar:$ROOT_PATH/../lib/xmlbeans-3.1.0.jar:$ROOT_PATH/buy_validation_0_11.jar:").replace("$ROOT_PATH",System.getProperty("user.dir")));
	...
	Object obj_tRunJob_1 = null;
		...
		if(obj_tRunJob_1!=null) {
			paraList_tRunJob_1.add("--context_param dateError=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_1));
		} else {
			paraList_tRunJob_1.add("--context_param dateError=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
...
try {
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_5", "", Thread.currentThread().getId() + "", "ERROR","","File Size KO","", "");
...
java.io.File file_tFileExist_6 = new java.io.File(context.IntegrationPath + ((String)globalMap.get("tFileList_1_CURRENT_FILE")));
...
globalMap.put("tFileExist_6_FILENAME",context.IntegrationPath + ((String)globalMap.get("tFileList_1_CURRENT_FILE")));
 ...
 */
	...
	currentComponent="tFileCopy_10";
        ...
        String srcFileName_tFileCopy_10 = context.IntegrationPath + ((String)globalMap.get("tFileList_1_CURRENT_FILE"));
		...
		String desFileName_tFileCopy_10 =  globalMap.get("dateError")  + "_" + ((String)globalMap.get("tFileList_1_CURRENT_FILE")) ;
		...
		if (!srcFile_tFileCopy_10.getPath().equals(desFile_tFileCopy_10.getPath())  ) {
				...
				java.io.File isRemoved_tFileCopy_10 = new java.io.File(context.IntegrationPath + ((String)globalMap.get("tFileList_1_CURRENT_FILE")));
...
try {
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_1", "", Thread.currentThread().getId() + "", "INFO","","Initialization fichier : " +  ((String)globalMap.get("tFileList_1_CURRENT_FILE")),"", "");
	talendLogs_LOGS.addMessage("tWarn", "tWarn_1", 3, "Initialization fichier : " +  ((String)globalMap.get("tFileList_1_CURRENT_FILE")), 3);
	talendLogs_LOGSProcess(globalMap);
	globalMap.put("tWarn_1_WARN_MESSAGES", "Initialization fichier : " +  ((String)globalMap.get("tFileList_1_CURRENT_FILE"))); 
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_7 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
            class ContextProcessor_tRunJob_7 {
                    ...
                    parentContextMap_tRunJob_7.put("ExtractPath", context.ExtractPath);
                    paraList_tRunJob_7.add("--context_type " + "ExtractPath" + "=" + "id_String");
                    parentContextMap_tRunJob_7.put("ExtractPathFinal", context.ExtractPathFinal);
                    paraList_tRunJob_7.add("--context_type " + "ExtractPathFinal" + "=" + "id_String");
                    parentContextMap_tRunJob_7.put("ModelFilePath", context.ModelFilePath);
                    paraList_tRunJob_7.add("--context_type " + "ModelFilePath" + "=" + "id_String");
                    parentContextMap_tRunJob_7.put("ExtractPathPrice", context.ExtractPathPrice);
                    paraList_tRunJob_7.add("--context_type " + "ExtractPathPrice" + "=" + "id_String");
                    parentContextMap_tRunJob_7.put("ExtractPathHBE", context.ExtractPathHBE);
                    paraList_tRunJob_7.add("--context_type " + "ExtractPathHBE" + "=" + "id_String");
                    parentContextMap_tRunJob_7.put("ExtractPathOTHER", context.ExtractPathOTHER);
                    paraList_tRunJob_7.add("--context_type " + "ExtractPathOTHER" + "=" + "id_String");
                    ...
                    parentContextMap_tRunJob_7.put("SQLSERVER_LOG_AdditionalParams", context.SQLSERVER_LOG_AdditionalParams);
                    paraList_tRunJob_7.add("--context_type " + "SQLSERVER_LOG_AdditionalParams" + "=" + "id_String");
...
try {
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_4", "", Thread.currentThread().getId() + "", "INFO","","Search recipient OK","", "");
...
String fileName_tFileOutputDelimited_3 = "";
    fileName_tFileOutputDelimited_3 = (new java.io.File(context.LogPath + ((String)globalMap.get("LogFile")))).getAbsolutePath().replace("\\","/");
...
try {
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_11", "", Thread.currentThread().getId() + "", "INFO","","Start job","", "");
 ...
 */
    ...
    public static void main(String[] args){
        final VERIFICATION_INTEGRATION_BDD VERIFICATION_INTEGRATION_BDDClass = new VERIFICATION_INTEGRATION_BDD();

        int exitCode = VERIFICATION_INTEGRATION_BDDClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = VERIFICATION_INTEGRATION_BDD.class.getClassLoader().getResourceAsStream("dev/verification_integration_bdd_0_37/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = VERIFICATION_INTEGRATION_BDD.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
            ...
            class ContextProcessing {
                private void processContext_0() {
                        ...
                        context.setContextType("insertSQLMode", "id_Boolean");
                            try{
                                context.insertSQLMode=routines.system.ParserUtils.parseTo_Boolean (context.getProperty("insertSQLMode"));
                            } catch(NumberFormatException e){
                                System.err.println(String.format("Null value will be used for context parameter %s: %s", "insertSQLMode", e.getMessage()));
...
try {
errorCode = null;tWarn_11Process(globalMap);
if(!"failure".equals(status)) { status = "end"; }
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : VERIFICATION_INTEGRATION_BDD");
        }
...
/************************************************************************************************
 *     302356 characters generated by Talend Open Studio for Data Integration 
 *     on the 14 février 2023 09:31:47 CET
 ************************************************************************************************/