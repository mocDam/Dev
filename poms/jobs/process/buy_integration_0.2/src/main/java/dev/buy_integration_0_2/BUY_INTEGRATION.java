...
package dev.buy_integration_0_2;
...
private class TalendException extends Exception {
	...
	public void printStackTrace() {
		...
		try {
			...
			public void tSleep_3_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
...
resumeUtil.addLog("SYSTEM_LOG", "NODE:"+ errorComponent, "", Thread.currentThread().getId()+ "", "FATAL", "", exception.getMessage(), ResumeUtil.getExceptionStackTrace(exception),"");
			...
			public void tForeach_1_onSubJobError(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {

resumeUtil.addLog("SYSTEM_LOG", "NODE:"+ errorComponent, "", Thread.currentThread().getId()+ "", "FATAL", "", exception.getMessage(), ResumeUtil.getExceptionStackTrace(exception),"");

			}
			public void tSleep_3_onSubJobError(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
...
Object[] values_tForeach_1 = new Object[]{
    "Currencies.xlsx",
    "Colors.xlsx",
    "K3 Fashion - Brands.xlsx",
    "K3 Fashion - Product status setup.xlsx",
    "K3 Fashion - Retail seasons.xlsx",
    "K3 fashion - Sales Order category.xlsx",
    "Product attribute enumeration types.xlsx",
    "Product categories.xlsx",
    "region translations.xlsx",
    "RetailProductHierarchyCategoryEntity.xlsx",
    "Sizes.xlsx",
    "States.xlsx",
};
...
java.io.File file_tFileExist_3 = new java.io.File(context.ReferentielPath +  ((String)globalMap.get("tForeach_1_CURRENT_VALUE")));
...
globalMap.put("tFileExist_3_FILENAME",context.ReferentielPath +  ((String)globalMap.get("tForeach_1_CURRENT_VALUE")));
 ...
 */
	...
	String message_tSendMail_1 = ((context.ErrorDataEntity) == null || "".equals(context.ErrorDataEntity)) ? "\"\"" : (context.ErrorDataEntity) ;
	...
	final String decryptedPassword_tSendMail_1 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[qW1Wy+pIdVyRKbMxr7G8KzxzNqsZLexzV3BXg3iDh/9LpGa/]");
				
				
				return new javax.mail.PasswordAuthentication("djebiri.franck@haddadeurope.com", decryptedPassword_tSendMail_1); 
				}         
			});   
	...
	java.util.List<String> paraList_tRunJob_1 = new java.util.ArrayList<String>();
			...
			if (osName_tRunJob_1 != null && osName_tRunJob_1.toLowerCase().startsWith("win")){
		      			...
		      			paraList_tRunJob_1.add("java");
		        				...
		        				jvm_argument_helper_tRunJob_1.addArgumentsTo(paraList_tRunJob_1, dealChildJobLibrary_tRunJob_1.replaceJarPathsFromCrcMap(".;../lib/routines.jar;../lib/activation.jar;../lib/advancedPersistentLookupLib-1.2.jar;../lib/commons-collections-3.2.2.jar;../lib/commons-collections4-4.1.jar;../lib/commons-compress-1.19.jar;../lib/commons-lang3-3.8.1.jar;../lib/commons-math3-3.6.1.jar;../lib/crypto-utils.jar;../lib/dom4j-1.6.1.jar;../lib/filecopy.jar;../lib/geronimo-stax-api_1.0_spec-1.0.1.jar;../lib/jboss-serialization.jar;../lib/log4j-1.2.17.jar;../lib/mail-1.4.jar;../lib/poi-4.1.0-20190523141255_modified_talend.jar;../lib/poi-ooxml-4.1.0-20190523141255_modified_talend.jar;../lib/poi-ooxml-schemas-4.1.0-20190523141255_modified_talend.jar;../lib/poi-scratchpad-4.1.0-20190523141255_modified_talend.jar;../lib/talendExcel-1.5-20190731.jar;../lib/talend_file_enhanced_20070724.jar;../lib/trove.jar;../lib/xmlbeans-3.1.0.jar;buy_validation_0_1.jar;"));
		      				
		      					jvm_argument_helper_tRunJob_1.addArgumentsTo(paraList_tRunJob_1, "dev.buy_validation_0_1.BUY_VALIDATION");
						...
						paraList_tRunJob_1.add("java");
								...
								jvm_argument_helper_tRunJob_1.addArgumentsTo(paraList_tRunJob_1, dealChildJobLibrary_tRunJob_1.replaceJarPathsFromCrcMap(".:$ROOT_PATH:$ROOT_PATH/../lib/routines.jar:$ROOT_PATH/../lib/activation.jar:$ROOT_PATH/../lib/advancedPersistentLookupLib-1.2.jar:$ROOT_PATH/../lib/commons-collections-3.2.2.jar:$ROOT_PATH/../lib/commons-collections4-4.1.jar:$ROOT_PATH/../lib/commons-compress-1.19.jar:$ROOT_PATH/../lib/commons-lang3-3.8.1.jar:$ROOT_PATH/../lib/commons-math3-3.6.1.jar:$ROOT_PATH/../lib/crypto-utils.jar:$ROOT_PATH/../lib/dom4j-1.6.1.jar:$ROOT_PATH/../lib/filecopy.jar:$ROOT_PATH/../lib/geronimo-stax-api_1.0_spec-1.0.1.jar:$ROOT_PATH/../lib/jboss-serialization.jar:$ROOT_PATH/../lib/log4j-1.2.17.jar:$ROOT_PATH/../lib/mail-1.4.jar:$ROOT_PATH/../lib/poi-4.1.0-20190523141255_modified_talend.jar:$ROOT_PATH/../lib/poi-ooxml-4.1.0-20190523141255_modified_talend.jar:$ROOT_PATH/../lib/poi-ooxml-schemas-4.1.0-20190523141255_modified_talend.jar:$ROOT_PATH/../lib/poi-scratchpad-4.1.0-20190523141255_modified_talend.jar:$ROOT_PATH/../lib/talendExcel-1.5-20190731.jar:$ROOT_PATH/../lib/talend_file_enhanced_20070724.jar:$ROOT_PATH/../lib/trove.jar:$ROOT_PATH/../lib/xmlbeans-3.1.0.jar:$ROOT_PATH/buy_validation_0_1.jar:").replace("$ROOT_PATH",System.getProperty("user.dir")));
	...
	java.util.List<String> paraList_tRunJob_2 = new java.util.ArrayList<String>();
			...
			if (osName_tRunJob_2 != null && osName_tRunJob_2.toLowerCase().startsWith("win")){
		      			...
		      			paraList_tRunJob_2.add("java");
		        				...
		        				jvm_argument_helper_tRunJob_2.addArgumentsTo(paraList_tRunJob_2, dealChildJobLibrary_tRunJob_2.replaceJarPathsFromCrcMap(".;../lib/routines.jar;../lib/advancedPersistentLookupLib-1.2.jar;../lib/commons-collections-3.2.2.jar;../lib/commons-collections4-4.1.jar;../lib/commons-compress-1.19.jar;../lib/commons-lang3-3.8.1.jar;../lib/commons-math3-3.6.1.jar;../lib/crypto-utils.jar;../lib/dom4j-1.6.1.jar;../lib/geronimo-stax-api_1.0_spec-1.0.1.jar;../lib/jboss-serialization.jar;../lib/log4j-1.2.17.jar;../lib/poi-4.1.0-20190523141255_modified_talend.jar;../lib/poi-ooxml-4.1.0-20190523141255_modified_talend.jar;../lib/poi-ooxml-schemas-4.1.0-20190523141255_modified_talend.jar;../lib/poi-scratchpad-4.1.0-20190523141255_modified_talend.jar;../lib/talendExcel-1.5-20190731.jar;../lib/thashfile-3.1-20190910.jar;../lib/trove.jar;../lib/xmlbeans-3.1.0.jar;extract_for_dynamics_0_1.jar;"));
		      				
		      					jvm_argument_helper_tRunJob_2.addArgumentsTo(paraList_tRunJob_2, "dev.extract_for_dynamics_0_1.EXTRACT_FOR_DYNAMICS");
						...
						paraList_tRunJob_2.add("java");
								...
								jvm_argument_helper_tRunJob_2.addArgumentsTo(paraList_tRunJob_2, dealChildJobLibrary_tRunJob_2.replaceJarPathsFromCrcMap(".:$ROOT_PATH:$ROOT_PATH/../lib/routines.jar:$ROOT_PATH/../lib/advancedPersistentLookupLib-1.2.jar:$ROOT_PATH/../lib/commons-collections-3.2.2.jar:$ROOT_PATH/../lib/commons-collections4-4.1.jar:$ROOT_PATH/../lib/commons-compress-1.19.jar:$ROOT_PATH/../lib/commons-lang3-3.8.1.jar:$ROOT_PATH/../lib/commons-math3-3.6.1.jar:$ROOT_PATH/../lib/crypto-utils.jar:$ROOT_PATH/../lib/dom4j-1.6.1.jar:$ROOT_PATH/../lib/geronimo-stax-api_1.0_spec-1.0.1.jar:$ROOT_PATH/../lib/jboss-serialization.jar:$ROOT_PATH/../lib/log4j-1.2.17.jar:$ROOT_PATH/../lib/poi-4.1.0-20190523141255_modified_talend.jar:$ROOT_PATH/../lib/poi-ooxml-4.1.0-20190523141255_modified_talend.jar:$ROOT_PATH/../lib/poi-ooxml-schemas-4.1.0-20190523141255_modified_talend.jar:$ROOT_PATH/../lib/poi-scratchpad-4.1.0-20190523141255_modified_talend.jar:$ROOT_PATH/../lib/talendExcel-1.5-20190731.jar:$ROOT_PATH/../lib/thashfile-3.1-20190910.jar:$ROOT_PATH/../lib/trove.jar:$ROOT_PATH/../lib/xmlbeans-3.1.0.jar:$ROOT_PATH/extract_for_dynamics_0_1.jar:").replace("$ROOT_PATH",System.getProperty("user.dir")));
	...
	java.util.List<String> paraList_tRunJob_3 = new java.util.ArrayList<String>();
			...
			if (osName_tRunJob_3 != null && osName_tRunJob_3.toLowerCase().startsWith("win")){
		      			...
		      			paraList_tRunJob_3.add("java");
		        				...
		        				jvm_argument_helper_tRunJob_3.addArgumentsTo(paraList_tRunJob_3, dealChildJobLibrary_tRunJob_3.replaceJarPathsFromCrcMap(".;../lib/routines.jar;../lib/advancedPersistentLookupLib-1.2.jar;../lib/commons-collections-3.2.2.jar;../lib/commons-collections4-4.1.jar;../lib/commons-compress-1.19.jar;../lib/commons-lang3-3.8.1.jar;../lib/commons-math3-3.6.1.jar;../lib/crypto-utils.jar;../lib/dom4j-1.6.1.jar;../lib/geronimo-stax-api_1.0_spec-1.0.1.jar;../lib/jboss-serialization.jar;../lib/log4j-1.2.17.jar;../lib/poi-4.1.0-20190523141255_modified_talend.jar;../lib/poi-ooxml-4.1.0-20190523141255_modified_talend.jar;../lib/poi-ooxml-schemas-4.1.0-20190523141255_modified_talend.jar;../lib/poi-scratchpad-4.1.0-20190523141255_modified_talend.jar;../lib/talendExcel-1.5-20190731.jar;../lib/talend_file_enhanced_20070724.jar;../lib/thashfile-3.1-20190910.jar;../lib/trove.jar;../lib/xmlbeans-3.1.0.jar;extract_for_dynamics_price_0_1.jar;"));
		      				
		      					jvm_argument_helper_tRunJob_3.addArgumentsTo(paraList_tRunJob_3, "dev.extract_for_dynamics_price_0_1.EXTRACT_FOR_DYNAMICS_PRICE");
						...
						paraList_tRunJob_3.add("java");
								...
								jvm_argument_helper_tRunJob_3.addArgumentsTo(paraList_tRunJob_3, dealChildJobLibrary_tRunJob_3.replaceJarPathsFromCrcMap(".:$ROOT_PATH:$ROOT_PATH/../lib/routines.jar:$ROOT_PATH/../lib/advancedPersistentLookupLib-1.2.jar:$ROOT_PATH/../lib/commons-collections-3.2.2.jar:$ROOT_PATH/../lib/commons-collections4-4.1.jar:$ROOT_PATH/../lib/commons-compress-1.19.jar:$ROOT_PATH/../lib/commons-lang3-3.8.1.jar:$ROOT_PATH/../lib/commons-math3-3.6.1.jar:$ROOT_PATH/../lib/crypto-utils.jar:$ROOT_PATH/../lib/dom4j-1.6.1.jar:$ROOT_PATH/../lib/geronimo-stax-api_1.0_spec-1.0.1.jar:$ROOT_PATH/../lib/jboss-serialization.jar:$ROOT_PATH/../lib/log4j-1.2.17.jar:$ROOT_PATH/../lib/poi-4.1.0-20190523141255_modified_talend.jar:$ROOT_PATH/../lib/poi-ooxml-4.1.0-20190523141255_modified_talend.jar:$ROOT_PATH/../lib/poi-ooxml-schemas-4.1.0-20190523141255_modified_talend.jar:$ROOT_PATH/../lib/poi-scratchpad-4.1.0-20190523141255_modified_talend.jar:$ROOT_PATH/../lib/talendExcel-1.5-20190731.jar:$ROOT_PATH/../lib/talend_file_enhanced_20070724.jar:$ROOT_PATH/../lib/thashfile-3.1-20190910.jar:$ROOT_PATH/../lib/trove.jar:$ROOT_PATH/../lib/xmlbeans-3.1.0.jar:$ROOT_PATH/extract_for_dynamics_price_0_1.jar:").replace("$ROOT_PATH",System.getProperty("user.dir")));
 ...
 */
    ...
    String zipFile_tFileArchive_1 = context.ExtractPath + "MASTER FILE " +   globalMap.get("dateError")  + ".zip";
	...
	final String decryptedPassword_tFileArchive_1 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[Z47fRghUOlliP036dfr28Q2KTieF+vNfo9GMOA==]");
 ...
 */
	...
	currentComponent="tFileCopy_1";
        ...
        String srcFileName_tFileCopy_1 = context.ExtractPath + "MASTER FILE " +   globalMap.get("dateError")  + ".zip";
		...
		if (!srcFile_tFileCopy_1.getPath().equals(desFile_tFileCopy_1.getPath())  ) {
				...
				java.io.File isRemoved_tFileCopy_1 = new java.io.File(context.ExtractPath + "MASTER FILE " +   globalMap.get("dateError")  + ".zip");
...
///////////////////////		
				...
				strBuffer_tLogRow_1.append(
				                String.valueOf(row7.EntitiesNotExists)							
				);
...
String fileName_talendLogs_FILE = "";
    fileName_talendLogs_FILE = (new java.io.File(context.LogPath+ "/" +"logs_file" +  TalendDate.formatDate("yyyy-MM-ddHH", new Date()) + ".txt")).getAbsolutePath().replace("\\","/");
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = BUY_INTEGRATION.class.getClassLoader().getResourceAsStream("dev/buy_integration_0_2/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     189171 characters generated by Talend Open Studio for Data Integration 
 *     on the 12 octobre 2021 à 14:08:24 CEST
 ************************************************************************************************/