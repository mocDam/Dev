...
package dev.masterfile_prices_0_33;
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"ENC:[032jhES2b0ohmoLfa7v4PAIkvTEIbY9xMPH3P6+rhsHDSl8JPKdGgLvWNoVp+Md0fW87hg4g0AE=]");
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_1", "", Thread.currentThread().getId() + "", "INFO",
							"", "Copie HBE1 OK", "", "");
					talendLogs_LOGS.addMessage("tWarn", "tWarn_1", 3, "Copie HBE1 OK", 3);
					talendLogs_LOGSProcess(globalMap);
					globalMap.put("tWarn_1_WARN_MESSAGES", "Copie HBE1 OK");
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_2", "", Thread.currentThread().getId() + "", "INFO",
							"", "Copie HBB1 OK", "", "");
					talendLogs_LOGS.addMessage("tWarn", "tWarn_2", 3, "Copie HBB1 OK", 3);
					talendLogs_LOGSProcess(globalMap);
					globalMap.put("tWarn_2_WARN_MESSAGES", "Copie HBB1 OK");
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_3", "", Thread.currentThread().getId() + "", "INFO",
							"", "Copie HBP1 OK", "", "");
					talendLogs_LOGS.addMessage("tWarn", "tWarn_3", 3, "Copie HBP1 OK", 3);
					talendLogs_LOGSProcess(globalMap);
					globalMap.put("tWarn_3_WARN_MESSAGES", "Copie HBP1 OK");
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_4", "", Thread.currentThread().getId() + "", "INFO",
							"", "Copie HBS1 OK", "", "");
					talendLogs_LOGS.addMessage("tWarn", "tWarn_4", 3, "Copie HBS1 OK", 3);
					talendLogs_LOGSProcess(globalMap);
					globalMap.put("tWarn_4_WARN_MESSAGES", "Copie HBS1 OK");
	...
	public void tDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String url_tDBConnection_1 = "jdbc:sqlserver://" + "neowise-testing.database.windows.net";
				String port_tDBConnection_1 = "1433";
				String dbname_tDBConnection_1 = "ads_hbe_erp";
				if (!"".equals(port_tDBConnection_1)) {
					url_tDBConnection_1 += ":" + "1433";
				}
				if (!"".equals(dbname_tDBConnection_1)) {

					url_tDBConnection_1 += ";databaseName=" + "ads_hbe_erp";
				}
				url_tDBConnection_1 += ";appName=" + projectName + ";" + "";
				String dbUser_tDBConnection_1 = "melusior";

				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"ENC:[OgHKNht0Tw0Ej9fSp4R0z5loGs6E/x2gx8TMKqQkuPCj2+q77ST0zcQ481Gm+Co77qLr5MwyFCM=]");
				...
				globalMap.put("db_tDBConnection_1", "ads_hbe_erp");
	...
	public void tDBRow_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				query_tDBRow_1 = "\nupdate a\nset a.priceExtractDate = getDate() \nfrom [masterfile].[Products] as a\ninner join [data].D365_Labels c on "
						+ "a.LBL = c.LABELCODE\ninner join [data].[D365_ReleasedProductVariantsV2] b on b.itemnumber = a.STYLE and b.productcolorid"
						+ " = a.COLOR and b.productsizeid = a.SIZE and b.productstyleid = c.LABELD365\nwhere a.fileName = "
						+ "'" + context.currentFileName + "'" + " and a.creationDate = " + "'"
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_connectionStatsLogs = routines.system.PasswordEncryptUtil
						.decryptPassword(
								"ENC:[Ss8v7Jpojb41qltQTsx+QgzMNJYgXJ7Lb4m7hoU2IxHu4J/QG8p0nB+i8S13uFfAgHjKV7HyH60=]");
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = MASTERFILE_PRICES.class.getClassLoader()
					.getResourceAsStream("dev/masterfile_prices_0_33/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 234626 characters generated by Talend Open Studio for Data Integration on the
 * 11 octobre 2022 10:00:39 CEST
 ************************************************************************************************/