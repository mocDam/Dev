...
package dev.sfo_calculate_discount_product_0_4;
...
public class SFO_CALCULATE_DISCOUNT_PRODUCT implements TalendJob {
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(SFO_CALCULATE_DISCOUNT_PRODUCT.this,
	...
	public void tAdvancedHash_from_pricebookentry_error(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (obj_tRunJob_1 != null) {
					paraList_tRunJob_1
							.add("--context_param attachmentFile=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_1));
				} else {
					paraList_tRunJob_1.add("--context_param attachmentFile="
							+ NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
				}
				...
				if (obj_tRunJob_1 != null) {
					paraList_tRunJob_1
							.add("--context_param message=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_1));
				} else {
	...
	public static class sortie_update_special_offerStruct
			implements routines.system.IPersistableRow<sortie_update_special_offerStruct> {
	...
	public void tSalesforceConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				props_tSalesforceConnection_1.setValue("endpoint", "https://login.salesforce.com/services/Soap/u/45.0");
				...
				props_tSalesforceConnection_1.setValue("timeout", 300000);

				props_tSalesforceConnection_1.setValue("httpTraceMessage", false);

				props_tSalesforceConnection_1.setValue("clientId", "");

				props_tSalesforceConnection_1.userPassword.setValue("securityKey",
						routines.system.PasswordEncryptUtil.decryptPassword(
								"ENC:[wd6r6YV6O12nM3QShcdcMc42pmAivdWLHueyFvtOBuBkN7BHMQBk17/EsjBxCGst6Fw328w=]"));

				props_tSalesforceConnection_1.userPassword.setValue("useAuth", false);

				props_tSalesforceConnection_1.userPassword.setValue("userId", "systemuser@haddadeurope.com");

				props_tSalesforceConnection_1.userPassword.setValue("password", routines.system.PasswordEncryptUtil
						.decryptPassword("ENC:[7EhXXuccF3oLpoBQfZxPq0k91klOTC75LTpidtdFlQ5M70npGF/I0jaYz1io]"));
				...
				class SchemaSettingTool_tSalesforceOutput_1_2_fisrt {
					...
					String getSchemaValue() {
						...
						a("\"name\":\"Special_Offer__c\",\"type\":[\"double\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"Special_Offer__c\",\"talend.field.dbColumnName\":\"Special_Offer__c\",\"di.column.talendType\":\"id_Double\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"18\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"Special_Offer__c\",\"di.column.relatedEntity\":\"\"},{",
								s);
						...
						a("\"name\":\"errorMessage\",\"type\":\"string\",\"talend.isLocked\":\"false\",\"talend.field.generated\":\"true\",\"talend.field.length\":\"255\"}],\"di.table.name\":\"sortie_update_special_offer\",\"di.table.label\":\"GuessedSchema\"}",
								s);
				...
				props_tSalesforceOutput_1.module.setValue("moduleName", "PricebookEntry");
...
// ###############################
				...
				class SchemaSettingTool_tSalesforceInput_1_1_fisrt {
					...
					String getSchemaValue() {
						...
						a("\"name\":\"Product2_Name\",\"type\":[\"string\",\"null\"],\"talend.field.length\":\"255\"},{",
								s);

						a("\"name\":\"Special_Offer__c\",\"type\":[\"double\",\"null\"],\"talend.field.length\":\"18\"}]}",
								s);
...
// Start of branch "sortie_update_special_offer"
					if (sortie_update_special_offer != null) {
						...
						if (incomingEnforcer_tSalesforceOutput_1.getRuntimeSchema().getField("Product2_Name") != null) {
							incomingEnforcer_tSalesforceOutput_1.put("Product2_Name",
									sortie_update_special_offer.Product2_Name);
						}
						// skip the put action if the input column doesn't appear in component runtime
						// schema
						if (incomingEnforcer_tSalesforceOutput_1.getRuntimeSchema()
								.getField("Special_Offer__c") != null) {
							incomingEnforcer_tSalesforceOutput_1.put("Special_Offer__c",
									sortie_update_special_offer.Special_Offer__c);
						}
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				class SchemaSettingTool_tSalesforceOutput_2_1_fisrt {
					...
					String getSchemaValue() {
						...
						a("\"name\":\"Special_Offer__c\",\"type\":\"double\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"Special_Offer__r_Discount__c\",\"talend.field.dbColumnName\":\"Special_Offer__c\",\"di.column.talendType\":\"id_Double\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"Special_Offer__c\",\"di.column.relatedEntity\":\"\"}],\"di.table.name\":\"tSalesforceOutput_2\",\"di.table.label\":\"tSalesforceOutput_2\"}",
								s);
				...
				class SchemaSettingTool_tSalesforceOutput_2_2_fisrt {
					...
					String getSchemaValue() {
						...
						a("\"name\":\"Special_Offer__c\",\"type\":\"double\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"Special_Offer__r_Discount__c\",\"talend.field.dbColumnName\":\"Special_Offer__c\",\"di.column.talendType\":\"id_Double\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"Special_Offer__c\",\"di.column.relatedEntity\":\"\"},{",
								s);
				...
				props_tSalesforceOutput_2.module.setValue("moduleName", "PricebookEntry");
...
// # Lookup's keys initialization
				...
				org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<from_pricebookentryStruct> tHash_Lookup_from_pricebookentry = (org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<from_pricebookentryStruct>) ((org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<from_pricebookentryStruct>) globalMap
						.get("tHash_Lookup_from_pricebookentry"));
...
// ###############################
				...
				class SchemaSettingTool_tSalesforceInput_2_1_fisrt {
					...
					String getSchemaValue() {
						...
						a("\"name\":\"Special_Offer__r_From__c\",\"type\":\"string\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"Special_Offer__r_From__c\",\"talend.field.dbColumnName\":\"Special_Offer__r_From__c\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"Special_Offer__r_From__c\",\"di.column.relatedEntity\":\"\"},{",
								s);

						a("\"name\":\"Special_Offer__r_To__c\",\"type\":\"string\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"Special_Offer__r_To__c\",\"talend.field.dbColumnName\":\"Special_Offer__r_To__c\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"Special_Offer__r_To__c\",\"di.column.relatedEntity\":\"\"}],\"di.table.name\":\"MAIN\",\"di.table.label\":\"MAIN\"}",
								s);
				...
				for (; available_tSalesforceInput_2; available_tSalesforceInput_2 = reader_tSalesforceInput_2
					...
					while ((tHash_Lookup_from_pricebookentry != null && tHash_Lookup_from_pricebookentry.hasNext())
							|| forceLoopfrom_pricebookentry) { // G_TM_M_043
...
// Start of branch "sortie_special"
						if (sortie_special != null) {
							...
							if (!keystUniqRow_1.contains(finder_tUniqRow_1)) {
								...
								row4.Id = sortie_special.Id;
								row4.Special_Offer__c = sortie_special.Special_Offer__c;
...
// finally of generic
	...
	public static class from_pricebookentryStruct
			implements routines.system.IPersistableComparableLookupRow<from_pricebookentryStruct> {
		final static byte[] commonByteArrayLock_DEV_SFO_CALCULATE_DISCOUNT_PRODUCT = new byte[0];
		static byte[] commonByteArray_DEV_SFO_CALCULATE_DISCOUNT_PRODUCT = new byte[0];
	...
	public void tSalesforceInput_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// source node:tSalesforceInput_3 - inputs:(after_tSalesforceInput_2)
				// outputs:(from_pricebookentry,from_pricebookentry) | target
				// node:tAdvancedHash_from_pricebookentry - inputs:(from_pricebookentry)
				// outputs:()
				// linked node: tMap_2 - inputs:(from_special_offer,from_pricebookentry)
				// outputs:(sortie_special)

				org.talend.designer.components.lookup.common.ICommonLookup.MATCHING_MODE matchingModeEnum_from_pricebookentry = org.talend.designer.components.lookup.common.ICommonLookup.MATCHING_MODE.ALL_MATCHES;
				...
				props_tSalesforceInput_3.setValue("safetySwitch", true);

				props_tSalesforceInput_3.setValue("returnNullValue", false);

				props_tSalesforceInput_3.setValue("jobTimeOut", 0);

				props_tSalesforceInput_3.setValue("pkChunking", false);
				...
				class SchemaSettingTool_tSalesforceInput_3_1_fisrt {
					...
					String getSchemaValue() {
						...
						a("\"name\":\"Product2_Name\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"Product2_Name\",\"talend.field.dbColumnName\":\"Product2_Name\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"255\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"Product2_Name\",\"di.column.relatedEntity\":\"\"}],\"di.table.name\":\"MAIN\",\"di.table.label\":\"MAIN\"}",
								s);
...
// finally of generic
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = SFO_CALCULATE_DISCOUNT_PRODUCT.class.getClassLoader().getResourceAsStream(
					"dev/sfo_calculate_discount_product_0_4/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = SFO_CALCULATE_DISCOUNT_PRODUCT.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : SFO_CALCULATE_DISCOUNT_PRODUCT");
		}
...
/************************************************************************************************
 * 247368 characters generated by Talend Open Studio for Data Integration on the
 * 14 juin 2022 14:24:05 CEST
 ************************************************************************************************/