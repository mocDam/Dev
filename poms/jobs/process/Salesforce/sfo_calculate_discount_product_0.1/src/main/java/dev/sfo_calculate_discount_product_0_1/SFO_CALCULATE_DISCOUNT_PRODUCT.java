...
package dev.sfo_calculate_discount_product_0_1;
	...
	public void tSalesforceConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				props_tSalesforceConnection_1.setValue("clientId", "test talend");

				props_tSalesforceConnection_1.userPassword.setValue("securityKey",
						routines.system.PasswordEncryptUtil.decryptPassword(
								"ENC:[DpTTtcebZli6efyQmum7U+ODa6uUzzU/5XQz/HOoLEjv/zEhDkO3KJLB37DYwdx44u2NEAs=]"));

				props_tSalesforceConnection_1.userPassword.setValue("useAuth", false);

				props_tSalesforceConnection_1.userPassword.setValue("userId", "djebiri.franck@haddadeurope.com.full");

				props_tSalesforceConnection_1.userPassword.setValue("password", routines.system.PasswordEncryptUtil
						.decryptPassword("ENC:[EOjTC2A5f15HA7nxoit1Umq0++tOQ3PgBFcvQ+M3b5cCLKZKKck=]"));
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				props_tSalesforceInput_3.setValue("query",
						"\nSelect Id, aProduct2.Name from PriceBookEntry where IsActive = true and Product2.IsActive = True\n");
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = SFO_CALCULATE_DISCOUNT_PRODUCT.class.getClassLoader().getResourceAsStream(
					"dev/sfo_calculate_discount_product_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 247456 characters generated by Talend Open Studio for Data Integration on the
 * 17 mai 2022 14:09:36 CEST
 ************************************************************************************************/