...
package dev.buy_integration_0_13;
...
private class TalendException extends Exception {
	...
	public void printStackTrace() {
		...
		try {
			...
			public void tFileCopy_15_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
			...
			public void tFileCopy_16_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
			...
			public void tFileCopy_17_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 */
	...
	final String decryptedPassword_tFileArchive_1 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[3pYKMjrkWw2F5odKk0+hB4OY4md4e76tITgLLg==]");
 ...
 */
	...
	currentComponent="tFileCopy_4";
		...
		if (!srcFile_tFileCopy_4.getPath().equals(desFile_tFileCopy_4.getPath())  ) {
				...
				try {
					org.talend.FileCopy.copyFile(srcFile_tFileCopy_4.getPath(), desFile_tFileCopy_4.getPath(), false);
				} catch (Exception e) {
 ...
 */
	...
	currentComponent="tFileCopy_15";
		...
		if (!srcFile_tFileCopy_15.exists() || !srcFile_tFileCopy_15.isFile()) {
			String errorMessageFileDoesnotExistsOrIsNotAFile_tFileCopy_15 = String.format("The source File \"%s\" does not exist or is not a file.", srcFileName_tFileCopy_15);
		...
		java.io.File desFile_tFileCopy_15 = new java.io.File(desDirName_tFileCopy_15, desFileName_tFileCopy_15);
		...
		if (!srcFile_tFileCopy_15.getPath().equals(desFile_tFileCopy_15.getPath())  ) {
				...
				try {
					org.talend.FileCopy.copyFile(srcFile_tFileCopy_15.getPath(), desFile_tFileCopy_15.getPath(), false);
				} catch (Exception e) {
 ...
 */
	...
	currentComponent="tFileCopy_16";
		...
		if (!srcFile_tFileCopy_16.exists() || !srcFile_tFileCopy_16.isFile()) {
			String errorMessageFileDoesnotExistsOrIsNotAFile_tFileCopy_16 = String.format("The source File \"%s\" does not exist or is not a file.", srcFileName_tFileCopy_16);
		...
		java.io.File desFile_tFileCopy_16 = new java.io.File(desDirName_tFileCopy_16, desFileName_tFileCopy_16);
		...
		if (!srcFile_tFileCopy_16.getPath().equals(desFile_tFileCopy_16.getPath())  ) {
				...
				try {
					org.talend.FileCopy.copyFile(srcFile_tFileCopy_16.getPath(), desFile_tFileCopy_16.getPath(), false);
				} catch (Exception e) {
 ...
 */
	...
	currentComponent="tFileCopy_17";
		...
		if (!srcFile_tFileCopy_17.exists() || !srcFile_tFileCopy_17.isFile()) {
			String errorMessageFileDoesnotExistsOrIsNotAFile_tFileCopy_17 = String.format("The source File \"%s\" does not exist or is not a file.", srcFileName_tFileCopy_17);
		...
		java.io.File desFile_tFileCopy_17 = new java.io.File(desDirName_tFileCopy_17, desFileName_tFileCopy_17);
		...
		if (!srcFile_tFileCopy_17.getPath().equals(desFile_tFileCopy_17.getPath())  ) {
				...
				try {
					org.talend.FileCopy.copyFile(srcFile_tFileCopy_17.getPath(), desFile_tFileCopy_17.getPath(), false);
				} catch (Exception e) {
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = BUY_INTEGRATION.class.getClassLoader().getResourceAsStream("dev/buy_integration_0_13/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     352250 characters generated by Talend Open Studio for Data Integration 
 *     on the 23 mars 2022 14:11:30 CET
 ************************************************************************************************/