...
package dev.buy_integration_0_11;
...
public class BUY_INTEGRATION implements TalendJob {
	...
	public void tFileArchive_3_error(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public void tFileCopy_14_error(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		tFileCopy_14_onSubJobError(exception, errorComponent, globalMap);
	}
	...
	public void tFileCopy_6_error(Exception exception, String errorComponent,
		...
		tFileCopy_6_onSubJobError(exception, errorComponent, globalMap);
	}
	...
	public void tFileCopy_15_error(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public void tFileCopy_16_error(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public void tFileCopy_17_error(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public void tFileArchive_3_onSubJobError(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public void tFileCopy_14_onSubJobError(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public void tFileCopy_5_onSubJobError(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public void tFileCopy_6_onSubJobError(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public void tFileList_4_onSubJobError(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
...
///////////////////////    			
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (obj_tRunJob_5 != null) {
					paraList_tRunJob_5
							.add("--context_param recipientEmail=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_5));
				} else {
					paraList_tRunJob_5.add("--context_param recipientEmail="
				...
				if (obj_tRunJob_5 != null) {
					paraList_tRunJob_5
							.add("--context_param subject=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_5));
				} else {
				...
				if (obj_tRunJob_5 != null) {
					paraList_tRunJob_5
							.add("--context_param message=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_5));
				} else {
					paraList_tRunJob_5.add(
							"--context_param message=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
				}
				...
				if (obj_tRunJob_5 != null) {
					paraList_tRunJob_5
							.add("--context_param attachmentFile=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_5));
				} else {
					paraList_tRunJob_5.add("--context_param attachmentFile="
							+ NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
				}
				...
				if (obj_tRunJob_5 != null) {
					paraList_tRunJob_5
							.add("--context_param excelFileName=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_5));
				} else {
					paraList_tRunJob_5.add("--context_param excelFileName="
							+ NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
				}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String srcFileName_tFileCopy_9 = context.IntegrationPath
						+ ((String) globalMap.get("tWaitForFile_1_FILENAME"));
				...
				if (osName_tRunJob_2 != null && osName_tRunJob_2.toLowerCase().startsWith("win")) {
					...
					jvm_argument_helper_tRunJob_2.addArgumentsTo(paraList_tRunJob_2,
							dealChildJobLibrary_tRunJob_2.replaceJarPathsFromCrcMap(
									"C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/workspace/DEV/poms/jobs/process/extract_for_dynamics_0.11/target/classpath.jar;"));

					jvm_argument_helper_tRunJob_2.addArgumentsTo(paraList_tRunJob_2,
							"dev.extract_for_dynamics_0_11.EXTRACT_FOR_DYNAMICS");
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (obj_tRunJob_4 != null) {
					paraList_tRunJob_4.add(
							"--context_param ReferentielPath=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_4));
				} else {
					paraList_tRunJob_4.add("--context_param ReferentielPath="
							+ NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
				}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (osName_tRunJob_3 != null && osName_tRunJob_3.toLowerCase().startsWith("win")) {
					...
					paraList_tRunJob_3.add("C:/Program Files/Java/jre1.8.0_321/bin/java.exe");
					...
					jvm_argument_helper_tRunJob_3.addArgumentsTo(paraList_tRunJob_3,
							dealChildJobLibrary_tRunJob_3.replaceJarPathsFromCrcMap(
									"C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/workspace/DEV/poms/jobs/process/extract_for_dynamics_price_0.10/target/classpath.jar;"));

					jvm_argument_helper_tRunJob_3.addArgumentsTo(paraList_tRunJob_3,
							"dev.extract_for_dynamics_price_0_10.EXTRACT_FOR_DYNAMICS_PRICE");
					...
					jvm_argument_helper_tRunJob_3.addArgumentsTo(paraList_tRunJob_3,
							dealChildJobLibrary_tRunJob_3.replaceJarPathsFromCrcMap(
									"C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/workspace/DEV/poms/jobs/process/extract_for_dynamics_price_0.10/target/classes:C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/workspace/DEV/poms/jobs/process/extract_for_dynamics_price_0.10/src/main/ext-resources:C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/workspace/DEV/poms/code/routines/target/classes:.:C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/configuration/.m2/repository/org/talend/libraries/advancedPersistentLookupLib-1.2/6.0.0/advancedPersistentLookupLib-1.2-6.0.0.jar:C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/configuration/.m2/repository/commons-collections/commons-collections/3.2.2/commons-collections-3.2.2.jar:C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/configuration/.m2/repository/org/talend/libraries/commons-collections4-4.1/6.0.0/commons-collections4-4.1-6.0.0.jar:C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/configuration/.m2/repository/org/apache/commons/commons-compress/1.19/commons-compress-1.19.jar:C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/configuration/.m2/repository/org/apache/commons/commons-math3/3.6.1/commons-math3-3.6.1.jar:C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/configuration/.m2/repository/org/talend/libraries/crypto-utils/6.0.0-SNAPSHOT/crypto-utils-6.0.0-SNAPSHOT.jar:C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/configuration/.m2/repository/dom4j/dom4j/1.6.1/dom4j-1.6.1.jar:C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/configuration/.m2/repository/org/talend/libraries/geronimo-stax-api_1.0_spec-1.0.1/6.0.0/geronimo-stax-api_1.0_spec-1.0.1-6.0.0.jar:C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/configuration/.m2/repository/org/talend/libraries/jboss-serialization/6.0.0/jboss-serialization-6.0.0.jar:C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/configuration/.m2/repository/log4j/log4j/1.2.17/log4j-1.2.17.jar:C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/configuration/.m2/repository/org/talend/libraries/mssql-jdbc/6.0.0/mssql-jdbc-6.0.0.jar:C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/configuration/.m2/repository/org/apache/poi/poi/4.1.0-20190523141255_modified_talend/poi-4.1.0-20190523141255_modified_talend.jar:C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/configuration/.m2/repository/org/apache/poi/poi-ooxml/4.1.0-20190523141255_modified_talend/poi-ooxml-4.1.0-20190523141255_modified_talend.jar:C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/configuration/.m2/repository/org/apache/poi/poi-ooxml-schemas/4.1.0-20190523141255_modified_talend/poi-ooxml-schemas-4.1.0-20190523141255_modified_talend.jar:C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/configuration/.m2/repository/org/apache/poi/poi-scratchpad/4.1.0-20190523141255_modified_talend/poi-scratchpad-4.1.0-20190523141255_modified_talend.jar:C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/configuration/.m2/repository/org/talend/libraries/talend_DB_mssqlUtil-1.3-20190523/6.0.0/talend_DB_mssqlUtil-1.3-20190523-6.0.0.jar:C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/configuration/.m2/repository/org/talend/libraries/talend_file_enhanced_20070724/6.0.0/talend_file_enhanced_20070724-6.0.0.jar:C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/configuration/.m2/repository/org/talend/libraries/talendcsv/6.0.0/talendcsv-6.0.0.jar:C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/configuration/.m2/repository/org/talend/components/lib/thashfile/3.1-20190910/thashfile-3.1-20190910.jar:C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/configuration/.m2/repository/org/talend/libraries/trove/6.0.0/trove-6.0.0.jar:C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/configuration/.m2/repository/org/apache/xmlbeans/xmlbeans/3.1.0/xmlbeans-3.1.0.jar:")
									.replace("$ROOT_PATH", System.getProperty("user.dir")));
				...
				if (obj_tRunJob_3 != null) {
					paraList_tRunJob_3.add(
							"--context_param ExtractPathPrice=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_3));
				} else {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tFileArchive_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("ENC:[RdSg81NrpeRaGNhD7f5ZpICg0FUaavXDZv6f9Q==]");
	...
	public void tFileArchive_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String sourceFile_tFileArchive_3 = context.ExtractPathOTHER;

				if (java.nio.file.Files.notExists(java.nio.file.Paths.get(sourceFile_tFileArchive_3),
						java.nio.file.LinkOption.NOFOLLOW_LINKS)) {
					throw new java.io.FileNotFoundException(
							sourceFile_tFileArchive_3 + " (The system cannot find the path specified)");
				}

				String zipFile_tFileArchive_3 = context.ExtractPathOTHER + "HBB1#MASTER FILE "
						+ globalMap.get("dateError") + ".zip";

				com.talend.compress.zip.Zip zip_tFileArchive_3 = new com.talend.compress.zip.Zip(
						sourceFile_tFileArchive_3, zipFile_tFileArchive_3);
				zip_tFileArchive_3.setOverwriteExistTargetZip(true);
				zip_tFileArchive_3.setMakeTargetDir(false);
				zip_tFileArchive_3.setCompressLevel(4);
				zip_tFileArchive_3.setArchiveFormat("zip");
				zip_tFileArchive_3.setAllFiles(true);

				zip_tFileArchive_3.setContainSubDir(true);
				zip_tFileArchive_3.setEncoding("ISO-8859-15");
				zip_tFileArchive_3.setZip64Mode("ASNEEDED");
				zip_tFileArchive_3.setEncrypted(false);

				final String decryptedPassword_tFileArchive_3 = routines.system.PasswordEncryptUtil
						.decryptPassword("ENC:[fADSEEN2AUG0Z1kfJ02E2NdEUpFjdWAuuphVaQ==]");

				zip_tFileArchive_3.setPassword(decryptedPassword_tFileArchive_3);

				zip_tFileArchive_3.setUseZip4jEncryption(true);
				zip_tFileArchive_3.setEncryptionMethod(net.lingala.zip4j.util.Zip4jConstants.ENC_METHOD_STANDARD);
	...
	public void tFileCopy_14Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		globalMap.put("tFileCopy_14_SUBPROCESS_STATE", 0);
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				/**
				 * [tFileCopy_14 begin ] start
				 */

				ok_Hash.put("tFileCopy_14", false);
				start_Hash.put("tFileCopy_14", System.currentTimeMillis());

				currentComponent = "tFileCopy_14";

				int tos_count_tFileCopy_14 = 0;

				/**
				 * [tFileCopy_14 begin ] stop
				 */

				/**
				 * [tFileCopy_14 main ] start
				 */

				currentComponent = "tFileCopy_14";

				String srcFileName_tFileCopy_14 = context.ExtractPathOTHER + "HBB1#MASTER FILE "
						+ globalMap.get("dateError") + ".zip";

				java.io.File srcFile_tFileCopy_14 = new java.io.File(srcFileName_tFileCopy_14);

				// here need check first, before mkdirs().
				if (!srcFile_tFileCopy_14.exists() || !srcFile_tFileCopy_14.isFile()) {
					String errorMessageFileDoesnotExistsOrIsNotAFile_tFileCopy_14 = String.format(
							"The source File \"%s\" does not exist or is not a file.", srcFileName_tFileCopy_14);
					System.err.println(errorMessageFileDoesnotExistsOrIsNotAFile_tFileCopy_14);
				}
				String desDirName_tFileCopy_14 = context.ExtractPathFinal;

				String desFileName_tFileCopy_14 = srcFile_tFileCopy_14.getName();

				if (desFileName_tFileCopy_14 != null && ("").equals(desFileName_tFileCopy_14.trim())) {
					desFileName_tFileCopy_14 = "NewName.temp";
				}

				java.io.File desFile_tFileCopy_14 = new java.io.File(desDirName_tFileCopy_14, desFileName_tFileCopy_14);

				if (!srcFile_tFileCopy_14.getPath().equals(desFile_tFileCopy_14.getPath())) {
					java.io.File parentFile_tFileCopy_14 = desFile_tFileCopy_14.getParentFile();

					if (parentFile_tFileCopy_14 != null && !parentFile_tFileCopy_14.exists()) {
						parentFile_tFileCopy_14.mkdirs();
					}
					try {
						org.talend.FileCopy.copyFile(srcFile_tFileCopy_14.getPath(), desFile_tFileCopy_14.getPath(),
								true);
					} catch (Exception e) {
						System.err.println("tFileCopy_14 " + e.getMessage());
					}
					java.io.File isRemoved_tFileCopy_14 = new java.io.File(
							context.ExtractPathOTHER + "HBB1#MASTER FILE " + globalMap.get("dateError") + ".zip");
					if (isRemoved_tFileCopy_14.exists()) {
						String errorMessageCouldNotRemoveFile_tFileCopy_14 = String.format(
								"tFileCopy_14 - The source file \"%s\" could not be removed from the folder because it is open or you only have read-only rights.",
								srcFileName_tFileCopy_14);
						System.err.println(errorMessageCouldNotRemoveFile_tFileCopy_14 + "\n");
					}

				}
				globalMap.put("tFileCopy_14_DESTINATION_FILEPATH", desFile_tFileCopy_14.getPath());
				globalMap.put("tFileCopy_14_DESTINATION_FILENAME", desFile_tFileCopy_14.getName());

				globalMap.put("tFileCopy_14_SOURCE_DIRECTORY", srcFile_tFileCopy_14.getParent());
				globalMap.put("tFileCopy_14_DESTINATION_DIRECTORY", desFile_tFileCopy_14.getParent());

				tos_count_tFileCopy_14++;

				/**
				 * [tFileCopy_14 main ] stop
				 */

				/**
				 * [tFileCopy_14 process_data_begin ] start
				 */

				currentComponent = "tFileCopy_14";

				/**
				 * [tFileCopy_14 process_data_begin ] stop
				 */

				/**
				 * [tFileCopy_14 process_data_end ] start
				 */

				currentComponent = "tFileCopy_14";

				/**
				 * [tFileCopy_14 process_data_end ] stop
				 */

				/**
				 * [tFileCopy_14 end ] start
				 */

				currentComponent = "tFileCopy_14";

				ok_Hash.put("tFileCopy_14", true);
				end_Hash.put("tFileCopy_14", System.currentTimeMillis());
			...
			try {
				...
				/**
				 * [tFileCopy_14 finally ] start
				 */

				currentComponent = "tFileCopy_14";

				/**
				 * [tFileCopy_14 finally ] stop
				 */
			} catch (java.lang.Exception e) {
				// ignore
			} catch (java.lang.Error error) {
		...
		globalMap.put("tFileCopy_14_SUBPROCESS_STATE", 1);
	}

	public void tFileCopy_5Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String srcFileName_tFileCopy_5 = context.ExtractPathFinal + "HBB1#MASTER FILE "
						+ globalMap.get("dateError") + ".zip";
	...
	public void tFileCopy_6Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		globalMap.put("tFileCopy_6_SUBPROCESS_STATE", 0);
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String srcFileName_tFileCopy_6 = context.ExtractPathFinal + "HBB1#MASTER FILE "
						+ globalMap.get("dateError") + ".zip";
		...
		globalMap.put("tFileCopy_6_SUBPROCESS_STATE", 1);
	}
	...
	public void tFileList_5Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				int NB_ITERATE_tFileCopy_4 = 0; // for statistics
				...
				for (int i_tFileList_5 = 0; i_tFileList_5 < list_tFileList_5.size(); i_tFileList_5++) {
					 ...
					 */
					NB_ITERATE_tFileCopy_4++;

					if (execStat) {
						runStat.updateStatOnConnection("iterate7", 1, "exec" + NB_ITERATE_tFileCopy_4);
						// Thread.sleep(1000);
					}
					...
					String srcFileName_tFileCopy_4 = ((String) globalMap.get("tFileList_5_CURRENT_FILEPATH"));
					...
					if (!srcFile_tFileCopy_4.exists() || !srcFile_tFileCopy_4.isFile()) {
						String errorMessageFileDoesnotExistsOrIsNotAFile_tFileCopy_4 = String.format(
								"The source File \"%s\" does not exist or is not a file.", srcFileName_tFileCopy_4);
						System.err.println(errorMessageFileDoesnotExistsOrIsNotAFile_tFileCopy_4);
					}
					String desDirName_tFileCopy_4 = context.ExtractPathFinalPrice;

					String desFileName_tFileCopy_4 = srcFile_tFileCopy_4.getName();

					if (desFileName_tFileCopy_4 != null && ("").equals(desFileName_tFileCopy_4.trim())) {
						desFileName_tFileCopy_4 = "NewName.temp";
					}

					java.io.File desFile_tFileCopy_4 = new java.io.File(desDirName_tFileCopy_4,
							desFileName_tFileCopy_4);
					 ...
					 */
					if (execStat) {
						runStat.updateStatOnConnection("iterate7", 2, "exec" + NB_ITERATE_tFileCopy_4);
					}
	...
	public void tFileList_6Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				int NB_ITERATE_tFileCopy_15 = 0; // for statistics
				...
				for (int i_tFileList_6 = 0; i_tFileList_6 < list_tFileList_6.size(); i_tFileList_6++) {
					 ...
					 */
					NB_ITERATE_tFileCopy_15++;

					if (execStat) {
						runStat.updateStatOnConnection("iterate8", 1, "exec" + NB_ITERATE_tFileCopy_15);
						// Thread.sleep(1000);
					}

					/**
					 * [tFileCopy_15 begin ] start
					 */

					ok_Hash.put("tFileCopy_15", false);
					start_Hash.put("tFileCopy_15", System.currentTimeMillis());

					currentComponent = "tFileCopy_15";

					int tos_count_tFileCopy_15 = 0;

					/**
					 * [tFileCopy_15 begin ] stop
					 */

					/**
					 * [tFileCopy_15 main ] start
					 */

					currentComponent = "tFileCopy_15";

					String srcFileName_tFileCopy_15 = ((String) globalMap.get("tFileList_6_CURRENT_FILEPATH"));

					java.io.File srcFile_tFileCopy_15 = new java.io.File(srcFileName_tFileCopy_15);

					// here need check first, before mkdirs().
					if (!srcFile_tFileCopy_15.exists() || !srcFile_tFileCopy_15.isFile()) {
						String errorMessageFileDoesnotExistsOrIsNotAFile_tFileCopy_15 = String.format(
								"The source File \"%s\" does not exist or is not a file.", srcFileName_tFileCopy_15);
						System.err.println(errorMessageFileDoesnotExistsOrIsNotAFile_tFileCopy_15);
					}
					String desDirName_tFileCopy_15 = context.ExtractPathFinalPriceHBB1;

					String desFileName_tFileCopy_15 = srcFile_tFileCopy_15.getName();

					if (desFileName_tFileCopy_15 != null && ("").equals(desFileName_tFileCopy_15.trim())) {
						desFileName_tFileCopy_15 = "NewName.temp";
					}

					java.io.File desFile_tFileCopy_15 = new java.io.File(desDirName_tFileCopy_15,
							desFileName_tFileCopy_15);

					if (!srcFile_tFileCopy_15.getPath().equals(desFile_tFileCopy_15.getPath())) {
						java.io.File parentFile_tFileCopy_15 = desFile_tFileCopy_15.getParentFile();

						if (parentFile_tFileCopy_15 != null && !parentFile_tFileCopy_15.exists()) {
							parentFile_tFileCopy_15.mkdirs();
						}
						try {
							org.talend.FileCopy.copyFile(srcFile_tFileCopy_15.getPath(), desFile_tFileCopy_15.getPath(),
									false);
						} catch (Exception e) {
							System.err.println("tFileCopy_15 " + e.getMessage());
						}

					}
					globalMap.put("tFileCopy_15_DESTINATION_FILEPATH", desFile_tFileCopy_15.getPath());
					globalMap.put("tFileCopy_15_DESTINATION_FILENAME", desFile_tFileCopy_15.getName());

					globalMap.put("tFileCopy_15_SOURCE_DIRECTORY", srcFile_tFileCopy_15.getParent());
					globalMap.put("tFileCopy_15_DESTINATION_DIRECTORY", desFile_tFileCopy_15.getParent());

					tos_count_tFileCopy_15++;

					/**
					 * [tFileCopy_15 main ] stop
					 */

					/**
					 * [tFileCopy_15 process_data_begin ] start
					 */

					currentComponent = "tFileCopy_15";

					/**
					 * [tFileCopy_15 process_data_begin ] stop
					 */

					/**
					 * [tFileCopy_15 process_data_end ] start
					 */

					currentComponent = "tFileCopy_15";

					/**
					 * [tFileCopy_15 process_data_end ] stop
					 */

					/**
					 * [tFileCopy_15 end ] start
					 */

					currentComponent = "tFileCopy_15";

					ok_Hash.put("tFileCopy_15", true);
					end_Hash.put("tFileCopy_15", System.currentTimeMillis());

					/**
					 * [tFileCopy_15 end ] stop
					 */
					if (execStat) {
						runStat.updateStatOnConnection("iterate8", 2, "exec" + NB_ITERATE_tFileCopy_15);
					}
			...
			try {
				...
				/**
				 * [tFileCopy_15 finally ] start
				 */

				currentComponent = "tFileCopy_15";

				/**
				 * [tFileCopy_15 finally ] stop
				 */
	...
	public void tFileList_7Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				int NB_ITERATE_tFileCopy_16 = 0; // for statistics
				...
				for (int i_tFileList_7 = 0; i_tFileList_7 < list_tFileList_7.size(); i_tFileList_7++) {
					 ...
					 */
					NB_ITERATE_tFileCopy_16++;

					if (execStat) {
						runStat.updateStatOnConnection("iterate9", 1, "exec" + NB_ITERATE_tFileCopy_16);
						// Thread.sleep(1000);
					}

					/**
					 * [tFileCopy_16 begin ] start
					 */

					ok_Hash.put("tFileCopy_16", false);
					start_Hash.put("tFileCopy_16", System.currentTimeMillis());

					currentComponent = "tFileCopy_16";

					int tos_count_tFileCopy_16 = 0;

					/**
					 * [tFileCopy_16 begin ] stop
					 */

					/**
					 * [tFileCopy_16 main ] start
					 */

					currentComponent = "tFileCopy_16";

					String srcFileName_tFileCopy_16 = ((String) globalMap.get("tFileList_7_CURRENT_FILEPATH"));

					java.io.File srcFile_tFileCopy_16 = new java.io.File(srcFileName_tFileCopy_16);

					// here need check first, before mkdirs().
					if (!srcFile_tFileCopy_16.exists() || !srcFile_tFileCopy_16.isFile()) {
						String errorMessageFileDoesnotExistsOrIsNotAFile_tFileCopy_16 = String.format(
								"The source File \"%s\" does not exist or is not a file.", srcFileName_tFileCopy_16);
						System.err.println(errorMessageFileDoesnotExistsOrIsNotAFile_tFileCopy_16);
					}
					String desDirName_tFileCopy_16 = context.ExtractPathFinalPriceHBP1;

					String desFileName_tFileCopy_16 = srcFile_tFileCopy_16.getName();

					if (desFileName_tFileCopy_16 != null && ("").equals(desFileName_tFileCopy_16.trim())) {
						desFileName_tFileCopy_16 = "NewName.temp";
					}

					java.io.File desFile_tFileCopy_16 = new java.io.File(desDirName_tFileCopy_16,
							desFileName_tFileCopy_16);

					if (!srcFile_tFileCopy_16.getPath().equals(desFile_tFileCopy_16.getPath())) {
						java.io.File parentFile_tFileCopy_16 = desFile_tFileCopy_16.getParentFile();

						if (parentFile_tFileCopy_16 != null && !parentFile_tFileCopy_16.exists()) {
							parentFile_tFileCopy_16.mkdirs();
						}
						try {
							org.talend.FileCopy.copyFile(srcFile_tFileCopy_16.getPath(), desFile_tFileCopy_16.getPath(),
									false);
						} catch (Exception e) {
							System.err.println("tFileCopy_16 " + e.getMessage());
						}

					}
					globalMap.put("tFileCopy_16_DESTINATION_FILEPATH", desFile_tFileCopy_16.getPath());
					globalMap.put("tFileCopy_16_DESTINATION_FILENAME", desFile_tFileCopy_16.getName());

					globalMap.put("tFileCopy_16_SOURCE_DIRECTORY", srcFile_tFileCopy_16.getParent());
					globalMap.put("tFileCopy_16_DESTINATION_DIRECTORY", desFile_tFileCopy_16.getParent());

					tos_count_tFileCopy_16++;

					/**
					 * [tFileCopy_16 main ] stop
					 */

					/**
					 * [tFileCopy_16 process_data_begin ] start
					 */

					currentComponent = "tFileCopy_16";

					/**
					 * [tFileCopy_16 process_data_begin ] stop
					 */

					/**
					 * [tFileCopy_16 process_data_end ] start
					 */

					currentComponent = "tFileCopy_16";

					/**
					 * [tFileCopy_16 process_data_end ] stop
					 */

					/**
					 * [tFileCopy_16 end ] start
					 */

					currentComponent = "tFileCopy_16";

					ok_Hash.put("tFileCopy_16", true);
					end_Hash.put("tFileCopy_16", System.currentTimeMillis());

					/**
					 * [tFileCopy_16 end ] stop
					 */
					if (execStat) {
						runStat.updateStatOnConnection("iterate9", 2, "exec" + NB_ITERATE_tFileCopy_16);
					}
			...
			try {
				...
				/**
				 * [tFileCopy_16 finally ] start
				 */

				currentComponent = "tFileCopy_16";

				/**
				 * [tFileCopy_16 finally ] stop
				 */
	...
	public void tFileList_8Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				int NB_ITERATE_tFileCopy_17 = 0; // for statistics
				...
				for (int i_tFileList_8 = 0; i_tFileList_8 < list_tFileList_8.size(); i_tFileList_8++) {
					 ...
					 */
					NB_ITERATE_tFileCopy_17++;

					if (execStat) {
						runStat.updateStatOnConnection("iterate10", 1, "exec" + NB_ITERATE_tFileCopy_17);
						// Thread.sleep(1000);
					}

					/**
					 * [tFileCopy_17 begin ] start
					 */

					ok_Hash.put("tFileCopy_17", false);
					start_Hash.put("tFileCopy_17", System.currentTimeMillis());

					currentComponent = "tFileCopy_17";

					int tos_count_tFileCopy_17 = 0;

					/**
					 * [tFileCopy_17 begin ] stop
					 */

					/**
					 * [tFileCopy_17 main ] start
					 */

					currentComponent = "tFileCopy_17";

					String srcFileName_tFileCopy_17 = ((String) globalMap.get("tFileList_8_CURRENT_FILEPATH"));

					java.io.File srcFile_tFileCopy_17 = new java.io.File(srcFileName_tFileCopy_17);

					// here need check first, before mkdirs().
					if (!srcFile_tFileCopy_17.exists() || !srcFile_tFileCopy_17.isFile()) {
						String errorMessageFileDoesnotExistsOrIsNotAFile_tFileCopy_17 = String.format(
								"The source File \"%s\" does not exist or is not a file.", srcFileName_tFileCopy_17);
						System.err.println(errorMessageFileDoesnotExistsOrIsNotAFile_tFileCopy_17);
					}
					String desDirName_tFileCopy_17 = context.ExtractPathFinalPriceHBS1;

					String desFileName_tFileCopy_17 = srcFile_tFileCopy_17.getName();

					if (desFileName_tFileCopy_17 != null && ("").equals(desFileName_tFileCopy_17.trim())) {
						desFileName_tFileCopy_17 = "NewName.temp";
					}

					java.io.File desFile_tFileCopy_17 = new java.io.File(desDirName_tFileCopy_17,
							desFileName_tFileCopy_17);

					if (!srcFile_tFileCopy_17.getPath().equals(desFile_tFileCopy_17.getPath())) {
						java.io.File parentFile_tFileCopy_17 = desFile_tFileCopy_17.getParentFile();

						if (parentFile_tFileCopy_17 != null && !parentFile_tFileCopy_17.exists()) {
							parentFile_tFileCopy_17.mkdirs();
						}
						try {
							org.talend.FileCopy.copyFile(srcFile_tFileCopy_17.getPath(), desFile_tFileCopy_17.getPath(),
									false);
						} catch (Exception e) {
							System.err.println("tFileCopy_17 " + e.getMessage());
						}

					}
					globalMap.put("tFileCopy_17_DESTINATION_FILEPATH", desFile_tFileCopy_17.getPath());
					globalMap.put("tFileCopy_17_DESTINATION_FILENAME", desFile_tFileCopy_17.getName());

					globalMap.put("tFileCopy_17_SOURCE_DIRECTORY", srcFile_tFileCopy_17.getParent());
					globalMap.put("tFileCopy_17_DESTINATION_DIRECTORY", desFile_tFileCopy_17.getParent());

					tos_count_tFileCopy_17++;

					/**
					 * [tFileCopy_17 main ] stop
					 */

					/**
					 * [tFileCopy_17 process_data_begin ] start
					 */

					currentComponent = "tFileCopy_17";

					/**
					 * [tFileCopy_17 process_data_begin ] stop
					 */

					/**
					 * [tFileCopy_17 process_data_end ] start
					 */

					currentComponent = "tFileCopy_17";

					/**
					 * [tFileCopy_17 process_data_end ] stop
					 */

					/**
					 * [tFileCopy_17 end ] start
					 */

					currentComponent = "tFileCopy_17";

					ok_Hash.put("tFileCopy_17", true);
					end_Hash.put("tFileCopy_17", System.currentTimeMillis());

					/**
					 * [tFileCopy_17 end ] stop
					 */
					if (execStat) {
						runStat.updateStatOnConnection("iterate10", 2, "exec" + NB_ITERATE_tFileCopy_17);
					}
			...
			try {
				...
				/**
				 * [tFileCopy_17 finally ] start
				 */

				currentComponent = "tFileCopy_17";

				/**
				 * [tFileCopy_17 finally ] stop
				 */
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				for (final String filemask_tFileList_4 : maskList_tFileList_4) {
					...
					filemask_compile_tFileList_4 = org.apache.oro.text.GlobCompiler.globToPerl5(
							filemask_tFileList_4.toCharArray(), org.apache.oro.text.GlobCompiler.DEFAULT_MASK);
				...
				for (int i_tFileList_4 = 0; i_tFileList_4 < list_tFileList_4.size(); i_tFileList_4++) {
					...
					if (files_tFileList_4.getName().contains(".") && files_tFileList_4.isFile()) {
						currentFileExtension_tFileList_4 = files_tFileList_4.getName()
								.substring(files_tFileList_4.getName().lastIndexOf(".") + 1);
					} else {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (osName_tRunJob_1 != null && osName_tRunJob_1.toLowerCase().startsWith("win")) {
					...
					paraList_tRunJob_1.add("C:/Program Files/Java/jre1.8.0_321/bin/java.exe");
					...
					jvm_argument_helper_tRunJob_1.addArgumentsTo(paraList_tRunJob_1,
							dealChildJobLibrary_tRunJob_1.replaceJarPathsFromCrcMap(
									"C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/workspace/DEV/poms/jobs/process/buy_validation_0.10/target/classpath.jar;"));

					jvm_argument_helper_tRunJob_1.addArgumentsTo(paraList_tRunJob_1,
							"dev.buy_validation_0_10.BUY_VALIDATION");
					...
					jvm_argument_helper_tRunJob_1.addArgumentsTo(paraList_tRunJob_1,
							dealChildJobLibrary_tRunJob_1.replaceJarPathsFromCrcMap(
									"C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/workspace/DEV/poms/jobs/process/buy_validation_0.10/target/classes:C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/workspace/DEV/poms/jobs/process/buy_validation_0.10/src/main/ext-resources:C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/workspace/DEV/poms/jobs/process/buy_send_email_0.1/target/classes:C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/workspace/DEV/poms/jobs/process/buy_send_email_0.1/src/main/ext-resources:C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/workspace/DEV/poms/code/routines/target/classes:.:C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/configuration/.m2/repository/javax/mail/mail/1.4.7/mail-1.4.7.jar:C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/configuration/.m2/repository/org/talend/libraries/activation/6.0.0/activation-6.0.0.jar:C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/configuration/.m2/repository/org/talend/libraries/advancedPersistentLookupLib-1.2/6.0.0/advancedPersistentLookupLib-1.2-6.0.0.jar:C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/configuration/.m2/repository/commons-collections/commons-collections/3.2.2/commons-collections-3.2.2.jar:C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/configuration/.m2/repository/org/talend/libraries/commons-collections4-4.1/6.0.0/commons-collections4-4.1-6.0.0.jar:C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/configuration/.m2/repository/org/apache/commons/commons-compress/1.19/commons-compress-1.19.jar:C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/configuration/.m2/repository/org/apache/commons/commons-lang3/3.8.1/commons-lang3-3.8.1.jar:C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/configuration/.m2/repository/org/apache/commons/commons-math3/3.6.1/commons-math3-3.6.1.jar:C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/configuration/.m2/repository/org/talend/libraries/crypto-utils/6.0.0-SNAPSHOT/crypto-utils-6.0.0-SNAPSHOT.jar:C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/configuration/.m2/repository/dom4j/dom4j/1.6.1/dom4j-1.6.1.jar:C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/configuration/.m2/repository/org/talend/libraries/filecopy/2.0.0/filecopy-2.0.0.jar:C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/configuration/.m2/repository/org/talend/libraries/geronimo-stax-api_1.0_spec-1.0.1/6.0.0/geronimo-stax-api_1.0_spec-1.0.1-6.0.0.jar:C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/configuration/.m2/repository/org/talend/libraries/jboss-serialization/6.0.0/jboss-serialization-6.0.0.jar:C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/configuration/.m2/repository/log4j/log4j/1.2.17/log4j-1.2.17.jar:C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/configuration/.m2/repository/org/talend/libraries/mail-1.4/6.0.0/mail-1.4-6.0.0.jar:C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/configuration/.m2/repository/org/talend/libraries/mssql-jdbc/6.0.0/mssql-jdbc-6.0.0.jar:C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/configuration/.m2/repository/org/apache/poi/poi/4.1.0-20190523141255_modified_talend/poi-4.1.0-20190523141255_modified_talend.jar:C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/configuration/.m2/repository/org/apache/poi/poi-ooxml/4.1.0-20190523141255_modified_talend/poi-ooxml-4.1.0-20190523141255_modified_talend.jar:C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/configuration/.m2/repository/org/apache/poi/poi-ooxml-schemas/4.1.0-20190523141255_modified_talend/poi-ooxml-schemas-4.1.0-20190523141255_modified_talend.jar:C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/configuration/.m2/repository/org/apache/poi/poi-scratchpad/4.1.0-20190523141255_modified_talend/poi-scratchpad-4.1.0-20190523141255_modified_talend.jar:C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/configuration/.m2/repository/org/talend/libraries/talendExcel-1.5-20190731/6.0.0/talendExcel-1.5-20190731-6.0.0.jar:C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/configuration/.m2/repository/org/talend/libraries/talend_DB_mssqlUtil-1.3-20190523/6.0.0/talend_DB_mssqlUtil-1.3-20190523-6.0.0.jar:C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/configuration/.m2/repository/org/talend/libraries/talend_file_enhanced_20070724/6.0.0/talend_file_enhanced_20070724-6.0.0.jar:C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/configuration/.m2/repository/org/talend/libraries/talendcsv/6.0.0/talendcsv-6.0.0.jar:C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/configuration/.m2/repository/org/talend/components/lib/thashfile/3.1-20190910/thashfile-3.1-20190910.jar:C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/configuration/.m2/repository/org/talend/libraries/trove/6.0.0/trove-6.0.0.jar:C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/configuration/.m2/repository/org/apache/xmlbeans/xmlbeans/3.1.0/xmlbeans-3.1.0.jar:")
									.replace("$ROOT_PATH", System.getProperty("user.dir")));
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (obj_tRunJob_6 != null) {
					paraList_tRunJob_6
							.add("--context_param recipientEmail=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_6));
				} else {
					paraList_tRunJob_6.add("--context_param recipientEmail="
							+ NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
				}
				...
				if (obj_tRunJob_6 != null) {
					paraList_tRunJob_6
							.add("--context_param subject=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_6));
				} else {
				...
				if (obj_tRunJob_6 != null) {
					paraList_tRunJob_6
							.add("--context_param message=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_6));
				} else {
					paraList_tRunJob_6.add(
							"--context_param message=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
				}
				...
				if (obj_tRunJob_6 != null) {
					paraList_tRunJob_6
							.add("--context_param attachmentFile=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_6));
				} else {
					paraList_tRunJob_6.add("--context_param attachmentFile="
							+ NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
				}
				...
				if (obj_tRunJob_6 != null) {
					paraList_tRunJob_6
							.add("--context_param excelFileName=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_6));
				} else {
					paraList_tRunJob_6.add("--context_param excelFileName="
							+ NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
				}
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = BUY_INTEGRATION.class.getClassLoader()
					.getResourceAsStream("dev/buy_integration_0_11/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 380749 characters generated by Talend Open Studio for Data Integration on the
 * 22 mars 2022 17:20:34 CET
 ************************************************************************************************/