...
package dev.masterfile_set_azure_storage_dynamics_0_2;
...
/**
 * Job: MASTERFILE_SET_AZURE_STORAGE_DYNAMICS Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class MASTERFILE_SET_AZURE_STORAGE_DYNAMICS implements TalendJob {
	...
	public class ContextProperties extends PropertiesWithType {
		...
		public void synchronizeContext() {
			...
			if (azureRepository != null) {
				...
				this.setProperty("azureRepository", azureRepository.toString());

			}

			if (azureRepositoryURL != null) {

				this.setProperty("azureRepositoryURL", azureRepositoryURL.toString());
		...
		public String getAzureRepository() {
			return this.azureRepository;
		}

		public String azureRepositoryURL;

		public String getAzureRepositoryURL() {
			return this.azureRepositoryURL;
		}
	...
	private final String jobName = "MASTERFILE_SET_AZURE_STORAGE_DYNAMICS";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					MASTERFILE_SET_AZURE_STORAGE_DYNAMICS.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(MASTERFILE_SET_AZURE_STORAGE_DYNAMICS.this,
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_1", "", Thread.currentThread().getId() + "", "INFO",
							"", "Start send file : " + context.File, "", "");
					talendLogs_LOGS.addMessage("tWarn", "tWarn_1", 3, "Start send file : " + context.File, 3);
					talendLogs_LOGSProcess(globalMap);
					globalMap.put("tWarn_1_WARN_MESSAGES", "Start send file : " + context.File);
	...
	public void tJava_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// Initialize TalendUtils
				TalendUtils talend = new TalendUtils(context.Path, context.File, context.azureRepository,
						context.azureRepositoryURL, context.signature);

				System.out.println("talend.dateModification : " + talend.dateModification);
				System.out.println("context.signature : " + context.signature);
				talend.callCreateFile(talend.getSharedKey());

				talend.callPutRange(talend.getSharedKeyPutRange());
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_2", "", Thread.currentThread().getId() + "", "INFO",
							"", "End send file : " + context.File, "", "");
					talendLogs_LOGS.addMessage("tWarn", "tWarn_2", 3, "End send file : " + context.File, 3);
					talendLogs_LOGSProcess(globalMap);
					globalMap.put("tWarn_2_WARN_MESSAGES", "End send file : " + context.File);
	...
	public static class row_talendLogs_DBStruct implements routines.system.IPersistableRow<row_talendLogs_DBStruct> {
		final static byte[] commonByteArrayLock_DEV_MASTERFILE_SET_AZURE_STORAGE_DYNAMICS = new byte[0];
		static byte[] commonByteArray_DEV_MASTERFILE_SET_AZURE_STORAGE_DYNAMICS = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_DEV_MASTERFILE_SET_AZURE_STORAGE_DYNAMICS.length) {
					if (length < 1024 && commonByteArray_DEV_MASTERFILE_SET_AZURE_STORAGE_DYNAMICS.length == 0) {
						commonByteArray_DEV_MASTERFILE_SET_AZURE_STORAGE_DYNAMICS = new byte[1024];
					} else {
						commonByteArray_DEV_MASTERFILE_SET_AZURE_STORAGE_DYNAMICS = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_DEV_MASTERFILE_SET_AZURE_STORAGE_DYNAMICS, 0, length);
				strReturn = new String(commonByteArray_DEV_MASTERFILE_SET_AZURE_STORAGE_DYNAMICS, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DEV_MASTERFILE_SET_AZURE_STORAGE_DYNAMICS) {
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final MASTERFILE_SET_AZURE_STORAGE_DYNAMICS MASTERFILE_SET_AZURE_STORAGE_DYNAMICSClass = new MASTERFILE_SET_AZURE_STORAGE_DYNAMICS();

		int exitCode = MASTERFILE_SET_AZURE_STORAGE_DYNAMICSClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = MASTERFILE_SET_AZURE_STORAGE_DYNAMICS.class.getClassLoader()
					.getResourceAsStream(
							"dev/masterfile_set_azure_storage_dynamics_0_2/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = MASTERFILE_SET_AZURE_STORAGE_DYNAMICS.class.getClassLoader()
			...
			class ContextProcessing {
				private void processContext_0() {
					...
					context.setContextType("azureRepository", "id_String");
					context.azureRepository = (String) context.getProperty("azureRepository");
					context.setContextType("azureRepositoryURL", "id_String");
					context.azureRepositoryURL = (String) context.getProperty("azureRepositoryURL");
		...
		if (parentContextMap != null && !parentContextMap.isEmpty()) {
			...
			if (parentContextMap.containsKey("azureRepository")) {
				context.azureRepository = (String) parentContextMap.get("azureRepository");
			}
			if (parentContextMap.containsKey("azureRepositoryURL")) {
				context.azureRepositoryURL = (String) parentContextMap.get("azureRepositoryURL");
			}
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : MASTERFILE_SET_AZURE_STORAGE_DYNAMICS");
		}
...
/************************************************************************************************
 * 102975 characters generated by Talend Open Studio for Data Integration on the
 * 29 décembre 2023 11:13:22 GMT
 ************************************************************************************************/