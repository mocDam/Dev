...
package dev.masterfile_integration_bdd_0_36;
...
public class MASTERFILE_INTEGRATION_BDD implements TalendJob {
	...
	private final String jobVersion = "0.36";
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = MASTERFILE_INTEGRATION_BDD.class.getClassLoader()
					.getResourceAsStream("dev/masterfile_integration_bdd_0_36/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 306645 characters generated by Talend Open Studio for Data Integration on the
 * 7 février 2023 10:00:17 CET
 ************************************************************************************************/