...
package dev.buy_integration_0_23;
...
public class BUY_INTEGRATION implements TalendJob {
	...
	private final String jobVersion = "0.23";
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tFileArchive_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("ENC:[ykkUtdC9za1djMUVFnOhS2D/n+iOC5EsW1GqNQ==]");
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = BUY_INTEGRATION.class.getClassLoader()
					.getResourceAsStream("dev/buy_integration_0_23/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 383507 characters generated by Talend Open Studio for Data Integration on the
 * 18 mai 2022 17:01:48 CEST
 ************************************************************************************************/