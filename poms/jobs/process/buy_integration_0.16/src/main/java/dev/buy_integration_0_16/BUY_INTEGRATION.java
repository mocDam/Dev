...
package dev.buy_integration_0_16;
...
public class BUY_INTEGRATION implements TalendJob {
	...
	private final String jobVersion = "0.16";
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tFileArchive_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("ENC:[gjKkTcCCnuIYIbi+5F7IIVnrZgW4i4Jtmu/Hag==]");
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = BUY_INTEGRATION.class.getClassLoader()
					.getResourceAsStream("dev/buy_integration_0_16/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 358786 characters generated by Talend Open Studio for Data Integration on the
 * 12 avril 2022 11:24:59 CEST
 ************************************************************************************************/