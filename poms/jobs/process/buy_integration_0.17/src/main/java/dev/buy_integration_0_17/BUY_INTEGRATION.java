...
package dev.buy_integration_0_17;
...
public class BUY_INTEGRATION implements TalendJob {
	...
	private final String jobVersion = "0.17";
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tFileArchive_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("ENC:[QP6lYHfql6GEfNlFzdsIHqaEnY3tyq3/JrljxQ==]");
				...
				if (osName_tRunJob_3 != null && osName_tRunJob_3.toLowerCase().startsWith("win")) {
					...
					jvm_argument_helper_tRunJob_3.addArgumentsTo(paraList_tRunJob_3,
							dealChildJobLibrary_tRunJob_3.replaceJarPathsFromCrcMap(
									"C:/TALEND/TOS_DI-20191031_1204-V7.3.1M3/workspace/DEV/poms/jobs/process/extract_for_dynamics_price_0.11/target/classpath.jar;"));

					jvm_argument_helper_tRunJob_3.addArgumentsTo(paraList_tRunJob_3,
							"dev.extract_for_dynamics_price_0_11.EXTRACT_FOR_DYNAMICS_PRICE");
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (obj_tRunJob_1 != null) {
					paraList_tRunJob_1
							.add("--context_param recipientEmail=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_1));
				} else {
					paraList_tRunJob_1.add("--context_param recipientEmail="
							+ NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
				}
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = BUY_INTEGRATION.class.getClassLoader()
					.getResourceAsStream("dev/buy_integration_0_17/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 370138 characters generated by Talend Open Studio for Data Integration on the
 * 19 avril 2022 10:39:36 CEST
 ************************************************************************************************/