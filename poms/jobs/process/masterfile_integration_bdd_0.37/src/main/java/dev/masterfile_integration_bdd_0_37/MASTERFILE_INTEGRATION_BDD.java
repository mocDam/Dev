...
package dev.masterfile_integration_bdd_0_37;
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (osName_tRunJob_2 != null && osName_tRunJob_2.toLowerCase().startsWith("win")) {
					...
					paraList_tRunJob_2.add("C:/Program Files/Java/jre1.8.0_291/bin/java.exe");
				...
				class ContextProcessor_tRunJob_2 {
					private void transmitContext_0() {
						...
						parentContextMap_tRunJob_2.put("ExtractPathFinal", context.ExtractPathFinal);
						paraList_tRunJob_2.add("--context_type " + "ExtractPathFinal" + "=" + "id_String");
						...
						parentContextMap_tRunJob_2.put("ExtractPathPrice", context.ExtractPathPrice);
						paraList_tRunJob_2.add("--context_type " + "ExtractPathPrice" + "=" + "id_String");
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = MASTERFILE_INTEGRATION_BDD.class.getClassLoader()
					.getResourceAsStream("dev/masterfile_integration_bdd_0_37/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 333618 characters generated by Talend Open Studio for Data Integration on the
 * 1 mars 2023 15:55:56 CET
 ************************************************************************************************/