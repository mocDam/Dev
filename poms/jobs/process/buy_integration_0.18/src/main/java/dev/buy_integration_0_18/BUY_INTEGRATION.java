...
package dev.buy_integration_0_18;
...
public class BUY_INTEGRATION implements TalendJob {
	...
	private final String jobVersion = "0.18";
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tFileArchive_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("ENC:[3PwGI+UmOJ78h33qDESeIf32ySoGX77Cl6bUdw==]");
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = BUY_INTEGRATION.class.getClassLoader()
					.getResourceAsStream("dev/buy_integration_0_18/contexts/" + contextStr + ".properties");
			if (inContext == null) {
