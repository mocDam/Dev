...
package dev.masterfile_products_0_39;
...
public class MASTERFILE_PRODUCTS implements TalendJob {
	...
	private final String jobVersion = "0.39";
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				class ContextProcessor_tRunJob_2 {
					private void transmitContext_0() {
						...
						parentContextMap_tRunJob_2.put("ExtractPath", context.ExtractPath);
						paraList_tRunJob_2.add("--context_type " + "ExtractPath" + "=" + "id_String");
						parentContextMap_tRunJob_2.put("ModelFilePath", context.ModelFilePath);
						paraList_tRunJob_2.add("--context_type " + "ModelFilePath" + "=" + "id_String");
						parentContextMap_tRunJob_2.put("ExtractPathHBE", context.ExtractPathHBE);
						paraList_tRunJob_2.add("--context_type " + "ExtractPathHBE" + "=" + "id_String");
						parentContextMap_tRunJob_2.put("ExtractPathOTHER", context.ExtractPathOTHER);
						paraList_tRunJob_2.add("--context_type " + "ExtractPathOTHER" + "=" + "id_String");
						parentContextMap_tRunJob_2.put("currentFileName", context.currentFileName);
						paraList_tRunJob_2.add("--context_type " + "currentFileName" + "=" + "id_String");
						parentContextMap_tRunJob_2.put("currentCreationDate", context.currentCreationDate);
						paraList_tRunJob_2.add("--context_type " + "currentCreationDate" + "=" + "id_String");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (osName_tRunJob_4 != null && osName_tRunJob_4.toLowerCase().startsWith("win")) {
					...
					paraList_tRunJob_4.add("C:/Program Files/Java/jre-1.8/bin/java.exe");
				...
				class ContextProcessor_tRunJob_4 {
					private void transmitContext_0() {
						parentContextMap_tRunJob_4.put("IntegrationPath", context.IntegrationPath);
						paraList_tRunJob_4.add("--context_type " + "IntegrationPath" + "=" + "id_String");
						parentContextMap_tRunJob_4.put("LogPath", context.LogPath);
						paraList_tRunJob_4.add("--context_type " + "LogPath" + "=" + "id_String");
						parentContextMap_tRunJob_4.put("ExtractPath", context.ExtractPath);
						paraList_tRunJob_4.add("--context_type " + "ExtractPath" + "=" + "id_String");
						parentContextMap_tRunJob_4.put("ModelFilePath", context.ModelFilePath);
						paraList_tRunJob_4.add("--context_type " + "ModelFilePath" + "=" + "id_String");
						parentContextMap_tRunJob_4.put("ExtractPathHBE", context.ExtractPathHBE);
						paraList_tRunJob_4.add("--context_type " + "ExtractPathHBE" + "=" + "id_String");
						parentContextMap_tRunJob_4.put("ExtractPathOTHER", context.ExtractPathOTHER);
						paraList_tRunJob_4.add("--context_type " + "ExtractPathOTHER" + "=" + "id_String");
						parentContextMap_tRunJob_4.put("currentFileName", context.currentFileName);
						paraList_tRunJob_4.add("--context_type " + "currentFileName" + "=" + "id_String");
						parentContextMap_tRunJob_4.put("currentCreationDate", context.currentCreationDate);
						paraList_tRunJob_4.add("--context_type " + "currentCreationDate" + "=" + "id_String");
						parentContextMap_tRunJob_4.put("SQLSERVER_Server", context.SQLSERVER_Server);
						paraList_tRunJob_4.add("--context_type " + "SQLSERVER_Server" + "=" + "id_String");
						parentContextMap_tRunJob_4.put("SQLSERVER_Password", context.SQLSERVER_Password);
						paraList_tRunJob_4.add("--context_type " + "SQLSERVER_Password" + "=" + "id_Password");
						parentContextMap_tRunJob_4.put("SQLSERVER_AdditionalParams",
								context.SQLSERVER_AdditionalParams);
						paraList_tRunJob_4.add("--context_type " + "SQLSERVER_AdditionalParams" + "=" + "id_String");
						parentContextMap_tRunJob_4.put("SQLSERVER_Database", context.SQLSERVER_Database);
						paraList_tRunJob_4.add("--context_type " + "SQLSERVER_Database" + "=" + "id_String");
						parentContextMap_tRunJob_4.put("SQLSERVER_Port", context.SQLSERVER_Port);
						paraList_tRunJob_4.add("--context_type " + "SQLSERVER_Port" + "=" + "id_String");
						parentContextMap_tRunJob_4.put("SQLSERVER_Schema", context.SQLSERVER_Schema);
						paraList_tRunJob_4.add("--context_type " + "SQLSERVER_Schema" + "=" + "id_String");
						parentContextMap_tRunJob_4.put("SQLSERVER_Login", context.SQLSERVER_Login);
						paraList_tRunJob_4.add("--context_type " + "SQLSERVER_Login" + "=" + "id_String");
						...
						parentContextMap_tRunJob_4.put("SQLSERVER_LOG_AdditionalParams",
								context.SQLSERVER_LOG_AdditionalParams);
						paraList_tRunJob_4
								.add("--context_type " + "SQLSERVER_LOG_AdditionalParams" + "=" + "id_String");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tFileArchive_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("ENC:[pcvqOunS2eoA801oibALmY8IcvcDmlGSaqnBig==]");
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = MASTERFILE_PRODUCTS.class.getClassLoader()
					.getResourceAsStream("dev/masterfile_products_0_39/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 271485 characters generated by Talend Open Studio for Data Integration on the
 * 29 décembre 2023 11:11:24 GMT
 ************************************************************************************************/