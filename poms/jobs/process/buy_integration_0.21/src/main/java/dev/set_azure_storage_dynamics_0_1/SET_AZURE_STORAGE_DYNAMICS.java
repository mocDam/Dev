...
package dev.set_azure_storage_dynamics_0_1;
...
/**
 * Job: SET_AZURE_STORAGE_DYNAMICS Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20191031_1204-M3
 * @status 
 */
public class SET_AZURE_STORAGE_DYNAMICS implements TalendJob {
...
public String getAzureRepositoryURL(){
	...
	private final String jobName = "SET_AZURE_STORAGE_DYNAMICS";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				SET_AZURE_STORAGE_DYNAMICS.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(SET_AZURE_STORAGE_DYNAMICS.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
				    			...
				    			if(resumeEntryMethodName == null || globalResumeTicket){
				    				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tLibraryLoad_2:OnSubjobOk", "", Thread.currentThread().getId() + "", "", "", "", "", "");
								}	    				    			
...
TalendUtils talend = new TalendUtils(context.Path , context.File, context.azureRepository,context.azureRepositoryURL  );
 ...
 */
    ...
    public static void main(String[] args){
        final SET_AZURE_STORAGE_DYNAMICS SET_AZURE_STORAGE_DYNAMICSClass = new SET_AZURE_STORAGE_DYNAMICS();

        int exitCode = SET_AZURE_STORAGE_DYNAMICSClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = SET_AZURE_STORAGE_DYNAMICS.class.getClassLoader().getResourceAsStream("dev/set_azure_storage_dynamics_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = SET_AZURE_STORAGE_DYNAMICS.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : SET_AZURE_STORAGE_DYNAMICS");
        }
...
/************************************************************************************************
 *     38336 characters generated by Talend Open Studio for Data Integration 
 *     on the 10 mai 2022 11:41:46 CEST
 ************************************************************************************************/