...
package dev.buy_integration_0_21;
...
public String getExtractPathFinalPriceHBS1(){
	...
	private final String jobVersion = "0.21";
 ...
 */
	...
	final String decryptedPassword_tFileArchive_1 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[xV/Va4MVWt0qpLGGA1+JAxo13gs41j/pEIHgvg==]");
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = BUY_INTEGRATION.class.getClassLoader().getResourceAsStream("dev/buy_integration_0_21/contexts/" + contextStr + ".properties");
            if (inContext == null) {
