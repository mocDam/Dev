...
package dev.masterfile_integration_bdd_0_40;
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = MASTERFILE_INTEGRATION_BDD.class.getClassLoader()
					.getResourceAsStream("dev/masterfile_integration_bdd_0_40/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 344969 characters generated by Talend Open Studio for Data Integration on the
 * 14 avril 2023 12:15:34 CEST
 ************************************************************************************************/