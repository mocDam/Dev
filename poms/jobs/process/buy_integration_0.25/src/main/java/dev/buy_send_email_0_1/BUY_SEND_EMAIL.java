...
java.io.File file_tFileExist_1 = new java.io.File(context.attachmentFile);
...
globalMap.put("tFileExist_1_FILENAME",context.attachmentFile);
 ...
 */
    ...
    String to_tSendMail_1 = (context.recipientEmail).replace(";",",");
	...
	java.util.List<String> contentTransferEncoding_tSendMail_1 = new java.util.ArrayList<String>();
		attachments_tSendMail_1.add(context.attachmentFile);
		contentTransferEncoding_tSendMail_1.add("DEFAULT");	

	String message_tSendMail_1 = ((context.message) == null || "".equals(context.message)) ? "\"\"" : (context.message) ;
	...
	final String decryptedPassword_tSendMail_1 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[aJ9VD2kKnAm8hS8WZUv/HgZPMV0ZXmoZ+MZRvBoB4rHJnWQL]");
 ...
 */
    ...
    String subject_tSendMail_2 = (context.subject);
	...
	String message_tSendMail_2 = ((context.message) == null || "".equals(context.message)) ? "\"\"" : (context.message) ;
	...
	final String decryptedPassword_tSendMail_2 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[NLeWtgVCpCp8inxdIw3GiQYq4fogvaOFDq+LExvhIV89VAFM]");
...
/************************************************************************************************
 *     51421 characters generated by Talend Open Studio for Data Integration 
 *     on the 18 mai 2022 17:27:49 CEST
 ************************************************************************************************/